                        ...
                        if (codes[i].trim()) {
                            ...
                            if (codes[i] == "i18n") {
                                ...
                                if (value.includes("<") && value.includes(">")) {
                                    if (
                                        !(
                                            value.replace("< >", "").indexOf("<") == -1 || // Invalid file name characters cases
                                            value.replace("<a target='_blank' href='{1}'>{2}</a>", "").indexOf("<") == -1 || // Generic Link case
                                            value
                                                .replace(
                                                    '<a target="_blank" href="https://www.drawio.com/doc/faq/license-drawio-confluence-jira-cloud">'
                                                )
                                                .replace("</a>", "")
                                                .indexOf("<") == -1
                                        )

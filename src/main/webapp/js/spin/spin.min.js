...
!(function (a, b) {
    ...
    function c(a, b, c, d)
    {
        var e = [ "opacity", b, ~~(100 * a), c, d ].join("-"), f = 0.01 + (c / d) * 100, g = Math.max(1 - ((1 - a) / b) * (100 - f), a),
            h = j.substring(0, j.indexOf("Animation")).toLowerCase(), i = (h && "-" + h + "-") || "";
        return (l[e]
                    || (m.insertRule("@" + i + "keyframes " + e + "{0%{opacity:" + g + "}" + f + "%{opacity:" + a + "}" + (f + 0.01)
                                         + "%{opacity:1}" + ((f + b) % 100) + "%{opacity:" + a + "}100%{opacity:" + g + "}}",
                                     m.cssRules.length),
                        (l[e] = 1)),
                e);
    }
    ...
    (h.defaults = {}),
        ...
        d.radius + d.length + d.width;
                ...
                if (
                    (b && (b.insertBefore(f, b.firstChild || null), e(f, { left: d.left, top: d.top })),

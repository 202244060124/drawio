...
var mxJSColor = {bindClass : "color", // class name
                 ...
                 init : function(){if (mxJSColor.preloading){mxJSColor.preload();
}
}
    ...
    color : function(target, prop)
{
            ...
            if (!this.pickerSmartPosition) {
                ...
                var pp = [
                    ...
                    -vp[b] + tp[b] + ts[b] + ps[b] - l + l * c > vs[b]
                        ? -vp[b] + tp[b] + ts[b] / 2 > vs[b] / 2 && tp[b] + ts[b] - l - l * c >= 0 ? tp[b] + ts[b] - l - l * c
                                                                                                   : tp[b] + ts[b] - l + l * c
    ...
    this.fromHSV = function(h, s, v, flags)
    {
        ...
        (s < 0 && (s = 0)) || (s > 1 && (s = 1));
        (v < 0 && (v = 0)) || (v > 1 && (v = 1));
        this.rgb = HSV_RGB(h == = null ? this.hsv[0] : (this.hsv[0] = h), s == = null ? this.hsv[1] : (this.hsv[1] = s),
    ...
    this.fromRGB = function(r, g, b, flags)
    {
        ...
        (g < 0 && (g = 0)) || (g > 1 && (g = 1));
        (b < 0 && (b = 0)) || (b > 1 && (b = 1));
        var hsv = RGB_HSV(r == = null ? this.rgb[0] : (this.rgb[0] = r), g == = null ? this.rgb[1] : (this.rgb[1] = g),
    ...
    this.fromString = function(hex, flags)
    {
            ...
            if (!m) {
                ...
                if (m[1].length == = 6) {
                    // 6-char notation
                    this.fromRGB(parseInt(m[1].substr(0, 2), 16) / 255, parseInt(m[1].substr(2, 2), 16) / 255,
                                 parseInt(m[1].substr(4, 2), 16) / 255, flags);
                } else {
                    // 3-char notation
                    this.fromRGB(parseInt(m[1].charAt(0) + m[1].charAt(0), 16) / 255, parseInt(m[1].charAt(1) + m[1].charAt(1), 16) / 255,
    ...
    function getPickerDims(o)
    {
        var dims = [
            ...
            o.pickerClosable ? 4 * o.pickerInset + 3 * o.pickerFace + mxJSColor.images.pad[1] + o.pickerButtonHeight
    ...
    var abortBlur = false;
    var valueElement = mxJSColor.fetchElement(this.valueElement), styleElement = mxJSColor.fetchElement(this.styleElement);

(function (e) {
    ...
    return (function () {
        ...
        function o(e)
        {
            ...
            for (n = 0; n < f; n += 4)
                (t = (u[e.charCodeAt(n)] << 18) | (u[e.charCodeAt(n + 1)] << 12) | (u[e.charCodeAt(n + 2)] << 6) | u[e.charCodeAt(n + 3)]),
                    (l[c++] = 255 & (t >> 16)), (l[c++] = 255 & (t >> 8)), (l[c++] = 255 & t);
            return (2 === s && ((t = (u[e.charCodeAt(n)] << 2) | (u[e.charCodeAt(n + 1)] >> 4)), (l[c++] = 255 & t)),
                    1 === s
                           && ((t = (u[e.charCodeAt(n)] << 10) | (u[e.charCodeAt(n + 1)] << 4) | (u[e.charCodeAt(n + 2)] >> 2)),
                               (l[c++] = 255 & (t >> 8)), (l[c++] = 255 & t)),
                    l);
        }
        function d(e)
        {
        ...
        function s(e, t, n)
        {
            for (var r, a = [], o = t; o < n; o += 3)
                (r = (16711680 & (e[o] << 16)) + (65280 & (e[o + 1] << 8)) + (255 & e[o + 2])), a.push(d(r));
            return a.join("");
        }
        function l(e)
        {
            ...
            return (1 === r ? ((t = e[n - 1]), a.push(c[t >> 2] + c[63 & (t << 4)] + "=="))
                             : 2 === r && ((t = (e[n - 2] << 8) + e[n - 1]), a.push(c[t >> 10] + c[63 & (t >> 4)] + c[63 & (t << 2)] + "=")),
                    a.join(""));
        }
        (n.byteLength =
             function(e) {
        ...
        for (var c = [], u = [], p = "undefined" == typeof Uint8Array ? Array : Uint8Array,
                 f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", g = 0, _ = f.length;
             g < _; ++g)
        ...
        (u[45] = 62), (u[95] = 63);
            ...
            3: [
                ...
                function _(e, t, n)
                {
                    ...
                    var r;
                    return ((r = void 0 === t && void 0 === n ? new Uint8Array(e)
                                                                : void 0 === n ? new Uint8Array(e, t) : new Uint8Array(e, t, n)),
                            (r.__proto__ = s.prototype), r);
                }
                function h(e)
                {
                    if (s.isBuffer(e)) {
                    ...
                    return void 0 === e.length ? "Buffer" === e.type && Array.isArray(e.data) ? g(e.data) : void 0
                                       : "number" != typeof e.length || X(e.length) ? d(0)
                                                                                    : g(e);
                }
                function m(e)
                {
                    if (e >= 2147483647)
                        throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x" + (2147483647).toString(16)
                                             + " bytes");
                    return 0 | e;
                }
                function b(e, t)
                ...
                function R(e, t, n, r, a)
                {
                    if (0 === e.length)
                        return -1;
                    if (("string" == typeof n ? ((r = n), (n = 0))
                         : 2147483647 < n     ? (n = 2147483647)
                                              : -2147483648 > n && (n = -2147483648),
                         (n = +n), X(n) && (n = a ? 0 : e.length - 1), 0 > n && (n = e.length + n), n >= e.length)) {
                        if (a)
                            return -1;
                        n = e.length - 1;
                    } else if (0 > n)
                ...
                function E(e, t, n, r, a)
                {
                    ...
                    if (void 0 != =
                            r && ((r = (r + "").toLowerCase()), "ucs2" === r || "ucs-2" === r || "utf16le" === r || "utf-16le" === r)) {
                ...
                function w(e, t, n, r)
                {
                    ...
                    r > o / 2 && (r = o / 2);
                    for (var d, s = 0; s < r; ++s) {
                        if (((d = parseInt(t.substr(2 * s, 2), 16)), X(d)))
                            return s;
                        e[n + s] = d;
                    }
                    return s;
                ...
                function x(e, t, n)
                {
                    ...
                    for (var r = [], a = t; a < n;) {
                        ...
                        if (a + l <= n) {
                            ...
                            1 === l ? 128 > d && (s = d)
                                     : 2 == =
                                           l ? ((c = e[a + 1]), 128 == (192 & c) && ((f = ((31 & d) << 6) | (63 & c)), 127 < f && (s = f)))
                                             : 3 === l ? ((c = e[a + 1]), (u = e[a + 2]),
                                                           128 == (192 & c) && 128 == (192 & u)
                                                               && ((f = ((15 & d) << 12) | ((63 & c) << 6) | (63 & u)),
                                                                   2047 < f && (55296 > f || 57343 < f) && (s = f)))
                                                        : 4 === l ? ((c = e[a + 1]), (u = e[a + 2]), (p = e[a + 3]),
                                                                      128 == (192 & c) && 128 == (192 & u) && 128 == (192 & p)
                                                                          && ((f = ((15 & d) << 18) | ((63 & c) << 12) | ((63 & u) << 6)
                                                                                   | (63 & p)),
                                                                              65535 < f && 1114112 > f && (s = f)))
                                                                   : void 0;
                        }
                        null === s ? ((s = 65533), (l = 1))
                                    : 65535 < s && ((s -= 65536), r.push(55296 | (1023 & (s >>> 10))), (s = 56320 | (1023 & s))),
                             r.push(s), (a += l);
                    }
                    return N(r);
                }
                function N(e)
                {
                    ...
                    for (var r = "", a = 0; a < n;)
                        r += t.apply(String, e.slice(a, (a += 4096)));
                    return r;
                }
                function D(e, n, r)
                {
                ...
                {
                    return ((t = +t), (n >> >= 0), a || B(e, t, n, 4, 34028234663852886e22, -34028234663852886e22),
                            J.write(e, t, n, r, 23, 4), n + 4);
                }
                function j(e, t, n, r, a)
                {
                    return ((t = +t), (n >> >= 0), a || B(e, t, n, 8, 17976931348623157e292, -17976931348623157e292),
                            J.write(e, t, n, r, 52, 8), n + 8);
                }
                function q(e)
                {
                    if (((e = e.split("=")[0]), (e = e.trim().replace(Q, "")), 2 > e.length))
                        return "";
                    for (; 0 != e.length % 4;)
                        e += "=";
                    return e;
                ...
                function K(e, t)
                {
                    return (
                        e
                        instanceof t || (null != e && null != e.constructor && null != e.constructor.name && e.constructor.name === t.name));
                }
                function X(e)
                {
                    return e != = e;
                ...
                (n.Buffer = s), (n.SlowBuffer = function(e) { return +e != e && (e = 0), s.alloc(+e); }), (n.INSPECT_MAX_BYTES = 50);
    ...
    if ((K(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)), K(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)),
    ...
    var a = this.length - t;
    if (((void 0 === n || n > a) && (n = a), (0 < e.length && (0 > n || 0 > t)) || t > this.length))
...
(s.prototype.slice =
     function(e, t) {
         var n = this.length;
         (e = ~~e), (t = t === void 0 ? n : ~~t), 0 > e ? ((e += n), 0 > e && (e = 0)) : e > n && (e = n),
             0 > t ? ((t += n), 0 > t && (t = 0)) : t > n && (t = n), t < e && (t = e);
         var r = this.subarray(e, t);
         return (r.__proto__ = s.prototype), r;
     }),
    (s.prototype.readUIntLE =
         function(e, t, n) {
    ...
    (s.prototype.readUInt8 = function(e, t) { return (e >> >= 0), t || O(e, 1, this.length), this[e]; }),
    (s.prototype.readUInt16LE = function(e, t) { return (e >> >= 0), t || O(e, 2, this.length), this[e] | (this[e + 1] << 8); }),
    (s.prototype.readUInt16BE = function(e, t) { return (e >> >= 0), t || O(e, 2, this.length), (this[e] << 8) | this[e + 1]; }),
    (s.prototype.readUInt32LE =
         function(e, t) {
             return ((e >> >= 0), t || O(e, 4, this.length), (this[e] | (this[e + 1] << 8) | (this[e + 2] << 16)) + 16777216 * this[e + 3]);
         }),
    (s.prototype.readUInt32BE =
         function(e, t) {
             return ((e >> >= 0), t || O(e, 4, this.length), 16777216 * this[e] + ((this[e + 1] << 16) | (this[e + 2] << 8) | this[e + 3]));
         }),
    (s.prototype.readIntLE =
         function(e, t, n) {
             (e >> >= 0), (t >> >= 0), n || O(e, t, this.length);
    ...
    (s.prototype.readInt8 =
         function(e, t) { return (e >> >= 0), t || O(e, 1, this.length), 128 & this[e] ? -1 * (255 - this[e] + 1) : this[e]; }),
    (s.prototype.readInt16LE =
         function(e, t) {
             (e >> >= 0), t || O(e, 2, this.length);
             var n = this[e] | (this[e + 1] << 8);
             return 32768 & n ? 4294901760 | n : n;
         }),
    (s.prototype.readInt16BE =
         function(e, t) {
             (e >> >= 0), t || O(e, 2, this.length);
             var n = this[e + 1] | (this[e] << 8);
             return 32768 & n ? 4294901760 | n : n;
         }),
    (s.prototype.readInt32LE =
         function(e, t) {
             return ((e >> >= 0), t || O(e, 4, this.length), this[e] | (this[e + 1] << 8) | (this[e + 2] << 16) | (this[e + 3] << 24));
         }),
    (s.prototype.readInt32BE =
         function(e, t) {
             return ((e >> >= 0), t || O(e, 4, this.length), (this[e] << 24) | (this[e + 1] << 16) | (this[e + 2] << 8) | this[e + 3]);
         }),
    (s.prototype.readFloatLE = function(e, t) { return (e >> >= 0), t || O(e, 4, this.length), J.read(this, e, !0, 23, 4); }),
    (s.prototype.readFloatBE = function(e, t) { return (e >> >= 0), t || O(e, 4, this.length), J.read(this, e, !1, 23, 4); }),
    (s.prototype.readDoubleLE = function(e, t) { return (e >> >= 0), t || O(e, 8, this.length), J.read(this, e, !0, 52, 8); }),
    (s.prototype.readDoubleBE = function(e, t) { return (e >> >= 0), t || O(e, 8, this.length), J.read(this, e, !1, 52, 8); }),
    (s.prototype.writeUIntLE =
         function(e, t, n, a) {
             if (((e = +e), (t >> >= 0), (n >> >= 0), !a)) {
                 var o = r(2, 8 * n) - 1;
                 F(this, e, t, n, o, 0);
    ...
    (s.prototype.writeUInt8 = function(e, t, n) { return (e = +e), (t >> >= 0), n || F(this, e, t, 1, 255, 0), (this[t] = 255 & e), t + 1; }),
    (s.prototype.writeUInt16LE = function(
         e, t, n) { return ((e = +e), (t >> >= 0), n || F(this, e, t, 2, 65535, 0), (this[t] = 255 & e), (this[t + 1] = e >>> 8), t + 2); }),
    (s.prototype.writeUInt16BE = function(
         e, t, n) { return ((e = +e), (t >> >= 0), n || F(this, e, t, 2, 65535, 0), (this[t] = e >>> 8), (this[t + 1] = 255 & e), t + 2); }),
    (s.prototype.writeUInt32LE =
         function(e, t, n) {
             return ((e = +e), (t >> >= 0), n || F(this, e, t, 4, 4294967295, 0), (this[t + 3] = e >>> 24), (this[t + 2] = e >>> 16),
                     (this[t + 1] = e >>> 8), (this[t] = 255 & e), t + 4);
         }),
    (s.prototype.writeUInt32BE =
         function(e, t, n) {
             return ((e = +e), (t >> >= 0), n || F(this, e, t, 4, 4294967295, 0), (this[t] = e >>> 24), (this[t + 1] = e >>> 16),
                     (this[t + 2] = e >>> 8), (this[t + 3] = 255 & e), t + 4);
         }),
    (s.prototype.writeIntLE =
         function(e, t, n, a) {
             if (((e = +e), (t >> >= 0), !a)) {
                 var o = r(2, 8 * n - 1);
                 F(this, e, t, n, o - 1, -o);
    ...
    (s.prototype.writeInt8 =
         function(e, t, n) {
             return ((e = +e), (t >> >= 0), n || F(this, e, t, 1, 127, -128), 0 > e && (e = 255 + e + 1), (this[t] = 255 & e), t + 1);
         }),
    (s.prototype.writeInt16LE =
         function(e, t, n) {
             return ((e = +e), (t >> >= 0), n || F(this, e, t, 2, 32767, -32768), (this[t] = 255 & e), (this[t + 1] = e >>> 8), t + 2);
         }),
    (s.prototype.writeInt16BE =
         function(e, t, n) {
             return ((e = +e), (t >> >= 0), n || F(this, e, t, 2, 32767, -32768), (this[t] = e >>> 8), (this[t + 1] = 255 & e), t + 2);
         }),
    (s.prototype.writeInt32LE =
         function(e, t, n) {
             return ((e = +e), (t >> >= 0), n || F(this, e, t, 4, 2147483647, -2147483648), (this[t] = 255 & e), (this[t + 1] = e >>> 8),
                     (this[t + 2] = e >>> 16), (this[t + 3] = e >>> 24), t + 4);
         }),
    (s.prototype.writeInt32BE =
         function(e, t, n) {
             return ((e = +e), (t >> >= 0), n || F(this, e, t, 4, 2147483647, -2147483648), 0 > e && (e = 4294967295 + e + 1),
                     (this[t] = e >>> 24), (this[t + 1] = e >>> 16), (this[t + 2] = e >>> 8), (this[t + 3] = 255 & e), t + 4);
         }),
    (s.prototype.writeFloatLE = function(e, t, n) { return U(this, e, t, !0, n); }),
    (s.prototype.writeFloatBE = function(e, t, n) { return U(this, e, t, !1, n); }),
    (s.prototype.writeDoubleLE = function(e, t, n) { return j(this, e, t, !0, n); }),
    (s.prototype.writeDoubleBE = function(e, t, n) { return j(this, e, t, !1, n); }),
    (s.prototype.copy =
         function(e, t, n, r) {
             if (!s.isBuffer(e))
...
;
    ...
    function i(e, t, r, i)
    {
        ...
        if ((a(r), (s = e._events),
             void 0 == =
                 s ? ((s = e._events = Object.create(null)), (e._eventsCount = 0))
                   : (void 0 != = s.newListener && (e.emit("newListener", t, r.listener ? r.listener : r), (s = e._events)), (l = s[t])),
             void 0 === l))
            (l = s[t] = r), ++e._eventsCount;
        else if (("function" == typeof l ? (l = s[t] = i ? [ r, l ] : [ l, r ])
                  : i                    ? l.unshift(r)
                                         : l.push(r),
                  (d = o(e)), 0 < d && l.length > d && !l.warned)) {
            l.warned = !0;
            var c = new Error("Possible EventEmitter memory leak detected. " + l.length + " "
    ...
    function _(e, t, n, r)
    {
        if ("function" == typeof e.on)
            ...
            e.addEventListener(t, function a(o) { r.once &&e.removeEventListener(t, a), n(o); });
        else
            throw new TypeError('The "emitter" argument must be of type EventEmitter. Received type ' + typeof e);
    }
    var h, m = "object" == typeof Reflect ? Reflect : null, b = m && "function" == typeof m.apply ? m.apply : function(e, t, n)
    {
    ...
    if ("function" == typeof s)
        ...
        for (var l = s.length, c = u(s, l), n = 0; n < l; ++n)
            b(c[n], this, t);
    return !0;
                        }),
    ...
    var n, r, o, d, s;
    if ((a(t), (r = this._events), void 0 === r))
        return this;
    if (((n = r[e]), void 0 === n))
        return this;
    if (n === t || n.listener === t)
        ...
        if (0 > o)
            return this;
        0 === o ? n.shift() : p(n, o), 1 === n.length && (r[e] = n[0]),
    ...
    t.exports = function()
    {
        ...
        var e = {
            ...
            RTCSessionDescription : globalThis.RTCSessionDescription || globalThis.mozRTCSessionDescription
    ...
    /*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ (
        o.read =
            function(t, n, a, o, l) {
                var c, u, p = 8 * l - o - 1, f = (1 << p) - 1, g = f >> 1, _ = -7, h = a ? l - 1 : 0, b = a ? -1 : 1, d = t[n + h];
        ...
        (o.write = function(a, o, l, u, p, f) {
            var h, b, y, g = Math.LN2, _ = Math.log, C = 8 * f - p - 1, R = (1 << C) - 1, E = R >> 1,
                         w = 23 === p ? r(2, -24) - r(2, -77) : 0, S = u ? 0 : f - 1, T = u ? 1 : -1,
                         d = 0 > o || (0 === o && 0 > 1 / o) ? 1 : 0;
            for (o = n(o), isNaN(o) || o === 1 / 0 ? ((b = isNaN(o) ? 1 : 0), (h = R))
                                                    : ((h = t(_(o) / g)), 1 > o * (y = r(2, -h)) && (h--, (y *= 2)),
                                                       (o += 1 <= h + E ? w / y : w * r(2, 1 - E)), 2 <= o * y && (h++, (y /= 2)),
                                                       h + E >= R   ? ((b = 0), (h = R))
                                                       : 1 <= h + E ? ((b = (o * y - 1) * r(2, p)), (h += E))
                                                                    : ((b = o * r(2, E - 1) * r(2, p)), (h = 0)));
                 8 <= p; a[l + S] = 255 & b, S += T, b /= 256, p -= 8)
                ;
    ...
    function a(e)
    {
        if (((e += ""), !(100 < e.length))) {
                            ...
                            if (t) {
                                ...
                                return "years" === n || "year" === n || "yrs" === n || "yr" === n || "y" == =
                                           n ? 31557600000 * r
                                             : "weeks" === n || "week" === n || "w" == =
                                                   n ? 604800000 * r
                                                     : "days" === n || "day" === n || "d" == =
                                                           n ? 86400000 * r
                                                             : "hours" === n || "hour" === n || "hrs" === n || "hr" === n || "h" == =
                                                                   n ? 3600000 * r
                                                                     : "minutes" === n || "minute" === n || "mins" === n || "min" == =
                                                                           n || "m" == =
                                                                               n ? 60000 * r
                                                                                 : "seconds" === n || "second" === n || "secs" == =
                                                                                       n || "sec" === n || "s" == =
                                                                                           n ? 1000 * r
    ...
    {
        var t = n(e);
        return 86400000 <= t  ? r(e / 86400000) + "d"
               : 3600000 <= t ? r(e / 3600000) + "h"
               : 60000 <= t   ? r(e / 60000) + "m"
               : 1000 <= t    ? r(e / 1000) + "s"
                              : e + "ms";
    }
    ...
    {
        var t = n(e);
        return 86400000 <= t  ? s(e, t, 86400000, "day")
               : 3600000 <= t ? s(e, t, 3600000, "hour")
               : 60000 <= t   ? s(e, t, 60000, "minute")
               : 1000 <= t    ? s(e, t, 1000, "second")
                              : e + " ms";
    }
    function s(e, t, a, n)
    {
    ...
    (p.nextTick =
        ...
        (s.prototype.run = function() { this.fun.apply(null, this.array); }), (p.title = "browser"), (p.browser = !0), (p.env = {}),
        (p.argv = []), (p.version = ""), (p.versions = {}), (p.on = l), (p.addListener = l), (p.once = l), (p.off = l),
        (p.removeListener = l), (p.removeAllListeners = l), (p.emit = l), (p.prependListener = l), (p.prependOnceListener = l),
        (p.listeners = function() { return []; }), (p.binding = function() { throw new Error("process.binding is not supported"); }),
        (p.cwd = function() { return "/"; }), (p.chdir = function() { throw new Error("process.chdir is not supported"); }),
    ...
    t.exports = "function" == typeof queueMicrotask
                    ? queueMicrotask.bind(globalThis)
                    : (e) = > (n || (n = Promise.resolve())).then(e).catch((e) = > setTimeout(() = > { throw e; }, 0));
                },
                {},
            ],
            14: [
    ...
    (function(n, r) {
            ...
            t.exports = o && o.getRandomValues ? function(e, t)
            {
                ...
                if (0 < e)
                    if (65536 < e)
                        ...
                        o.getRandomValues(r);
                return "function" == typeof t ? n.nextTick(function() { t(null, r); }) : r;
            }
                                    : function ()
                                    {
                                        throw new Error(
        ...
        .call(this, e("_process"),
              "undefined" == typeof global ? "undefined" == typeof self ? "undefined" == typeof window ? {} : window : self : global);
                },
    ...
    function a(e, t)
    {
        if (Array.isArray(e)) {
            var n = e.length;
            return ((e = e.map(function(e) { return e + ""; })),
                    2 < n ? "one of ".concat(t, " ").concat(e.slice(0, n - 1).join(", "), ", or ") + e[n - 1]
                          : 2 === n ? "one of ".concat(t, " ").concat(e[0], " or ").concat(e[1]) : "of ".concat(t, " ").concat(e[0]));
        }
    ...
    r(
        ...
        r(
            "ERR_METHOD_NOT_IMPLEMENTED", function(e) { return "The " + e + " method is not implemented"; }),
        r("ERR_STREAM_PREMATURE_CLOSE", "Premature close"),
        r(
            "ERR_STREAM_DESTROYED", function(e) { return "Cannot call " + e + " after a stream was destroyed"; }),
        ...
        r("ERR_STREAM_UNSHIFT_AFTER_END_EVENT", "stream.unshift() after end event"), (t.exports.codes = s);
                },
                {},
            ],
            16: [
            ...
            {
                return this
                    instanceof r ? void(d.call(this, e), s.call(this, e), (this.allowHalfOpen = !0),
                                        e
                                            && (!1 === e.readable && (this.readable = !1), !1 === e.writable && (this.writable = !1),
...
,
    ...
    e("inherits")(n, r), (n.prototype._transform = function(e, t, n) { n(null, e); });
                },
    ...
    (function(n, r) {
            ...
            function i(e, t, n)
            {
                return "function" == typeof e.prependListener
                           ...
                           : void(e._events && e._events[t]
                                      ? Array.isArray(e._events[t]) ? e._events[t].unshift(n) : (e._events[t] = [ n, e._events[t] ])
                                      : e.on(t, n));
            }
            function d(t, n, r)
            {
                (A = A || e("./_stream_duplex")), (t = t || {}), "boolean" != typeof r && (r = n instanceof A),
                    (this.objectMode = !!t.objectMode), r && (this.objectMode = this.objectMode || !!t.readableObjectMode),
                    (this.highWaterMark = H(this, t, "readableHighWaterMark", r)), (this.buffer = new j()), (this.length = 0),
                    (this.pipes = null), (this.pipesCount = 0), (this.flowing = null), (this.ended = !1), (this.endEmitted = !1),
                    (this.reading = !1), (this.sync = !0), (this.needReadable = !1), (this.emittedReadable = !1),
                    (this.readableListening = !1), (this.resumeScheduled = !1), (this.paused = !0), (this.emitClose = !1 != = t.emitClose),
                    (this.autoDestroy = !!t.autoDestroy), (this.destroyed = !1), (this.defaultEncoding = t.defaultEncoding || "utf8"),
                    (this.awaitDrain = 0), (this.readingMore = !1), (this.decoder = null), (this.encoding = null),
                    t.encoding
                        && (!F && (F = e("string_decoder/").StringDecoder), (this.decoder = new F(t.encoding)),
            ...
            function s(t)
            {
                ...
                (this._readableState = new d(t, this, n)), (this.readable = !0),
                    t
            ...
            function l(e, t, n, r, o)
            {
                ...
                if (null === t)
                    ...
                    if ((o || (d = u(i, t)), d))
                        ...
                        r || ((i.reading = !1), m(e, i));
                    else if (("string" == typeof t || i.objectMode || Object.getPrototypeOf(t) === P.prototype || (t = a(t)), r))
                        ...
                        if (i.destroyed)
                            return !1;
                        (i.reading = !1), i.decoder && !n
                                              ? ((t = i.decoder.write(t)), i.objectMode || 0 != = t.length ? c(e, i, t, !1) : m(e, i))
                                              : c(e, i, t, !1);
                    }
                }
            ...
            function c(e, t, n, r)
            {
                t.flowing&& 0 === t.length && !t.sync ? ((t.awaitDrain = 0), e.emit("data", n))
                                                       : ((t.length += t.objectMode ? 1 : n.length),
                                                          r ? t.buffer.unshift(n) : t.buffer.push(n), t.needReadable && _(e)),
                              m(e, t);
            }
            function u(e, t)
            {
                var n;
                return (o(t) || "string" == typeof t || void 0 === t || e.objectMode
                                                                    || (n = new V("chunk", [ "string", "Buffer", "Uint8Array" ], t)),
                        n);
            }
            function p(e)
            {
                return (1073741824 <= e ? (e = 1073741824)
                                        : (e--, (e |= e >>> 1), (e |= e >>> 2), (e |= e >>> 4), (e |= e >>> 8), (e |= e >>> 16), e++),
                        e);
            }
            function f(e, t)
            {
                return 0 >= e || (0 === t.length && t.ended) ? 0
                       : t.objectMode                         ? 1
                                      : e === e                       ? (e > t.highWaterMark && (t.highWaterMark = p(e)), e <= t.length ? e
                                                                                                                           : t.ended     ? t.length
                                                                                                                                     : ((t.needReadable = !0), 0))
                                                                     : t.flowing && t.length ? t.buffer.head.data.length
                                                                       : t.length;
            }
            function g(e, t)
            {
            ...
            function _(e)
            {
                ...
                x("emitReadable", t.needReadable, t.emittedReadable), (t.needReadable = !1),
                    t.emittedReadable || (x("emitReadable", t.flowing), (t.emittedReadable = !0), n.nextTick(h, e));
            }
            function h(e)
            {
                var t = e._readableState;
                x("emitReadable_", t.destroyed, t.length, t.ended),
                    ...
                    (t.needReadable = !t.flowing && !t.ended && t.length <= t.highWaterMark), S(e);
            }
            function m(e, t)
            {
            ...
            function y(e)
            {
                ...
                {
                    var t = e._readableState;
                    x("pipeOnDrain", t.awaitDrain), t.awaitDrain &&t.awaitDrain--,
            ...
            function w(e, t)
            {
                x("resume", t.reading), t.reading || e.read(0), (t.resumeScheduled = !1), e.emit("resume"), S(e),
            ...
            function T(e, t)
            {
                if (0 === t.length)
                    return null;
                var n;
                return (t.objectMode ? (n = t.buffer.shift())
                        : !e || e >= t.length
            ...
            var A;
            s.ReadableState = d;
            var x, N = e("events").EventEmitter, D = function(e, t)
            {
                return e.listeners(t).length;
            }
            , I = e("./internal/streams/stream"), P = e("buffer").Buffer, M = r.Uint8Array || function(){}, O = e("util");
            x = O && O.debuglog ? O.debuglog("stream") : function(){};
            var F, B, U, j = e("./internal/streams/buffer_list"), q = e("./internal/streams/destroy"), W = e("./internal/streams/state"),
                         H = W.getHighWaterMark, Y = e("../errors").codes, V = Y.ERR_INVALID_ARG_TYPE, z = Y.ERR_STREAM_PUSH_AFTER_EOF,
                         G = Y.ERR_METHOD_NOT_IMPLEMENTED, K = Y.ERR_STREAM_UNSHIFT_AFTER_END_EVENT;
            e("inherits")(s, I);
        ...
        (s.prototype.destroy = q.destroy), (s.prototype._undestroy = q.undestroy), (s.prototype._destroy = function(e, t) { t(e); }),
        (s.prototype.push =
             function(e, t) {
                 var n, r = this._readableState;
                 return (r.objectMode ? (n = !0)
                                      : "string" == typeof e
                                            && ((t = t || r.defaultEncoding), t != = r.encoding && ((e = P.from(e, t)), (t = "")), (n = !0)),
                         l(this, e, t, !1, n));
             }),
        (s.prototype.unshift = function(e) { return l(this, e, null, !0, !1); }),
        (s.prototype.isPaused = function() { return !1 === this._readableState.flowing; }), (s.prototype.setEncoding = function(t) {
            ...
            return (this._readableState.buffer.clear(), "" != = a && this._readableState.buffer.push(a),
                    (this._readableState.length = a.length), this);
        });
        ...
        if ((0 != = e && (t.emittedReadable = !1),
            ...
            return x("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? v(this) : _(this), null;
        if (((e = f(e, t)), 0 === e && t.ended))
            return 0 === t.length && v(this), null;
        var a = t.needReadable;
        x("need readable", a), (0 === t.length || t.length - e < t.highWaterMark) && ((a = !0), x("length less than watermark", a)),
            t.ended || t.reading ? ((a = !1), x("reading or ended", a))
                                 : a
                                       && (x("do read"), (t.reading = !0), (t.sync = !0), 0 === t.length && (t.needReadable = !0),
                                           this._read(t.highWaterMark), (t.sync = !1), !t.reading && (e = f(r, t)));
        var o;
        return ((o = 0 < e ? T(e, t) : null),
                null === o ? ((t.needReadable = t.length <= t.highWaterMark), (e = 0)) : ((t.length -= e), (t.awaitDrain = 0)),
                0 === t.length && (!t.ended && (t.needReadable = !0), r != = e && t.ended && v(this)), null != = o && this.emit("data", o),
                o);
                            }),
        ...
        function o()
        {
            x("cleanup"), e.removeListener("close", l), e.removeListener("finish", c), e.removeListener("drain", h),
                e.removeListener("error", s), e.removeListener("unpipe", r), p.removeListener("end", a), p.removeListener("end", u),
                p.removeListener("data", d), (m = !0), f.awaitDrain && (!e._writableState || e._writableState.needDrain) && h();
        }
        function d(t)
        {
            x("ondata");
            var n = e.write(t);
            x("dest.write", n), !1 === n
                                        && (((1 === f.pipesCount&& f.pipes === e) || (1 < f.pipesCount&& -1 != = L(f.pipes, e))) && !m
        ...
        var g = (!t || !1 != = t.end)&&e != = n.stdout &&e != = n.stderr, _ = g ? a : u;
        f.endEmitted ? n.nextTick(_) : p.once("end", _), e.on("unpipe", r);
        var h = y(p);
        e.on("drain", h);
        var m = !1;
        return (p.on("data", d), i(e, "error", s), e.once("close", l), e.once("finish", c), e.emit("pipe", p),
                f.flowing || (x("pipe resume"), p.resume()), e);
                                }),
        ...
        if (0 === t.pipesCount)
            return this;
        if (1 === t.pipesCount)
            return e && e != = t.pipes ? this
                                       : (e || (e = t.pipes), (t.pipes = null), (t.pipesCount = 0), (t.flowing = !1),
                                          e && e.emit("unpipe", this, n), this);
        if (!e) {
        ...
        var d = L(t.pipes, e);
        return -1 === d ? this
                         : (t.pipes.splice(d, 1), (t.pipesCount -= 1), 1 === t.pipesCount && (t.pipes = t.pipes[0]),
                            e.emit("unpipe", this, n), this);
                                }),
                                (s.prototype.on = function (e, t) {
        var r = I.prototype.on.call(this, e, t), a = this._readableState;
        return ("data" === e ? ((a.readableListening = 0 < this.listenerCount("readable")), !1 != = a.flowing && this.resume())
                              : "readable" == e && !a.endEmitted && !a.readableListening
                                    && ((a.readableListening = a.needReadable = !0), (a.flowing = !1), (a.emittedReadable = !1),
                                        x("on readable", a.length, a.reading), a.length ? _(this) : !a.reading && n.nextTick(R, this)),
                r);
                                }),
        ...
        return (x("call pause flowing=%j", this._readableState.flowing),
                !1 != = this._readableState.flowing && (x("pause"), (this._readableState.flowing = !1), this.emit("pause")),
                (this._readableState.paused = !0), this);
                                }),
        ...
        for (var o in (e.on(
                       ...
                       e.on(
                           "data",
                           function(n) {
                               if ((x("wrapped data"), r.decoder && (n = r.decoder.write(n)),
        ...
        return ((this._read = function(t) { x("wrapped _read", t), a && ((a = !1), e.resume()); }), this);
                                }),
...
,
    ...
    {
        return this
            instanceof r ? void(u.call(this, e), (this._transformState = {
    ...
    {
        var e = this;
        "function" != typeof this._flush || this._readableState.destroyed ? o(this, null, null)
                                                                          : this._flush(function(t, n) { o(e, t, n); });
    }
    function o(e, t, n)
    {
        if (t)
    ...
    t.exports = r;
    var i = e("../errors").codes, d = i.ERR_METHOD_NOT_IMPLEMENTED, s = i.ERR_MULTIPLE_CALLBACK, l = i.ERR_TRANSFORM_ALREADY_TRANSFORMING,
        c = i.ERR_TRANSFORM_WITH_LENGTH_0, u = e("./_stream_duplex");
    e("inherits")(r, u),
        (r.prototype.push = function(e, t) { return (this._transformState.needTransform = !1), u.prototype.push.call(this, e, t); }),
        (r.prototype._transform = function(e, t, n) { n(new d("_transform()")); }),
        (r.prototype._write =
             function(e, t, n) {
        ...
        (r.prototype._destroy = function(e, t) { u.prototype._destroy.call(this, e, function(e) { t(e); }); });
                },
            ...
            {
                var t = this;
                (this.next = null), (this.entry = null), (this.finish = function() { v(t, e); });
            }
            function o(e)
            {
                return x.from(e);
            ...
            function s(t, n, r)
            {
                (k = k || e("./_stream_duplex")), (t = t || {}), "boolean" != typeof r && (r = n instanceof k),
                    (this.objectMode = !!t.objectMode), r && (this.objectMode = this.objectMode || !!t.writableObjectMode),
                    (this.highWaterMark = P(this, t, "writableHighWaterMark", r)), (this.finalCalled = !1), (this.needDrain = !1),
                    (this.ending = !1), (this.ended = !1), (this.finished = !1), (this.destroyed = !1);
                var o = !1 === t.decodeStrings;
                (this.decodeStrings = !o), (this.defaultEncoding = t.defaultEncoding || "utf8"), (this.length = 0), (this.writing = !1),
                    (this.corked = 0), (this.sync = !0), (this.bufferProcessing = !1), (this.onwrite = function(e) { m(n, e); }),
                    ...
                    (this.autoDestroy = !!t.autoDestroy), (this.bufferedRequestCount = 0), (this.corkedRequestsFree = new a(this));
            }
            function l(t)
            {
                k = k || e("./_stream_duplex");
                var n = this instanceof k;
                return n || V.call(l, this) ? void((this._writableState = new s(t, this, n)), (this.writable = !0),
                                                   t
            ...
            {
                var o;
                return (null === r ? (o = new q())
                                    : "string" != typeof r && !t.objectMode && (o = new O("chunk", [ "string", "Buffer" ], r)),
            ...
            {
                (t.writelen = r), (t.writecb = i), (t.writing = !0), (t.sync = !0),
                    t.destroyed ? t.onwrite(new j("write"))
            ...
            {
                --t.pendingcb, r ? (n.nextTick(o, a), n.nextTick(S, e, t), (e._writableState.errorEmitted = !0), Y(e, a))
            ...
            function m(e, t)
            {
                var r = e._writableState, a = r.sync, o = r.writecb;
                if ("function" != typeof o)
                    throw new B();
                if ((h(r), t))
                    _(e, r, a, t, o);
            ...
            function C(e, t)
            {
                ...
                if (e._writev && n && n.next) {
                    var r = t.bufferedRequestCount, o = Array(r), i = t.corkedRequestsFree;
                    i.entry = n;
                    for (var d = 0, s = !0; n;)
                        (o[d] = n), n.isBuf || (s = !1), (n = n.next), (d += 1);
                    (o.allBuffers = s), g(e, t, !0, t.length, o, "", i.finish), t.pendingcb++, (t.lastBufferedRequest = null),
                        i.next ? ((t.corkedRequestsFree = i.next), (i.next = null)) : (t.corkedRequestsFree = new a(t)),
                        (t.bufferedRequestCount = 0);
                } else {
                    for (; n;) {
                        var l = n.chunk, c = n.encoding, u = n.callback, p = t.objectMode ? 1 : l.length;
                        if ((g(e, t, !1, p, l, c, u), (n = n.next), t.bufferedRequestCount--, t.writing))
                            break;
                    }
            ...
            function E(e, t)
            {
                e._final(function(n) { t.pendingcb--, n &&Y(e, n), (t.prefinished = !0), e.emit("prefinish"), S(e, t); });
            }
            function w(e, t)
            {
                t.prefinished || t.finalCalled
                    || ("function" != typeof e._final || t.destroyed ? ((t.prefinished = !0), e.emit("prefinish"))
            ...
            var k;
            l.WritableState = s;
            var L = {deprecate : e("util-deprecate")}, A = e("./internal/streams/stream"), x = e("buffer").Buffer,
                N = r.Uint8Array || function(){}, D = e("./internal/streams/destroy"), I = e("./internal/streams/state"),
                P = I.getHighWaterMark, M = e("../errors").codes, O = M.ERR_INVALID_ARG_TYPE, F = M.ERR_METHOD_NOT_IMPLEMENTED,
                B = M.ERR_MULTIPLE_CALLBACK, U = M.ERR_STREAM_CANNOT_PIPE, j = M.ERR_STREAM_DESTROYED, q = M.ERR_STREAM_NULL_VALUES,
                W = M.ERR_STREAM_WRITE_AFTER_END, H = M.ERR_UNKNOWN_ENCODING, Y = D.errorOrDestroy;
            e("inherits")(l, A),
            ...
            "function" == typeof Symbol&& Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance]
                ? ((V = Function.prototype[Symbol.hasInstance]), Object.defineProperty(l, Symbol.hasInstance, {
                      value : function(e){return !!V.call(this, e) || (!(this != = l) && e && e._writableState instanceof s);
                                      },
                                  }))
                                : (V = function (e) {
        ...
        var r = this._writableState, a = !1, s = !r.objectMode && i(e);
        return (s && !x.isBuffer(e) && (e = o(e)), "function" == typeof t && ((n = t), (t = null)),
                s ? (t = "buffer") : !t && (t = r.defaultEncoding), "function" != typeof n && (n = d),
                r.ending ? c(this, n) : (s || u(this, r, e, n)) && (r.pendingcb++, (a = f(this, r, s, e, t, n))), a);
                                }),
        ...
        if (("string" == typeof e && (e = e.toLowerCase()), !(-1 <
                                                              [
                                                                  "hex",
                                                                  "utf8",
                                                                  "utf-8",
...
,
    ...
    return ("function" == typeof e ? ((n = e), (e = null), (t = null)) : "function" == typeof t && ((n = t), (t = null)),
            null != = e && void 0 != = e && this.write(e, t), r.corked && ((r.corked = 1), this.uncork()), r.ending || T(this, r, n), this);
                                }),
...
,
    ...
    t(e);
            ...
            function d(e, t)
            {
                return function(n, r)
                {
                    e.then(function() { return t[f] ? void n(a(void 0, !0)) : void t[_](n, r); }, r);
                };
            }
                            var s,
                                l = e("./end-of-stream"),
            ...
            if (this[h].destroyed)
                return new Promise(function(t, r) { n.nextTick(function() { e[p] ? r(e[p]) : t(a(void 0, !0)); }); });
            var r, o = this[g];
            if (o)
        ...
        return this;
                                    ...
                                    r(s, "return", function () {
        var e = this;
        return new Promise(function(t, n) { e[h].destroy(null, function(e) { return e ? void n(e) : void t(a(void 0, !0)); }); });
                                    }),
                                    s),
                                    m
                                );
...
;
    ...
    function r(e)
    {
        for (var t, r = 1; r < arguments.length; r++)
            (t = null == arguments[r] ? {} : arguments[r]),
                r % 2 ? n(Object(t), !0).forEach(function(n) { a(e, n, t[n]); })
    ...
    function i(e, t)
    {
        for (var n, r = 0; r < t.length; r++)
            (n = t[r]), (n.enumerable = n.enumerable || !1), (n.configurable = !0), "value" in n && (n.writable = !0),
...
, {key : "shift", value : function(){if (0 != = this.length){var e = this.head.data;
return (this.head = 1 === this.length ? (this.tail = null) : this.head.next), --this.length, e;
}
}
,
}
, {key : "clear", value : function(){(this.head = this.tail = null), (this.length = 0);
}
,
}
, {key : "join", value : function(e){if (0 === this.length) return "";
...
, {key : "concat", value : function(e){if (0 === this.length) return u.alloc(0);
...
, {key : "consume", value : function(e, t){var n;
return (e < this.head.data.length ? ((n = this.head.data.slice(0, e)), (this.head.data = this.head.data.slice(e)))
                                  : e === this.head.data.length ? (n = this.shift()) : (n = t ? this._getString(e) : this._getBuffer(e)),
        n);
}
,
}
...
, {key : "_getString", value : function(e){var t = this.head, r = 1, a = t.data;
for (e -= a.length; (t = t.next);) {
    var o = t.data, i = e > o.length ? o.length : e;
...
, {key : "_getBuffer", value : function(e){var t = u.allocUnsafe(e), r = this.head, a = 1;
for (r.data.copy(t), e -= r.data.length; (r = r.next);) {
    var o = r.data, i = e > o.length ? o.length : e;
...
, {key : g, value : function(e, t){return f(this, r({}, t, {depth : 0, customInspect : !1}));
}
,
},
                            ]),
            ...
            t.exports = {destroy : function(t, o){var i = this, d = this._readableState && this._readableState.destroyed,
            ...
            return d || s ? (o ? o(t)
                          ...
                          : (this._readableState && (this._readableState.destroyed = !0),
                             ...
                             this._destroy(
                                 t || null,
                                 function(t) {
                                     !o&& t ? i._writableState ? i._writableState.errorEmitted
                                                                     ? e.nextTick(r, i)
                                                                     : ((i._writableState.errorEmitted = !0), e.nextTick(n, i, t))
                                                               : e.nextTick(n, i, t)
                                     : o ? (e.nextTick(r, i), o(t))
                                            : e.nextTick(r, i);
                                 }),
                             this);
                                },
                                undestroy: function () {
            this._readableState
                && ((this._readableState.destroyed = !1), (this._readableState.reading = !1), (this._readableState.ended = !1),
                    (this._readableState.endEmitted = !1)),
                this._writableState
                    && ((this._writableState.destroyed = !1), (this._writableState.ended = !1), (this._writableState.ending = !1),
                        (this._writableState.finalCalled = !1), (this._writableState.prefinished = !1), (this._writableState.finished = !1),
    ...
    function o(e, t, d)
    {
        if ("function" == typeof t)
            return o(e, null, t);
        t || (t = {}), (d = n(d || r));
        var s = t.readable || (!1 != = t.readable && e.readable), l = t.writable || (!1 != = t.writable && e.writable), c = function()
        {
            e.writable || p();
        }
        ...
        , f = e._readableState && e._readableState.endEmitted, g = function()
        {
            (s = !1), (f = !0), l || d.call(e);
        }
        , _ = function(t)
        ...
        {
            var t;
            return s && !f   ? ((e._readableState && e._readableState.ended) || (t = new i()), d.call(e, t))
                   : l && !u ? ((e._writableState && e._writableState.ended) || (t = new i()), d.call(e, t))
                             : void 0;
        }
        , m = function()
        {
        ...
        return (
            a(e) ? (e.on("complete", p), e.on("abort", h), e.req ? m() : e.on("request", m))
                 : l && !e._writableState && (e.on("end", c), e.on("close", c)),
            e.on("end", g), e.on("finish", p), !1 != = t.error && e.on("error", _), e.on("close", h), function() {
                e.removeListener("complete", p), e.removeListener("abort", h), e.removeListener("request", m),
                    e.req &&e.req.removeListener("finish", p), e.removeListener("end", c), e.removeListener("close", c),
                    e.removeListener("finish", p), e.removeListener("end", g), e.removeListener("error", _), e.removeListener("close", h);
            });
    }
    ...
    function o(t, r, o, i)
    {
        ...
        t.on(
            ...
            l === void 0 && (l = e("./end-of-stream")),
              l(t, {readable : r, writable : o}, function(e) { return e ? i(e) : void((d = !0), i()); });
        var s = !1;
        return function(e)
        {
            if (!d)
    ...
    t.exports = function()
    {
        ...
        var a, l = t.map(function(e, n) {
            var d = n < t.length - 1;
            return o(e, d, 0 < n, function(e) { a || (a = e), e &&l.forEach(i), d || (l.forEach(i), r(a)); });
        });
        return t.reduce(d);
    };
                },
    ...
    n.exports = {getHighWaterMark : function(e, n, o, i){var d = r(n, i, o);
    if (null != d) {
...
;
    ...
    t.exports = e("events").EventEmitter;
            ...
            29: [
                function (e, t, n) {
    (n = t.exports = e("./lib/_stream_readable.js")), (n.Stream = n), (n.Readable = n), (n.Writable = e("./lib/_stream_writable.js")),
        (n.Duplex = e("./lib/_stream_duplex.js")), (n.Transform = e("./lib/_stream_transform.js")),
        (n.PassThrough = e("./lib/_stream_passthrough.js")), (n.finished = e("./lib/internal/streams/end-of-stream.js")),
    ...
    /*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */ var o = e("buffer"), i = o.Buffer;
    i.from &&i.alloc &&i.allocUnsafe &&i.allocUnsafeSlow ? (t.exports = o) : (r(o, n), (n.Buffer = a)),
        (a.prototype = Object.create(i.prototype)), r(i, a),
        (a.from =
             function(e, t, n) {
                 if ("number" == typeof e)
    ...
    function s(e, t, n)
    {
        ...
        if (r < n)
            return 0;
        var a = d(t[r]);
        return 0 <= a ? (0 < a && (e.lastNeed = a - 1), a)
                      : --r < n || -2 == =
                            a ? 0
                            : ((a = d(t[r])), 0 <= a)
                                ? (0 < a && (e.lastNeed = a - 2), a)
                                : --r < n || -2 == =
                                      a ? 0 : ((a = d(t[r])), 0 <= a ? (0 < a && (2 === a ? (a = 0) : (e.lastNeed = a - 3)), a) : 0);
    }
    function l(e, t)
    {
        if (128 != (192 & t[0]))
    ...
    function c(e)
    {
        ...
        return void 0 === n ? this.lastNeed <= e.length
    ...
    function u(e, t)
    {
        if (0 == (e.length - t) % 2) {
            ...
            if (n) {
                ...
                if (55296 <= r && 56319 >= r)
                    return ((this.lastNeed = 2), (this.lastTotal = 4), (this.lastChar[0] = e[e.length - 2]),
    ...
    {
        var r = (e.length - t) % 3;
        return 0 == r ? e.toString("base64", t)
                      : ((this.lastNeed = 3 - r), (this.lastTotal = 3),
                         1 == r ? (this.lastChar[0] = e[e.length - 1])
    ...
    (n.StringDecoder = o),
        ...
        (o.prototype.fillLast = function(e) {
            return this.lastNeed <= e.length
                       ...
                       : void(e.copy(this.lastChar, this.lastTotal - this.lastNeed, 0, e.length), (this.lastNeed -= e.length));
        });
                },
                { "safe-buffer": 30 },
            ],
    ...
    /*! simple-peer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */ const a = e("debug")("simple-peer"),
                                                                                               o = e("get-browser-rtc"),
                                                                                               i = e("randombytes"),
                                                                                               d = e("readable-stream"),
                                                                                               s = e("queue-microtask"), l = e("err-code"),
                                                                                               {Buffer : c} = e("buffer"), u = 65536;
    class p extends d.Duplex{constructor(e){
        if (((e = Object.assign({allowHalfOpen : !1}, e)), super(e), (this._id = i(4).toString("hex").slice(0, 7)),
             this._debug("new peer %o", e), (this.channelName = e.initiator ? e.channelName || i(20).toString("hex") : null),
             (this.initiator = e.initiator || !1), (this.channelConfig = e.channelConfig || p.channelConfig),
             (this.channelNegotiated = this.channelConfig.negotiated), (this.config = Object.assign({}, p.config, e.config)),
             (this.offerOptions = e.offerOptions || {}), (this.answerOptions = e.answerOptions || {}),
             (this.sdpTransform = e.sdpTransform || ((e) = > e)), (this.streams = e.streams || (e.stream ? [e.stream] : [])),
             (this.trickle = void 0 === e.trickle || e.trickle),
             (this.allowHalfTrickle = void 0 != = e.allowHalfTrickle && e.allowHalfTrickle),
             (this.iceCompleteTimeout = e.iceCompleteTimeout || 5000), (this.destroyed = !1), (this.destroying = !1), (this._connected = !1),
             (this.remoteAddress = void 0), (this.remoteFamily = void 0), (this.remotePort = void 0), (this.localAddress = void 0),
             (this.localFamily = void 0), (this.localPort = void 0), (this._wrtc = e.wrtc && "object" == typeof e.wrtc ? e.wrtc : o()),
             !this._wrtc)) if ("undefined"
                               == typeof window) throw l(new Error("No WebRTC support: Specify `opts.wrtc` option in this environment"),
                                                         "ERR_WEBRTC_SUPPORT");
    else throw l(new Error("No WebRTC support: Not a supported browser"), "ERR_WEBRTC_SUPPORT");
    (this._pcReady = !1), (this._channelReady = !1), (this._iceComplete = !1), (this._iceCompleteTimer = null), (this._channel = null),
        (this._pendingCandidates = []), (this._isNegotiating = !1), (this._firstNegotiation = !0), (this._batchedNegotiation = !1),
        (this._queuedNegotiation = !1), (this._sendersAwaitingStable = []), (this._senderMap = new Map()), (this._closingInterval = null),
        (this._remoteTracks = []), (this._remoteStreams = []), (this._chunk = null), (this._cb = null), (this._interval = null);
    try {
    ...
    (this._isReactNativeWebrtc = "number" == typeof this._pc._peerConnectionId),
        ...
        "object" == typeof this._pc.peerIdentity&& this._pc.peerIdentity.catch((e) = > { this.destroy(l(e, "ERR_PC_PEER_IDENTITY")); }),
        this.initiator || this.channelNegotiated ? this._setupData({
            channel : this._pc.createDataChannel(this.channelName, this.channelConfig),
        })
                                                 : (this._pc.ondatachannel = (e) = > { this._setupData(e); }),
        this.streams&& this.streams.forEach((e) = > { this.addStream(e); }), (this._pc.ontrack = (e) = > { this._onTrack(e); }),
        this._debug("initial negotiation"), this._needsNegotiation(), (this._onFinishBound = () = > { this._onFinish(); }),
    ...
    if (!this.destroying) {
        ...
        this._debug("signal()"),
                                    ...
                                    e.sdp ||
                                        ...
                                        e.renegotiate ||
                                        e.transceiverRequest ||
                                        this.destroy(l(new Error("signal() called with invalid signal data"), "ERR_SIGNALING"));
    }
                        }
                        _addIceCandidate(e) {
    ...
    if (!this.destroying) {
        ...
        this._debug("addStream()"), e.getTracks().forEach((t) = > { this.addTrack(t, e); });
    }
                        }
                        addTrack(e, t) {
    if (this.destroying)
    ...
    const r = this._senderMap.get(e), a = r ? r.get(n) : null;
    if (!a)
        throw l(new Error("Cannot replace track that was never added."), "ERR_TRACK_NOT_ADDED");
    t&& this._senderMap.set(t, r),
        null == a.replaceTrack ? this.destroy(l(new Error("replaceTrack is not supported in this browser"), "ERR_UNSUPPORTED_REPLACETRACK"))
                               : a.replaceTrack(t);
                        }
                        removeTrack(e, t) {
    if (this.destroying)
    ...
    const n = this._senderMap.get(e), r = n ? n.get(t) : null;
    if (!r)
    ...
    if (!this.destroying) {
        ...
        this._debug("removeSenders()"), e.getTracks().forEach((t) = > { this.removeTrack(t, e); });
    }
                        }
                        _needsNegotiation() {
    this._debug("_needsNegotiation"),
        this._batchedNegotiation || ((this._batchedNegotiation = !0), s(() = > {
    ...
    if (!this.destroying) {
        ...
        this.initiator        ? this._isNegotiating ? ((this._queuedNegotiation = !0), this._debug("already negotiating, queueing"))
                                                    : (this._debug("start negotiation"), setTimeout(() = > { this._createOffer(); }, 0))
               : this._isNegotiating ? ((this._queuedNegotiation = !0), this._debug("already negotiating, queueing"))
                              : (this._debug("requesting negotiation from initiator"), this.emit("signal", {
                                    type : "renegotiate",
                                    renegotiate : !0,
                                })),
    ...
    this.destroyed || this.destroying
        || ((this.destroying = !0), this._debug("destroying (error: %s)", e && (e.message || e)), s(() = > {
                if (((this.destroyed = !0), (this.destroying = !1), this._debug("destroy (error: %s)", e && (e.message || e)),
                     (this.readable = this.writable = !1), this._readableState.ended || this.push(null),
                     this._writableState.finished || this.end(), (this._connected = !1), (this._pcReady = !1), (this._channelReady = !1),
                     (this._remoteTracks = null), (this._remoteStreams = null), (this._senderMap = null),
                     clearInterval(this._closingInterval), (this._closingInterval = null), clearInterval(this._interval),
                     (this._interval = null), (this._chunk = null), (this._cb = null),
    ...
    (this._channel = e.channel), (this._channel.binaryType = "arraybuffer"),
        "number" == typeof this._channel.bufferedAmountLowThreshold && (this._channel.bufferedAmountLowThreshold = u),
        (this.channelName = this._channel.label), (this._channel.onmessage = (e) = > { this._onChannelMessage(e); }),
        (this._channel.onbufferedamountlow = () = > { this._onChannelBufferedAmountLow(); }),
        (this._channel.onopen = () = > { this._onChannelOpen(); }), (this._channel.onclose = () = > { this._onChannelClose(); }),
        (this._channel.onerror = (e) = > { this.destroy(l(e, "ERR_DATA_CHANNEL")); });
    let t = !1;
    this._closingInterval =
        setInterval(() = > { this._channel&& "closing" === this._channel.readyState ? (t && this._onChannelClose(), (t = !0)) : (t = !1); },
                    5000);
                        }
                        _read() {}
                        _write(e, t, n) {
    ...
    this._pc.getTransceivers&& this._pc.getTransceivers().forEach(
        (e) = > { e.mid || !e.sender.track || e.requested || ((e.requested = !0), this.addTransceiver(e.sender.track.kind)); });
                        }
                        _createAnswer() {
    this.destroyed ||
                                this._pc
    ...
    this._debug("iceStateChange (connection: %s) (gathering: %s)", e, t), this.emit("iceStateChange", e, t),
        ("connected" === e || "completed" === e) && ((this._pcReady = !0), this._maybeReady()),
        "failed" === e && this.destroy(l(new Error("Ice connection failed."), "ERR_ICE_CONNECTION_FAILURE")),
                 "closed" === e && this.destroy(l(new Error("Ice connection closed."), "ERR_ICE_CONNECTION_CLOSED"));
                        }
                        getStats(e) {
    const t = (e) =
        > ("[object Array]" === Object.prototype.toString.call(e.values) && e.values.forEach((t) = > { Object.assign(e, t); }), e);
        ...
        this.destroyed || this.getStats((t, n) = > {
            ...
            n.forEach((e) = > {
                ("remotecandidate" === e.type || "remote-candidate" === e.type) && (r[e.id] = e),
                    ("localcandidate" === e.type || "local-candidate" === e.type) && (a[e.id] = e),
            ...
            const d = (e) = >
            {
                ...
                t && (t.ip || t.address) ? ((this.localAddress = t.ip || t.address), (this.localPort = +t.port))
                : t &&t.ipAddress        ? ((this.localAddress = t.ipAddress), (this.localPort = +t.portNumber))
                                         : "string" == typeof e.googLocalAddress
                                        && ((t = e.googLocalAddress.split(":")), (this.localAddress = t[0]), (this.localPort = +t[1])),
                    this.localAddress && (this.localFamily = this.localAddress.includes(":") ? "IPv6" : "IPv4");
                let n = r[e.remoteCandidateId];
                n && (n.ip || n.address) ? ((this.remoteAddress = n.ip || n.address), (this.remotePort = +n.port))
                : n &&n.ipAddress        ? ((this.remoteAddress = n.ipAddress), (this.remotePort = +n.portNumber))
                                         : "string" == typeof e.googRemoteAddress
                                        && ((n = e.googRemoteAddress.split(":")), (this.remoteAddress = n[0]), (this.remotePort = +n[1])),
                    this.remoteAddress && (this.remoteFamily = this.remoteAddress.includes(":") ? "IPv6" : "IPv4"),
                    this._debug("connect local: %s:%s remote: %s:%s", this.localAddress, this.localPort, this.remoteAddress,
                                this.remotePort);
            };
            if (
                                            (n.forEach((e) => {
                                                "transport" === e.type && e.selectedCandidatePairId && d(o[e.selectedCandidatePairId]),
            ...
            "number" != typeof this._channel.bufferedAmountLowThreshold
                && ((this._interval = setInterval(() = > this._onInterval(), 150)), this._interval.unref && this._interval.unref()),
                this._debug("connect"), this.emit("connect");
        });
    };
    e();
                        }
    ...
    this.destroyed
        || ("stable" === this._pc.signalingState
                          && ((this._isNegotiating = !1), this._debug("flushing sender queue", this._sendersAwaitingStable),
                              this._sendersAwaitingStable.forEach((e) = > { this._pc.removeTrack(e), (this._queuedNegotiation = !0); }),
            ...
            this._debug("signalingStateChange %s", this._pc.signalingState), this.emit("signalingStateChange", this._pc.signalingState));
                        }
                        _onIceCandidate(e) {
    this.destroyed
    ...
    this.destroyed || e.streams.forEach((t) = > {
        this._debug("on track"), this.emit("track", e.track, t), this._remoteTracks.push({track : e.track, stream : t}),
            this._remoteStreams.some((e) = > e.id === t.id)
                || (this._remoteStreams.push(t), s(() = > { this._debug("on stream"), this.emit("stream", t); }));
    });
                        }
                        _debug() {

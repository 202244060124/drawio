var rough = (function () {
    ...
    {
        const h = o, r = Math.max(n, 0.1), i = s[0] && s[0][0] && "number" == typeof s[0][0] ? [s] : s, c = [ 0, 0 ];
        if (h)
            for (const e of i)
                t(e, c, h);
        const l = (function(t, s, n) {
            ...
            if ((h.sort((t, e) = > t.ymin < e.ymin ? -1
                                 : t.ymin > e.ymin ? 1
                                 : t.x < e.x       ? -1
                                 : t.x > e.x       ? 1
                                                   : t.ymax === e.ymax ? 0 : (t.ymax - e.ymax) / Math.abs(t.ymax - e.ymax)),
                 !h.length))
                return a;
            ...
            for (; r.length || h.length;) {
                if (h.length) {
                    let t = -1;
                    for (let e = 0; e < h.length && !(h[e].ymin > i); e++)
                        t = e;
                    h.splice(0, t + 1).forEach((t) = > { r.push({s : i, edge : t}); });
                }
                if (((r = r.filter((t) = > !(t.edge.ymax <= i))),
                     r.sort((t, e) = > (t.edge.x === e.edge.x ? 0 : (t.edge.x - e.edge.x) / Math.abs(t.edge.x - e.edge.x))),
                ...
                (i += n), r.forEach((t) = > { t.edge.x = t.edge.x + n * t.edge.islope; }), c++;
            }
            return a;
        })(i, r, a);
        if (h) {
    ...
    function n(t, e)
    {
        ...
        let h = 1;
        return (e.roughness >= 1 && ((null === (n = e.randomizer) || void 0 === n ? void 0 : n.next()) || Math.random()) > 0.7 && (h = a),
                s(t, a, o, h || 1));
    }
    class o {
        constructor(t)
    ...
    class h extends o {
        fillPolygons(t, e)
        {
            ...
            const o = n(t, Object.assign({}, e, {hachureGap : s})), h = (Math.PI / 180) * e.hachureAngle, r = [], i = 0.5 * s * Math.cos(h),
                  c = 0.5 * s * Math.sin(h);
            for (const[t, e] of o)
                a([ t, e ]) && r.push([[t [0] - i, t [1] + c], [... e]], [[t [0] + i, t [1] - c], [... e]]);
        ...
        dotsOnLines(t, e)
        {
            ...
            const h = n / 4;
            for (const r of t) {
                const t = a(r), i = t / n, c = Math.ceil(i) - 1, l = t - c * n, u = (r[0][0] + r[1][0]) / 2 - n / 4,
                      p = Math.min(r[0][1], r[1][1]);
                for (let t = 0; t < c; t++) {
                    const a = p + l + t * n, r = u - h + 2 * Math.random() * h, i = a - h + 2 * Math.random() * h,
        ...
        dashedLine(t, e)
        {
            const s = e.dashOffset < 0 ? (e.hachureGap < 0 ? 4 * e.strokeWidth : e.hachureGap) : e.dashOffset,
                  n = e.dashGap < 0 ? (e.hachureGap < 0 ? 4 * e.strokeWidth : e.hachureGap) : e.dashGap, o = [];
            return (
                t.forEach((t) => {
                    const h = a(t),
                        r = Math.floor(h / (s + n)),
        ...
        fillPolygons(t, e)
        {
            const s = e.hachureGap < 0 ? 4 * e.strokeWidth : e.hachureGap, o = e.zigzagOffset < 0 ? s : e.zigzagOffset,
    ...
    function b(t)
    {
        const e = [], s = (function(t) {
                          ...
                          for (; "" != = t;)
                              if (t.match(/ ^([ \t\r\n,
                                  ...
                                  (e[e.length] = {type : f, text : RegExp.$1}), (t = t.substr(RegExp.$1.length));
                              else {
                        if (!t.match(/^(([-+]?[0-9]+(\.[0-9]*)?|[-+]?\.[0-9]+)([eE][-+]?[0-9]+)?)/))
                            return [];
                        (e[e.length] = {type : d, text : `${parseFloat(RegExp.$1)}` }), (t = t.substr(RegExp.$1.length));
                              }
        ...
        for (; !k(a, g);) {
            ...
            if ("BOD" === n) {
                ...
                k(a, d) ? (h = M[n]) : (o++, (h = M[a.text]), (n = a.text));
            if (!(o + h < s.length))
        ...
        for (const {key : h, data : r} of t)
            switch (h) {
                case "M":
                    ...
                    break;
                case "m":
                    (e += r[0]), (s += r[1]), a.push({key : "M", data : [ e, s ]}), (n = e), (o = s);
                    break;
                case "L":
                ...
                case "A":
                    ...
                    break;
                case "a":
                    (e += r[5]), (s += r[6]), a.push({key : "A", data : [ r[0], r[1], r[2], r[3], r[4], e, s ]});
                    break;
                case "H":
        ...
        for (const {key : c, data : l} of t) {
            switch (c) {
                case "M":
                    ...
                    break;
                case "C":
                    e.push({key : "C", data : [... l]}), (n = l[4]), (o = l[5]), (r = l[2]), (i = l[3]);
                    break;
                case "L":
                ...
                case "S": {
                    let t = 0, a = 0;
                    "C" === s || "S" === s ? ((t = n + (n - r)), (a = o + (o - i))) : ((t = n), (a = o)),
                        e.push({key : "C", data : [ t, a, ... l ]}), (r = l[0]), (i = l[1]), (n = l[2]), (o = l[3]);
                    break;
                }
                case "T": {
                    const[t, a] = l;
                    ...
                    e.push({key : "C", data : [ u, p, f, d, t, a ]}), (r = h), (i = c), (n = t), (o = a);
                    break;
                }
                case "Q": {
                    const[t, s, a, h] = l, c = n + (2 * (t - n)) / 3, u = o + (2 * (s - o)) / 3, p = a + (2 * (t - a)) / 3,
                                   f = h + (2 * (s - h)) / 3;
                    e.push({key : "C", data : [ c, u, p, f, a, h ]}), (r = t), (i = s), (n = a), (o = h);
                    break;
                }
                case "A": {
                    ...
                    if (0 === t || 0 === s)
                        ...
                        x(n, o, i, c, t, s, a, h, r).forEach(function(t) { e.push({key : "C", data : t}); }), (n = i), (o = c);
                    }
                    break;
                }
                case "Z":
    ...
    function x(t, e, s, n, o, a, h, r, i, c)
    {
        ...
        if (c)
            ...
            const p = o * o, k = a * a, b = p * k - p * c * c - k * h * h, y = p * c * c + k * h * h,
                  m = (r === i ? -1 : 1) * Math.sqrt(Math.abs(b / y));
            (g = (m * o * c) / a + (t + s) / 2), (M = (m * -a * h) / o + (e + n) / 2), (f = Math.asin(parseFloat(((e - M) / a).toFixed(9)))),
                (d = Math.asin(parseFloat(((n - M) / a).toFixed(9)))), t < g && (f = Math.PI - f), s < g && (d = Math.PI - d),
                f<0 && (f = 2 * Math.PI + f), d<0 && (d = 2 * Math.PI + d), i && f> d && (f -= 2 * Math.PI), !i && d> f
                    && (d -= 2 * Math.PI);
        }
        let k = d - f;
        if (Math.abs(k) > (120 * Math.PI) / 180) {
            ...
            (d = i && d > f ? f + ((120 * Math.PI) / 180) * 1 : f + ((120 * Math.PI) / 180) * -1),
                (p = x((s = g + o * Math.cos(d)), (n = M + a * Math.sin(d)), e, r, o, a, h, 0, i, [ d, t, g, M ]));
        }
        k = d - f;
        const b = Math.cos(f), y = Math.sin(f), m = Math.cos(d), P = Math.sin(d), v = Math.tan(k / 4), S = (4 / 3) * o * v,
              O = (4 / 3) * a * v, L = [ t, e ], T = [ t + S * y, e - O * b ], D = [ s + S * P, n - O * m ], A = [ s, n ];
    ...
    const P = {randOffset : function(t, e){return G(t, e);
        },
...
function S(t, e, s)
{
    ...
    if (n > 2) {
        ...
        return e && o.push(... $(t[n - 1][0], t[n - 1][1], t[0][0], t[0][1], s)), {type : "path", ops : o};
    }
...
{
    return (function(t, e) { return S(t, !0, e); })(
        [
            [ t, e ],
            [ t + s, e ],
            [ t + s, e + n ],
...
{
    if (t.length) {
        const s = "number" == typeof t[0][0] ? [t] : t, n = j(s[0], 1 * (1 + 0.2 * e.roughness), e),
              o = e.disableMultiStroke ? [] : j(s[0], 1.5 * (1 + 0.22 * e.roughness), z(e));
        for (let t = 1; t < s.length; t++) {
            const a = s[t];
            if (a.length) {
                const t = j(a, 1 * (1 + 0.2 * e.roughness), e), s = e.disableMultiStroke ? [] : j(a, 1.5 * (1 + 0.22 * e.roughness), z(e));
                for (const e of t)
                    "move" != = e.op && n.push(e);
                for (const t of s)
                    "move" != = t.op && o.push(t);
...
function T(t, e, s)
{
    const n = Math.sqrt(2 * Math.PI * Math.sqrt((Math.pow(t / 2, 2) + Math.pow(e / 2, 2)) / 2)),
          o = Math.ceil(Math.max(s.curveStepCount, (s.curveStepCount / Math.sqrt(200)) * n)), a = (2 * Math.PI) / o;
    let h = Math.abs(t / 2), r = Math.abs(e / 2);
    const i = 1 - s.curveFitting;
    return (h += G(h * i, s)), (r += G(r * i, s)), {increment : a, rx : h, ry : r};
}

function D(t, e, s, n)
{
    const[o, a] = F(n.increment, t, e, n.rx, n.ry, 1, n.increment * E(0.1, E(0.4, 1, s), s), s);
    let h = q(o, null, s);
...
function A(t, e, s, n, o, a, h, r, i)
{
    ...
    return (h
                && (r ? k.push(... $(c, l, c + u * Math.cos(f), l + p * Math.sin(f), i),
                               ... $(c, l, c + u * Math.cos(d), l + p * Math.sin(d), i))
                      : k.push({op : "lineTo", data : [ c, l ]}, {op : "lineTo", data : [ c + u * Math.cos(f), l + p * Math.sin(f) ]})),
            {type : "path", ops : k});
}
...
function R(t, e, s, n, o, a, h)
{
    ...
    return (a && (h ? g.push({op : "move", data : [ t + (b ? 0 : M()), e + (b ? 0 : M()) ]}) : g.push({
                op : "move",
...
function j(t, e, s)
{
    ...
    for (let o = 1; o < t.length; o++)
        n.push([ t[o][0] + G(e, s), t[o][1] + G(e, s) ]), o === t.length - 1 && n.push([ t[o][0] + G(e, s), t[o][1] + G(e, s) ]);
    return q(n, null, s);
}
...
function q(t, e, s)
{
    ...
    if (n > 3) {
        ...
        for (let e = 1; e + 2 < n; e++) {
            const s = t[e];
            (a[0] = [ s[0], s[1] ]),
                (a[1] = [ s[0] + (h * t[e + 1][0] - h * t[e - 1][0]) / 6, s[1] + (h * t[e + 1][1] - h * t[e - 1][1]) / 6 ]),
                (a[2] = [ t[e + 1][0] + (h * t[e][0] - h * t[e + 2][0]) / 6, t[e + 1][1] + (h * t[e][1] - h * t[e + 2][1]) / 6 ]),
                (a[3] = [ t[e + 1][0], t[e + 1][1] ]), o.push({
                    op : "bcurveTo",
        ...
        3 === n ? (o.push({op : "move", data : [ t[1][0], t[1][1] ]}), o.push({
            op : "bcurveTo",
...
function F(t, e, s, n, o, a, h, r)
{
    ...
    if (0 === r.roughness) {
        ...
        c.push([ G(a, r) + e + 0.9 * n * Math.cos(l - t), G(a, r) + s + 0.9 * o * Math.sin(l - t) ]);
        const u = 2 * Math.PI + l - 0.01;
        for (let h = l; h < u; h += t) {
            const t = [ G(a, r) + e + n * Math.cos(h), G(a, r) + s + o * Math.sin(h) ];
            i.push(t), c.push(t);
        }
        c.push([ G(a, r) + e + n * Math.cos(l + 2 * Math.PI + 0.5 * h), G(a, r) + s + o * Math.sin(l + 2 * Math.PI + 0.5 * h) ]),
            c.push([ G(a, r) + e + 0.98 * n * Math.cos(l + h), G(a, r) + s + 0.98 * o * Math.sin(l + h) ]),
            c.push([ G(a, r) + e + 0.9 * n * Math.cos(l + 0.5 * h), G(a, r) + s + 0.9 * o * Math.sin(l + 0.5 * h) ]);
    }
    return [ c, i ];
}
...
{
    const c = a + G(0.1, i), l = [];
    l.push([ G(r, i) + e + 0.9 * n * Math.cos(c - t), G(r, i) + s + 0.9 * o * Math.sin(c - t) ]);
    for (let a = c; a <= h; a += t)
...
{
    const i = [], c = [ r.maxRandomnessOffset || 1, (r.maxRandomnessOffset || 1) + 0.3 ];
    let l = [ 0, 0 ];
    const u = r.disableMultiStroke ? 1 : 2, p = r.preserveVertices;
    for (let f = 0; f < u; f++)
        0 === f ? i.push({op : "move", data : [ h[0], h[1] ]}) : i.push({
            op : "move",
...
function H(t, e = 0)
{
    ...
    const n = [];
    if (3 === s)
        n.push(Q(t[0]), Q(t[1]), Q(t[2]), Q(t[2]));
    else {
        const s = [];
        s.push(t[0], t[0]);
        ...
        for (let t = 1; t + 2 < s.length; t++) {
            const e = s[t];
            (o[0] = [ e[0], e[1] ]),
                (o[1] = [ e[0] + (a * s[t + 1][0] - a * s[t - 1][0]) / 6, e[1] + (a * s[t + 1][1] - a * s[t - 1][1]) / 6 ]),
                (o[2] = [ s[t + 1][0] + (a * s[t][0] - a * s[t + 2][0]) / 6, s[t + 1][1] + (a * s[t][1] - a * s[t + 2][1]) / 6 ]),
                (o[3] = [ s[t + 1][0], s[t + 1][1] ]), n.push(o[1], o[2], o[3]);
        }
    }
    return n;
}
...
function K(t, e, s, n)
{
    ...
    if ((function(t, e) {
        ...
        const n = 0.5, a = t[e + 0], h = t[e + 1], r = t[e + 2], i = t[e + 3], c = J(a, h, n), l = J(h, r, n), u = J(r, i, n),
              p = J(c, l, n), f = J(l, u, n), d = J(p, f, n);
...
class et {
        ...
        if (s.fill&& s.fill != = tt)
            if ("solid" === s.fillStyle) {
                ...
                if (o.length) {
                    ...
                    for (const n of t)
                        n.length < 3 ? e.push(... n)
                                     : 3 === n.length ? e.push(... Y(H([ n[0], n[0], n[1], n[2] ]), 10, (1 + s.roughness) / 2))
    ...
    polygon(t, e)
    {
        ...
        return (s.fill && ("solid" === s.fillStyle ? n.push(I([t], s)) : n.push(C([t], s))), s.stroke != = tt && n.push(o),
                this._d("polygon", n, s));
    }
    ...
    path(t, e)
    {
        ...
        const o = s.fill&& "transparent" != = s.fill&& s.fill != = tt, a = s.stroke != = tt,
        ...
        if (o)
            if ("solid" === s.fillStyle)
                ...
                n.push(C(r, s));
        return (a && (h ? r.forEach((t) = > { n.push(S(t, !1, s)); }) : n.push(i)), this._d("path", n, s));
    }
    ...
    draw(t)
    {
        ...
        for (const a of e)
            switch (a.type) {
                case "path":
                    n.save(), (n.strokeStyle = "none" === s.stroke ? "transparent" : s.stroke), (n.lineWidth = s.strokeWidth),
                        s.strokeLineDash &&n.setLineDash(s.strokeLineDash),
                        s.strokeLineDashOffset && (n.lineDashOffset = s.strokeLineDashOffset), this._drawToContext(n, a, o), n.restore();
                    break;
                case "fillPath": {
    ...
    {
        let n = s.fillWeight;
        n < 0 && (n = s.strokeWidth / 2), t.save(), s.fillLineDash &&t.setLineDash(s.fillLineDash),
            s.fillLineDashOffset && (t.lineDashOffset = s.fillLineDashOffset), (t.strokeStyle = s.fill || ""), (t.lineWidth = n),
            this._drawToContext(t, e, s.fixedDecimalPlaceDigits), t.restore();
    }
...
class ot {
    ...
    draw(t)
    {
        const e = t.sets || [], s = t.options || this.getDefaultOptions(), n = this.svg.ownerDocument || window.document,
              o = n.createElementNS(nt, "g"), a = t.options.fixedDecimalPlaceDigits;
        for (const h of e) {
            let e = null;
            switch (h.type) {
                case "path":
                    (e = n.createElementNS(nt, "path")), e.setAttribute("d", this.opsToPath(h, a)), e.setAttribute("stroke", s.stroke),
                        e.setAttribute("stroke-width", s.strokeWidth + ""), e.setAttribute("fill", "none"),
                    ...
                    break;
                case "fillPath":
                    (e = n.createElementNS(nt, "path")), e.setAttribute("d", this.opsToPath(h, a)), e.setAttribute("stroke", "none"),
                        e.setAttribute("stroke-width", "0"), e.setAttribute("fill", s.fill || ""),
    ...
    fillSketch(t, e, s)
    {
        ...
        return (o.setAttribute("d", this.opsToPath(e, s.fixedDecimalPlaceDigits)), o.setAttribute("stroke", s.fill || ""),
                o.setAttribute("stroke-width", n + ""), o.setAttribute("fill", "none"),
                s.fillLineDash && o.setAttribute("stroke-dasharray", s.fillLineDash.join(" ").trim()),
                s.fillLineDashOffset && o.setAttribute("stroke-dashoffset", `$ { s.fillLineDashOffset }`), o);
    }

function mxODPicker(container, previewFn, getODFilesList, getODFileInfo, getRecentList, addToRecent, pickedFileCallback, errorFn,
                    foldersOnly, backFn, withSubmitBtn, withThumbnail, initFolderPath, acceptAllFiles, isMobile)
{
    var previewHtml = "";
    ...
    var html = '<div style="display: flex; height: 50%;">' + '<div class="odCatsList">' + '<div class="odCatsListLbl">OneDrive</div>'
    ...
    var css =
        ".odCatsList *, .odFilesSec * { user-select: none; }" + ".odCatsList {" + "    box-sizing: border-box;"
        + "    border: 1px solid #CCCCCC;" + "    border-bottom:none;" + "    overflow-x: hidden;" + "    overflow-y: auto;"
        + "    flex: 2;" + "}" + ".odCatsListLbl {" + "    height: 17px;" + "    color: #6D6D6D;" + "    font-size: 14px;"
        + "    font-weight: bold;" + "    line-height: 17px;" + "    margin: 10px 0 3px 5px;" + "}" + ".odFilesSec {"
        + "    box-sizing: border-box;" + "    border: 1px solid #CCCCCC;" + "    border-left:none;" + "    border-bottom:none;"
        + "    overflow: hidden;" + "    flex: 5;" + "}" + ".odFilesBreadcrumb {" + "    box-sizing: border-box;" + "    min-height: 32px;"
        + "    text-overflow:ellipsis;" + "    overflow:hidden;" + "    font-size: 13px;" + "    color: #6D6D6D;" + "    padding: 5px;"
        + "}" + ".odRefreshButton {" + "    box-sizing: border-box;" + "    position:absolute;" + "    right:20px;" + "    top:20px;"
        ...
        // '    border-radius:50%;' +
        // '}' +
        ".odRefreshButton:active {" + "    opacity:0.7;" + "}" + ".odFilesList {" + "    box-sizing: border-box;"
        + "    height: calc(100% - 32px);" + "    overflow-x: hidden;" + "    overflow-y: auto;" + "}" + ".odFileImg {" + "    width: 24px;"
        + "    padding-left: 5px;" + "    padding-right: 5px;" + "}" + ".odFileTitle {" + "    cursor: default;"
        + "    font-weight: normal;" + "    color: #666666 !important;" + "    width: calc(100% - 20px);" + "    white-space: nowrap;"
        + "    overflow: hidden;" + "    text-overflow: ellipsis;" + "}" + ".odFileListGrid {" + "    width: 100%;"
        + "    white-space: nowrap;" + "    font-size: 13px;" + "    box-sizing: border-box;" + "    border-spacing: 0;" + "}"
        + ".odOddRow {" + (isDarkMode ? "" : "    background-color: #eeeeee;") + "}" + ".odEvenRow {"
        ...
        + "    top:50%;" + "    transform: translateY(-50%);" + "    font-size:13px;" + "    opacity:0.5;" + "    color: #6D6D6D;" + "}"
        + ".odPreview {" + "     overflow:hidden;" + "     border: 1px solid #CCCCCC;" + "    height: 50%;" + "}" + ".odLinkBtn {"
        + "    font-size: 12px;" + "    cursor: pointer;" + "    color: #6D6D6D;" + "    position: relative;" + "    bottom: 20px;"
        + "    left: 8px;" + "    width: 50px;" + "    white-space: nowrap;" + "}" + ".odSubmitBtn {" + "   position: relative;"
        + "    color: #333;" + "    right: 5px;" + "    bottom: 40px;" + "    float: right;" + "}";

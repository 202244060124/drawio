...
!(function (e) {
    ...
    return (function o(a, s, u) {
        function l(t, e)
        {
            if (!s[t]) {
                ...
                var n = (s[t] = {exports : {}});
                a[t][0].call(n.exports, function(e) { return l(a[t][1][e] || e); }, n, n.exports, o, a, s, u);
            }
            return s[t].exports;
        }
        ...
        !(function(e, t, r, i, n, o, a, s) {
            ...
            var u = (function() {
                ...
                t.open = function(e)
                {
                    if (t.isReady()) {
                        ...
                        new a.default(e).launchInvoker().then(function() { t.reset(); });
                    }
                };
                t.save = function(e)
                {
                    if (t.isReady()) {
                        ...
                        new s.default(e).launchInvoker().then(function() { t.reset(); });
                    }
                };
                t.reset = function()
                {
            ...
            t.default = u;
        })(0, r, e("./utilities/ErrorHandler"), e("./models/ErrorType"), e("./utilities/Logging"), e("./models/OneDriveSdkError"),
           e("./controllers/Picker"), e("./controllers/Saver"));
                },
                {
        ...
        !(function(e, t, d, p, f, c, h, v, m, g, y) {
            ...
            {
                for (var i = [], n = {webUrl : null, value : []}, o = 0, a = e.value; o < a.length; o++) {
                    var s = a[o];
                    i.push(T(s, t, r));
                }
            ...
            function u(o, e, t)
            {
                var a = m.appendToPath(b(o, e.apiEndpointUrl), v.format("{0}.createLink", e.apiActionNamingSpace)), r = new g.default({
                    url : a,
                    clientId : e.clientId,
                ...
                return new y.Promise(function(a, s) {
                    window.File&& e
                        instanceof window.File
                                       ? (t = new FileReader())
                                       : s(new h.default(p.default.unsupportedFeature, "FileReader is not supported in this browser"));
                    ...
                    t.onload = function(e)
                    {
                        var t = m.appendToPath(b(u, d.apiEndpointUrl), "children('" + l.name + "')/content"), r = {};
                        ...
                        var n = new g.default({
                            ...
                            o = e.target.result;
                        n.upload(
                            o, function(e, t) { a({webUrl : null, value : [JSON.parse(e.responseText)]}); },
                            function(e, t, r) {
                                s(new h.default(p.default.webRequestFailure,
                                                v.format("file uploading failed by form uplaod with HTTP status: {0}", t)));
                            },
                            function(e, t) { c(t.progressPercentage); });
                    };
            ...
            t.saveItemByUriUpload = function(e, t, r, i)
            {
                ...
                var n, o = m.appendToPath(b(e, i.apiEndpointUrl), "children"), a = {Prefer : "respond-async"};
                    ...
                    u.start(
                        function(e, t) {
                            if (200 === t || 201 === t) {
                                ...
                                n(new h.default(p.default.webRequestFailure,
                                                v.format("file uploading failed by data uri with HTTP status: {0}", t)));
                        },
                        function(e, t, r) {
                       ...
                       : m.isPathFullUrl(r)
                           ? ((s = l), new y.Promise(function(i, n) {
                                 s.start(
                                     function(e, t) {
                                         if (202 === t) {
                                             ...
                                             n(new h.default(p.default.webRequestFailure,
                                                             v.format("create upload by url job failed with HTTP status: {0}", t)));
                                     },
                                     function(e, t, r) {
                                         n(new h.default(p.default.webRequestFailure,
                                                         v.format("create upload by url job failed with HTTP status: {0}", t)));
                                                     ...
                                                     o.start(
                                                         function(e, t) {
                                                             switch (t) {
                                                                 ...
                                                                 default:
                                                                     n(new h.default(p.default.webRequestFailure,
                                                                                     v.format("polling upload job failed with HTTP status: {0}",
                                                                                              t)));
                                                             }
                                                         },
                                                         function(e, t, r) {
                                                             n(new h.default(p.default.webRequestFailure,
                                                                             v.format("polling upload job failed with HTTP status: {0}", t)));
                                                         });
                                                 })).then(function(e) {
                                                    e.resourceId ? n(e.resourceId)
                                                    : i <= w     ? setTimeout(t(r, i), i)
                                                                 : a(new h.default(p.default.webRequestFailure,
            ...
            {
                var t = m.appendQueryString(m.appendToPath(e.apiEndpointUrl, "me"), "$select", "mySite"), r = {};
                ...
                return new y.Promise(function(i, n) {
                    o.start(
                        function(e, t) {
                            var r = c.deserializeJSON(e.responseText);
                            r.mySite ? i(r.mySite)
                                     : n(new h.default(p.default.badResponse,
                                                       v.format("Cannot find the personal tenant url, response text: {0}", e.responseText)));
                        },
                        function(e, t, r) {
                            n(new h.default(p.default.webRequestFailure,
                                            v.format("graph/me request failed, status code: '{0}', response text: '{1}'",
                                                     g.default.statusCodeToString(t), e.responseText)));
                        });
                });
            };
            function b(e, t)
        ...
        })(0, r, e("../models/ApiEndpoint"), e("../models/ErrorType"), e("../utilities/Logging"), e("../utilities/ObjectUtilities"),
           e("../models/OneDriveSdkError"), e("../utilities/StringUtilities"), e("../utilities/UrlUtilities"), e("../utilities/XHR"),
           e("es6-promise"));
                },
                {
        ...
        !(function(e, t, n, o, d, c, p, f, r, a, i, h, s, u, v, m, l) {
            ...
            var g = (function() {
                ...
                {
                    var e = this, t = this.invokerOptions;
                    return this.launch()
                        .catch(function(e) {
                            r.default.logError("Failed due to unknown error: ", e);
                            t.error(e);
                        })
                        .then(function() { e.cleanPopupAndIFrame(); });
                };
                e.prototype.launch = function(e)
                {
                    var l = this;
                    return this.buildOauthPromise(e)
                        .then(function(e) { return e && "cancel" === e.type ? e : l.buildPickerUI(e); })
                        .then(function(e) {
                            var t = l.invokerOptions;
                            e.type
                                || p.throwError(new h.default(f.default.badResponse,
                                                              m.format("received bad response from picker UX: {0}", JSON.stringify(e))))
                                       .exposeToPublic();
                            if ("switch" === e.type)
                                return l.launch(!0);
                            if ("success" === e.type) {
                                ...
                                var s = {webUrl : null, value : r}, u = void 0;
                                ...
                                return u.then(function(e) {
                                    ...
                                    l.apiRequestConfig
                                        ...
                                        : l.loginHint&& l.loginHint.endpointHint === c.default.aad && (e.apiEndpoint = d.default.GRAPH_URL);
                                    t.success(e);
                                    return e;
                                });
                            }
                ...
                {
                    return e || this.invokerOptions.needOauth() ? i.auth(i.buildOauthConfig(this.invokerOptions, e), this.popup)
                ...
                e.prototype.buildPickerUI = function(e)
                {
                    ...
                    if (e) {
                        ...
                        this.invokerOptions.endpointHint != = c.default.msa&& this.invokerOptions.endpointHint != =
                            c.default.tenant
                            && p.throwError(
                                    new h.default(f.default.optionsError,
                    ...
                    return ((this.loginHint = r).apiEndpoint === n.default.graph_odb ? o.getUserTenantUrl(this.buildApiConfig())
                                                                                      : v.Promise.resolve(void 0))
                        .then(function(e) {
                            i.pickerUX =
                                s.generatePickerUX(r.apiEndpoint, r.endpointHint === c.default.tenant ? i.invokerOptions.siteUrl : e);
                ...
                {
                    this.loginHint
                        || p.throwError(new h.default(f.default.internalError, "missing loginHint when trying to build API request"))
                               .exposeToPublic();
                    this.oauthResponse || this.invokerOptions.accessToken
                        || p.throwError(new h.default(f.default.internalError, "missing access token when trying to build API request"))
                               .exposeToPublic();
                    var e = null, t = null;
            ...
            t.default = g;
        })(0, r, e("../models/ApiEndpoint"), e("./ApiRequest"), e("../Constants"), e("../models/DomainHint"), e("../utilities/ErrorHandler"),
           e("../models/ErrorType"), e("../utilities/Logging"), e("./LoginCache"), e("./Oauth"), e("../models/OneDriveSdkError"),
           e("./PickerUX"), e("../utilities/Popup"), e("es6-promise"), e("../utilities/StringUtilities"), e("../utilities/UrlUtilities"));
                },
                {
                    "../Constants": 1,
                    "../models/ApiEndpoint": 11,
        ...
        !(function(e, t, d, c, p, f, i, n, o, a) {
            "use strict";
            Object.defineProperty(t, "__esModule", {value : !0});
            var s = "preferred_username", h = "odsdkLoginHint";
            ...
            t.parseIdToken = function(e)
            {
                ...
                var t = e.split(".")[1].replace("-", "+").replace("_", "/"), r = a.deserializeJSON(atob(t));
        ...
        })(0, r, e("../models/ApiEndpoint"), e("../utilities/Cache"), e("../Constants"), e("../models/DomainHint"),
           e("../utilities/ErrorHandler"), e("../models/ErrorType"), e("../models/OneDriveSdkError"), e("../utilities/ObjectUtilities"));
                },
                {
                    "../Constants": 1,
                    "../models/ApiEndpoint": 11,
        ...
        !(function(e, t, r, a, u, s, l, d, c, p, i, f) {
            "use strict";
            Object.defineProperty(t, "__esModule", {value : !0});
            var n = "access_token", o = "error", h = "error_description", v = "id_token", m = "oauth", g = "state",
                y = "https://login.microsoftonline.com/common/oauth2/authorize",
                _ = "https://login.microsoftonline.com/common/oauth2/v2.0/authorize", E = "https://login.live.com/oauth20_authorize.srf",
                ...
                e[m]   ? (function(e) {
                    ...
                    switch (e.endpoint) {
                        ...
                        case c.default.AADv2:
                            t = ((i = "profile openid https://graph.microsoft.com/User.Read "
                                      + (r = e).scopes.map(function(e) { return "https://graph.microsoft.com/" + e; }).join(" ")),
                        ...
                        default:
                            s.throwError(
                                new p.default(l.default.badResponse, "received bad oauth endpoint, endpoint value is: " + e.endpoint));
                    }
                    var r, i, n;
                    var o;
                    if (e.switchAccount)
            ...
            function b(e, t)
            {
                if (e.state) {
                    ...
                    2 != = r.length
                           && s.throwError(new p.default(l.default.badResponse,
                                                         "received bad state parameter from Oauth endpoint, state received: " + e.state))
                                  .exposeToPublic();
                    var i = r[0];
                    t ? t.send(w + JSON.stringify(e), i)
                      : s.throwError(new p.default(l.default.popupOpen, "opener is not defined")).exposeToPublic();
                } else
            ...
            t.buildOauthConfig = function(t, e)
            {
                ...
                var i = t.scopes.map(function(e) { return e + (-1 < e.indexOf("Files.") && t.needSharePointPermission ? ".All" : ""); }),
                    n = {
                        clientId : t.clientId,
                        endpoint : r,
                        scopes : i,
        ...
        })(0, r, e("../utilities/Channel"), e("../models/DomainHint"), e("../utilities/DomUtilities"), e("../utilities/ErrorHandler"),
           e("../models/ErrorType"), e("./LoginCache"), e("../models/OauthEndpoint"), e("../models/OneDriveSdkError"), e("es6-promise"),
        ...
        !(function(e, t, r, n, o, i, a, s, u, l, d) {
            ...
            var c = (function(i) {
                ...
                function t(e)
                {
                    var t = a.shallowClone(e), r = new s.default(t);
                ...
                {
                    var t = this, r = this.invokerOptions.createLinkParameters || this.getDefaultSharingConfig();
                ...
                {
                    var e = {type : "view"};
                    if (this.getApiRequestConfig().apiEndpoint === r.default.graph_odc
            ...
            t.default = c;
        })(0, r, e("../models/ApiEndpoint"), e("./ApiRequest"), e("../Constants"), e("./Invoker"), e("../utilities/ObjectUtilities"),
           e("../models/PickerOptions"), e("../models/PickerActionType"), e("../utilities/StringUtilities"), e("../utilities/UrlUtilities"));
                },
                {
                    "../Constants": 1,
                    "../models/ApiEndpoint": 11,
        ...
        !(function(e, t, r, f, h, i, n, o, a, s, u, v) {
            ...
            var l = (function() {
                function e(e, t)
                {
                    if (e === r.default.graph_odc || e === r.default.msa)
                        this.url = s.appendQueryStrings("https://onedrive.live.com/", {v : "2"});
                ...
                e.prototype.invokePickerUX = function(d, c)
                {
                    ...
                    return new u.Promise(function(u, e) {
                        var l = h.onMessage(function(e) {
                            var t = p.url.split("/"), r = new f.default(p.iframe ? p.iframe.contentWindow : c.getPopupWindow());
                            if (e.origin === t[0] + "//" + t[2]) {
                                var i = "" + (e.data || "");
                                if (0 === i.indexOf(m)&& e.source === r.getReceiver()) {
                                    var n = JSON.parse(i.substring(m.length)), o = n.pickerId, a = n.conversationId, s = n.type;
                                    if (o === d.id)
                                        if ("initialize" === s)
                        ...
                        if (!d.parentDiv)
                            return c.openPopup(r).then(function() { u({type : "cancel"}); });
                        c.close();
            ...
            t.default = l;
        })(0, r, e("../models/ApiEndpoint"), e("../utilities/Channel"), e("../utilities/DomUtilities"), e("../utilities/ErrorHandler"),
           e("../models/ErrorType"), e("../utilities/Logging"), e("../models/OneDriveSdkError"), e("../utilities/UrlUtilities"),
           e("es6-promise"), e("../Constants"));
                },
                {
                    "../Constants": 1,
                    "../models/ApiEndpoint": 11,
        ...
        !(function(e, t, n, o, r, a, s, u, l, d) {
            ...
            var i = (function(i) {
                ...
                function e(e)
                {
                    var t = a.shallowClone(e), r = new u.default(t);
                    return i.call(this, r) || this;
                }
            ...
            t.default = i;
        })(0, r, e("./ApiRequest"), e("../Constants"), e("./Invoker"), e("../utilities/ObjectUtilities"), e("../models/SaverActionType"),
           e("../models/SaverOptions"), e("../models/UploadType"), e("../utilities/UrlUtilities"));
                },
                {
                    "../Constants": 1,
        ...
        !(function(e, t, n, a, s, u, l, o, d, c, p, f) {
            ...
            var r = new RegExp("^[a-fA-F\\d]{8}-([a-fA-F\\d]{4}-){3}[a-fA-F\\d]{12}$"),
                i = (function() {
                    ...
                    {
                        e ? r.test(e) ? o.default.logMessage("parsed client id: " + e)
                                      : u.throwError(
                                            new d.default(l.default.unknown,
                                                          c.format("invalid format for client id '{0}' - AAD: 32 characters (HEX) GUID", e)))
                          : u.throwError(new d.default(l.default.unknown, "client id is missing in options"));
                    };
                    ...
                    i.prototype.parseAdvancedOptions = function(e)
                    {
                        if (e.advanced) {
                            ...
                            if (e.advanced.queryParameters) {
                                ...
                                for (var r in t)
                                    "select" != = r.toLowerCase()&& "expand" != =
                                        r.toLowerCase()
                                        && u.throwError(
                                            new d.default(l.default.optionsError,
                                                          c.format("unexpected query key: {0} is found in advanced.queryParameters", r)));
                                var i = t.select, n = t.expand;
                                i&& n ? (this.queryParameters = c.format("expand={0}&select={1}", n, i))
                                : n   ? (this.queryParameters = c.format("expand={0}", n))
                                      : i && "select=" + i.split(",").sort().join(",") != =
                                          a.default.DEFAULT_QUERY_ITEM_PARAMETER && (this.queryParameters = c.format("select={0}", i));
                            }
                            ...
                            if (e.advanced.iframeParentDiv) {
                                (e.advanced.iframeParentDiv.nodeName&& "div" === e.advanced.iframeParentDiv.nodeName.toLowerCase())
                                    || u.throwError(
                            ...
                            e.advanced.scopes
                                && ("string" == typeof e.advanced.scopes ? (this.scopes = [e.advanced.scopes]) : e.advanced.scopes
                                    instanceof Array && (this.scopes = e.advanced.scopes));
                    ...
                    i.prototype.parseNavigationOptions = function(e)
                    {
                        if (e) {
                            ...
                            if (t) {
                                if (t.sharePoint) {
                                    var r = t.sharePoint, i = r.sitePath, n = r.listPath;
            ...
            t.default = i;
        })(0, r, e("../utilities/CallbackInvoker"), e("../Constants"), e("./DomainHint"), e("../utilities/ErrorHandler"), e("./ErrorType"),
           e("../utilities/Logging"), e("./OneDriveSdkError"), e("../utilities/StringUtilities"), e("../utilities/TypeValidators"),
           e("../utilities/UrlUtilities"));
                },
                {
                    "../Constants": 1,
        ...
        !(function(e, t, o, a, r, s, u, l) {
            ...
            var i = (function(n) {
                ...
                function e(e)
                {
                    var t = n.call(this, e) || this, r = l.validateCallback(e.success, !1);
            ...
            t.default = i;
        })(0, r, e("../utilities/CallbackInvoker"), e("../Constants"), e("./InvokerOptions"), e("../utilities/Logging"),
           e("./PickerActionType"), e("../utilities/TypeValidators"));
                },
                {
                    "../Constants": 1,
                    "../utilities/CallbackInvoker": 23,
        ...
        !(function(e, t, a, s, r, i, n, o, u, l, d, c, p, f, h) {
            ...
            var v = (function(o) {
                ...
                function e(e)
                {
                    var t = o.call(this, e) || this, r = p.validateCallback(e.success, !1);
                    t.success = function(e)
                    {
                ...
                {
                    e.sourceInputElementId&& e.sourceUri&& i.throwError(
                        new l.default(n.default.optionsError, "sourceUri and sourceInputElementId are provided, only one is required."));
                    ...
                    if (this.sourceUri) {
                        if (h.isPathFullUrl(this.sourceUri)) {
                            ...
                            this.fileName
                                || i.throwError(
                                    new l.default(n.default.optionsError, "must supply a file name or a URL that ends with a file name"));
                        } else if (h.isPathDataUrl(this.sourceUri)) {
                            this.uploadType = f.default.dataUrl;
                            this.fileName = t;
                            this.fileName
                                || i.throwError(new l.default(n.default.optionsError, "must supply a file name for data URL uploads"));
                        }
            ...
            t.default = v;
        })(0, r, e("../utilities/CallbackInvoker"), e("../Constants"), e("../utilities/DomUtilities"), e("../utilities/ErrorHandler"),
           e("./ErrorType"), e("./InvokerOptions"), e("../utilities/Logging"), e("./OneDriveSdkError"), e("./SaverActionType"),
           e("../utilities/StringUtilities"), e("../utilities/TypeValidators"), e("./UploadType"), e("../utilities/UrlUtilities"));
                },
                {
                    "../Constants": 1,
                    "../utilities/CallbackInvoker": 23,
        ...
        !(function(e, t, n) {
            ...
            t.invokeCallbackAsynchronous = function(e)
            {
                for (var t = [], r = 1; r < arguments.length; r++)
                    t[r - 1] = arguments[r];
                window.setTimeout(function() { e.apply(null, t); }, 0);
            };
        })(0, r, e("../Constants"));
                },
                { "../Constants": 1 },
        ...
        !(function(e, t, n, o, a, r) {
            ...
            t.getFileInput = function(e)
            {
                ...
                if (t instanceof HTMLInputElement) {
                    ...
                    var r = t.files;
                    (r && window.FileReader)
                        || n.throwError(new a.default(o.default.unsupportedFeature, "browser does not support Files API"));
                    1 != = r.length
                           && n.throwError(new a.default(o.default.unsupportedFeature, "can not upload more than one file at a time"));
                    var i = r[0];
            ...
            t.throwError = function(e)
            {
                if (e.errorCode != = i.default[ i.default.unknown ]) {
                    for (var t = 0, r = n; t < r.length; t++)
                        (0, r[t])(e);
                    return {exposeToPublic : function(){throw e;
                }
                ,
            };
                            }
        ...
        var t = (function() {
            ...
            t.createPopupFeatures = function()
            {
                ...
                return [
                    "width=1024",
                    "height=650",
                    "top=" + (window.screenY + Math.max(window.outerHeight - 650, 0) / 2),
                    "left=" + e,
                    "status=no",
                    "resizable=yes",
                    "toolbar=no",
            ...
            t.prototype.openPopup = function(e)
            {
                ...
                if (t.getCurrentPopup().isPopupOpen()) {
                    ...
                    this._popup ? this._popup.focus()
                                : r.throwError(new s.default(o.default.popupOpen, "popup window is disconnected")).exposeToPublic();
    ...
    !(function(e, t, i, a, s, u, l, d, c) {
        ...
        t.validateCallback = function(e, t)
        {
            ...
            r != = i.default.TYPE_FUNCTION
                   && a.throwError(
                       new d.default(s.default.typeError, c.format("expected function type: function | string, actual type: {0}", r)));
            return e;
        };
    })(0, r, e("../Constants"), e("./ErrorHandler"), e("../models/ErrorType"), e("./Logging"), e("./ObjectUtilities"),
       e("../models/OneDriveSdkError"), e("./StringUtilities"));
                },
                {
                    "../Constants": 1,
                    "../models/ErrorType": 13,
    ...
    !(function(e, t, i, o, a, s, u) {
        ...
        function c(e)
        {
            var t = {}, r = e.indexOf("?") + 1, i = e.indexOf("#") + 1;
            if (0 < r) {
            ...
            -1 < e.indexOf("://")
                ? e.split("/")[2]
                      != = window.location.host
                           && o.throwError(new s.default(a.default.optionsError, "redirect uri is not in the same domain as picker sdk"))
                                  .exposeToPublic()
                : o.throwError(new s.default(a.default.optionsError, "redirect uri is not an absolute url")).exposeToPublic();
        };
        function h(e, t)
        {
            for (var r = e.split("&"), i = 0; i < r.length; i++) {
                var n = r[i], o = n.indexOf("=");
                if (-1 != = o) {
                    var a = n.substr(0, o), s = n.substr(o + 1);
    ...
    !(function(e, t, i, n, a, s, u, l, d) {
        ...
        t.default = r;
    })(0, r, e("../models/ApiEndpoint"), e("../Constants"), e("./ErrorHandler"), e("../models/ErrorType"), e("./Logging"),
       e("../models/OneDriveSdkError"), e("./StringUtilities"));
                },
                {
                    "../Constants": 1,
     ...
     */
        ...
        , i = 0, t = void 0, n = void 0, s = function(e, t)
        {
            p[i] = e;
            p[i + 1] = t;
            2 === (i += 2) && (n ? n(f) : h());
        };
        var e = "undefined" != typeof window ? window : void 0, o = e || {}, a = o.MutationObserver || o.WebKitMutationObserver,
        ...
        h = u ? function()
        {
            return process.nextTick(f);
                                ...
                                : a
                                ? (function () {
            var e = 0, t = new a(f), r = document.createTextNode("");
            ...
            try {
                ...
                return c();
                                ...
                                function v(e, t)
                                {
                                    var r = arguments, i = this, n = new this.constructor(y);
                                    void 0 === n[g] && M(n);
                                    var o, a = i._state;
                                    a ? ((o = r[a - 1]), s(function() { return H(a, n, o, i._result); })) : S(i, n, e, t);
                                    return n;
                                }
                                function m(e)
                                {
                                ...
                                function P(e, t, r)
                                {
                                    t.constructor === e.constructor&& r === v&& t.constructor.resolve == =
                                        m ? ((o = e),
                                             (a = t)._state === E ? U(o, a._result)
                                                                   : a._state === w ? C(o, a._result)
                                                                                     : S(
                                                                                           a, void 0, function(e) { return k(o, e); },
                                                                                           function(e) { return C(o, e); }))
                                          : r === T ? C(e, T.error)
                                                     : void 0 === r      ? U(e, t)
                                                                   : l(r) ? ((i = t), (n = r),
                                                                             s(
                                ...
                                function k(e, t)
                                {
                                    e === t ? C(e, new TypeError("You cannot resolve a promise with itself"))
                                           : "function" == typeof(r = t) || ("object" == typeof r&& null != = r) ? P(e, t, b(t))
                                                                                                                 : U(e, t);
                                    var r;
                                }
                                function O(e)
                                ...
                                function H(e, t, r, i)
                                {
                                    var n = l(r), o = void 0, a = void 0, s = void 0, u = void 0;
                                    if (n) {
                                        if ((o = (function(e, t) {
                                                 try {
                                                     return e(t);
                                ...
                                {
                                    var r = this;
                                    S(e, void 0, function(e) { return r._settledAt(E, t, e); }, function(e) { return r._settledAt(w, t, e); });
                                };
                                function L(e)
                                {
                                    this[g] = D++;
                                    ...
                                    if (y != = e) {
                                        ...
                                        this
                                            instanceof L ? (function(t, e) {
                                                           try {
                                                               e(function(e) { k(t, e); }, function(e) { C(t, e); });
                                                           } catch (e) {
                                                               C(t, e);
                                                           }
                                                       })(this, e)
                                    ...
                                    return r(n) ? new o(function(e, t) {
                                        for (var r = n.length, i = 0; i < r; i++)
                                            o.resolve(n[i]).then(e, t);
                                                ...
                                                : new o(function(e, t) { return t(new TypeError("You must pass an array to race.")); });
                                };
                                L.resolve = m;
                                L.reject = function(e)
                                {
                                ...
                                L._asap = s;
                                L.prototype = {constructor : L, then : v, catch : function(e){return this.then(null, e);
                                },
                            };
                            function N() {
    var e = void 0;

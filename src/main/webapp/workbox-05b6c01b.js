    ...
    ["exports"], function(t) {
        ...
        const a = {
            ...
            suffix : "undefined" != typeof registration ? registration.scope : "",
              ...
              h = (t) = > [ a.prefix, t, a.suffix ].filter((t) = > t && t.length > 0).join("-"), u = (t) = > t || h(a.precache),
              l = (t) = > t || h(a.runtime);
        function f(t, e)
        {
            const s = e();
        ...
        class U {
            constructor(t, e)
            {
                (this.u = {}), Object.assign(this, e), (this.event = e.event), (this.l = t), (this.p = new m()), (this.R = []),
            ...
            async cachePut(t, e)
            {
                ...
                if (!c)
                    return !1;
                const {cacheName : a, matchOptions : h} = this.l, u = await self.caches.open(a), l = this.hasCallback("cacheDidUpdate"),
            ...
            *iterateCallbacks(t)
            ...
            handleAll(t)
            {
                ...
                const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request,
                      n = "params" in t ? t.params : void 0, i = new U(this, {event : e, request : s, params : n}), r = this.U(i, s, e);
            ...
            constructor(t = {})
            {
                (t.cacheName = u(t.cacheName)), super(t), (this.C = !1 != = t.fallbackToNetwork),
            ...
            k()
            {
                ...
                for (const[s, n] of this.plugins.entries())
                    n != = b.copyRedirectedCacheableResponsesPlugin
                           && (n === b.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
        ...
        class C {
            ...
            {
                (this.K = new Map()), (this.T = new Map()), (this.W = new Map()),
                    (this.l = new b({
                         cacheName : u(t),

define(
    "./workbox-eb9c7348.js", ["exports"], function(t) {
        "use strict";
        try {
        ...
        class b {
            constructor(t, e)
            {
                (this.u = {}), Object.assign(this, e), (this.event = e.event), (this.l = t), (this.p = new v()), (this.R = []),
                    (this.m = [... t.plugins]), (this.v = new Map());
            ...
            *iterateCallbacks(t)
            ...
            handleAll(t)
            {
                ...
                const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request,
                      n = "params" in t ? t.params : void 0, i = new b(this, {event : e, request : s, params : n}), r = this.U(i, s, e);
            ...
            constructor(t = {})
            {
                (t.cacheName = l(t.cacheName)), super(t), (this.C = !1 != = t.fallbackToNetwork),
            ...
            async N(t, e)
            {
                    ...
                    });
                {
                    ...
                    (n = await e.fetch(new Request(t, {integrity : r || s}))), s&& o && (this.k(), await e.cachePut(t, n.clone()));
                }
                return n;
            }
            async O(t, e)
        ...
        class E {
            ...
            {
                (this.j = new Map()), (this.K = new Map()), (this.T = new Map()),
                    (this.l = new C({
                         cacheName : l(t),
            ...
            precache(t)
            {
                this.addToCacheList(t),
                    this.W
                        || (self.addEventListener("install", this.install), self.addEventListener("activate", this.activate), (this.W = !0));
            }
            addToCacheList(t)
            {
                const e = [];
                ...
                return w(
                    t, async() = > {
                        ...
                        for (const[e, s] of this.j) {
                            const n = this.T.get(s), i = this.K.get(e), r = new Request(e, {
                                                                            integrity : n,
                                                                            cache : i,
            ...
            activate(t)
            {
                return w(
                    t, async() = > {
                        const t = await self.caches.open(this.strategy.cacheName), e = await t.keys(), s = new Set(this.j.values()), n = [];
                        for (const i of e)
        ...
        {
            !(function(t) { x().precache(t); })(t), k(e);
        };
    });
// # sourceMappingURL=workbox-eb9c7348.js.map

...
Draw.loadPlugin(function(ui) {
                                ...
                                function() {
                                    ...
                                    if (childrenA != null && childrenB != null) {
                                        ...
                                        try {
                                            ...
                                            console.log("random.js: " + counter + " - swapping " + passes
                                                        + " children from parent A to parent B");
                                            ...
                                            console.log("random.js: " + counter + " - swapping " + passes
                                                        + " children from parent B to parent A");
    ...
    var menu = ui.menus.get(urlParams["test"] == "1" ? "testDevelop" : "extras");

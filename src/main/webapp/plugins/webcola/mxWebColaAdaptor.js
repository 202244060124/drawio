...
mxWebColaAdaptor.prototype.defaultValues = {doAnimations : true, // whether to show the layout as it's running
                                            ...
                                            nodeDimensionsIncludeLabels :
                                                false, // whether labels should be included in determining the space used by a node
                                            ...
                                            nodeSpacing : function nodeSpacing(node){return 10;
}
,                                 // extra spacing around nodes
    flow : undefined,             // use DAG/tree flow layout if specified, e.g. { axis: 'y', minSeparation: 30 }
           alignment : undefined, // relative alignment constraints on nodes, e.g. function( node ){ return { x: 0, y: 1 } }
                       gapInequalities
    : undefined, // list of inequality constraints for the gap between the nodes, e.g. [{"axis":"y", "left":node1, "right":node2, "gap":25}]
                   ...
                   edgeSymDiffLength : undefined,                     // symmetric diff edge length in simulation
                                       edgeJaccardLength : undefined, // jaccard edge length in simulation
                                                           ...
                                                           unconstrIter : undefined, // unconstrained initial layout iterations
                                                                          userConstIter
    : undefined,                // initial layout iterations with user-specified constraints
...
colaAdaptor.nodes(this.nodes).links(this.links).groups(this.groups).size(this.dimension).linkDistance(function(link) { return link.length; });
...
mxWebColaAdaptor.prototype.graphToLayout =
    function(graph, movableVertices
             /**
...
mxWebColaAdaptor.prototype.computeVertexDegrees = function() /**
                                                              * Computes group vertex and vertex degrees. Useful to stop layouting for
                                                              * groups with no internal, incoming or outgoing edges.
                                                              */
{
...
{
    if (cell.isCollapsed() || cell.children == null || cell.children.length == 0
    ...
    /*
  if (!cell.isCollapsed() && cell.children != null && cell.children.length > 0 && this.graph.getEdges(cell, null, true, true, true,
  true).length == 0)
  {
...
mxWebColaAdaptor.prototype.findActiveVertices =
    function(graph
             /**
    ...
    )
{
        ...
        if (children != null && children.length > 0) {
            for (var i = 0; i < children.length; i++) {
                ...
                cellsToExplore.push({
                    vertex : child,
                    isActive : isActive,
                    activeParent : childActiveParent,
                });
                if (child.isVertex()) {
    ...
    return {
        ...
        inactiveToActiveMap : inactiveToActiveMap,
    };
};

mxWebColaAdaptor.prototype.getActiveVerticesInGroup =
    function(groupCell, activeVertices, includeCollapsedGroups
             /**
...
mxWebColaAdaptor.prototype.getAllVerticesInGroup =
    function(groupCell, includeCollapsedGroups
             /**
              * Scans all children in group and returns all active vertices inside group
              * This method is for creating redundant edges between members of groups to simulate group edges in WebCola
              * See https://github.com/tgdwyer/WebCola/issues/38
...
mxWebColaAdaptor.prototype.hasVertexChildren =
    function(cell
             /**
...
mxWebColaAdaptor.prototype.addGroupConstraintLinks =
    function(groupA, groupB, activeVertices, inactiveToActiveMap, cellIds
             /**
...
if ((typeof window === "undefined" ? "undefined" : typeof window) != = (true ? "undefined" : typeof undefined)) {
    doRendering = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame

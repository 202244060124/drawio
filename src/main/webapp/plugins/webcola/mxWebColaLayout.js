...
)
{
    ...
    this.layout = new mxWebColaAdaptor(this.graph, this.graph.pageVisible ? [ ps.width, ps.height ] : [ 800, 800 ], movableVertices);
    var initial = true;
...
mxWebColaLayout.prototype.getReachableVertices = function(parent
                                                           ...
                                                           *          if undefined is returned, it means parent was not provided and it
                                                           * should be interpreted as all vertices are reachable
                                                           */
)
{
    if (parent == undefined)

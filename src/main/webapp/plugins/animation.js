...
Draw.loadPlugin(function(editorUi) {
    ...
    editorUi.actions.addAction(
        "animation", function() {
            if (this.animationWindow == null) {
                ...
                this.animationWindow = new AnimationWindow(editorUi, (document.body.offsetWidth - 480) / 2, 120, 640, 480);
    ...
    var AnimationWindow = function(editorUi, x, y, w, h)
    {
        ...
        var applyBtn = mxUtils.button("Apply", function() { editorUi.editor.graph.setAttributeForCell(root, "animation", list.value); });

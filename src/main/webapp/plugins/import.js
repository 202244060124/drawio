...
Draw.loadPlugin(function(ui) {
    ...
    function importFreemindData(data)
    {
        ...
        var freeMindBranchVertexStyle =
            "whiteSpace=wrap;html=1;shape=partialRectangle;top=0;left=0;bottom=1;right=0;points=[[0,1],[1,1]];strokeColor=#000000;fillColor=none;align=center;verticalAlign=bottom;routingCenterY=0.5;snapToPoint=1;collapsible=0;container=1;recursiveResize=0;autosize=1;";
        var freeMindConceptVertexStyle =
            "whiteSpace=wrap;html=1;rounded=1;arcSize=50;align=center;verticalAlign=middle;collapsible=0;container=1;recursiveResize=0;strokeWidth=1;autosize=1;spacing=4;";
    ...
    // Adds menu
    ui.menubar.addMenu("Import", function(menu, parent) { ui.menus.addMenuItem(menu, "importFreemind"); });

define("./workbox-7a2a8380.js", ["exports"], function (t) {
    "use strict";
    try {
    ...
    class i {
        ...
        findMatchingRoute({url : t, sameOrigin : e, request : s, event : n})
        {
            ...
            for (const r of i) {
                ...
                if (o)
                    return ((i = o),
                            ((Array.isArray(i) && 0 === i.length) || (o.constructor === Object && 0 === Object.keys(o).length)
                             || "boolean" == typeof o)
                                && (i = void 0),
                            {route : r, params : i});
            }
    ...
    class U {
        constructor(t, e)
        {
            (this.u = {}), Object.assign(this, e), (this.event = e.event), (this.l = t), (this.p = new m()), (this.g = []),
        ...
        async cachePut(t, e)
        {
            ...
            if (!a)
                return !1;
            const {cacheName : c, matchOptions : h} = this.l, u = await self.caches.open(c), l = this.hasCallback("cacheDidUpdate"),
        ...
        *iterateCallbacks(t)
        ...
        constructor(t = {})
        {
            (this.cacheName = l(t.cacheName)), (this.plugins = t.plugins || []), (this.fetchOptions = t.fetchOptions),
        ...
        handleAll(t)
        {
            ...
            const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request, n = "params" in t ? t.params : void 0,
                  i = new U(this, {event : e, request : s, params : n}), r = this.q(i, s, e);
    ...
    } {constructor(t = {}){(t.cacheName = u(t.cacheName)), super(t), (this._ = !1 != = t.fallbackToNetwork),
...
class L {
    ...
    {
        (this.k = new Map()), (this.j = new Map()), (this.K = new Map()), (this.l = new b({
                                                                               cacheName : u(t),
    ...
    precache(t)
    {
        this.addToCacheList(t),
            this.T || (self.addEventListener("install", this.install), self.addEventListener("activate", this.activate), (this.T = !0));
    }
        ...
        return f(
            t, async() = > {
                ...
                for (const[e, s] of this.k) {
                    const n = this.K.get(s), i = this.j.get(e), r = new Request(e, {
                                                                    integrity : n,
                                                                    cache : i,
...
{
    !(function(t) { E().precache(t); })(t), x(e);
};
});
// # sourceMappingURL=workbox-7a2a8380.js.map

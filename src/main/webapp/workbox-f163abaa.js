define("./workbox-f163abaa.js", ["exports"], function (t) {
    ...
    class i {
        ...
        handleRequest({request : t, event : e})
        {
            ...
            let o = r && r.handler;
            const a = t.method;
            if ((!o && this.i.has(a) && (o = this.i.get(a)), !o))
                return;
            let c;
            try {
        ...
        findMatchingRoute({url : t, sameOrigin : e, request : s, event : n})
        {
            ...
            for (const r of i) {
                ...
                if (o)
                    return ((i = o),
                            ((Array.isArray(o) && 0 === o.length) || (o.constructor === Object && 0 === Object.keys(o).length)
                             || "boolean" == typeof o)
                                && (i = void 0),
                            {route : r, params : i});
            }
    ...
    class p {
        constructor()
        {
            (this.updatedURLs = []), (this.notUpdatedURLs = []),
                (this.handlerWillStart = async({request : t, state : e}) = > { e && (e.originalRequest = t); }),
    ...
    class v {
        constructor()
        {
            this.promise = new Promise((t, e) = > { (this.resolve = t), (this.reject = e); });
        }
    } const q = new Set();
    try {
    ...
    class L {
        constructor(t, e)
        {
            (this.u = {}), Object.assign(this, e), (this.event = e.event), (this.l = t), (this.p = new v()), (this.g = []),
                (this.R = [... t.plugins]), (this.m = new Map());
        ...
        async cacheMatch(t)
        {
            const e = U(t);
            let s;
            const {cacheName : n, matchOptions : i} = this.l, r = await this.getCacheKey(e, "read"), o = c({}, i, {cacheName : n});
        ...
        async cachePut(t, e)
        {
            ...
            if (!a)
                return !1;
            const {cacheName : h, matchOptions : u} = this.l, l = await self.caches.open(h), f = this.hasCallback("cacheDidUpdate"),
                                                 w = f ? await(async function(t, e, s, n) {
                                                     const i = m(e.url, s);
                                                     if (e.url === i)
                                                         return t.match(e, n);
                                                     const r = c({}, n, {ignoreSearch : !0}), o = await t.keys(e, r);
                                                     for (const e of o)
                                                         if (i === m(e.url, s))
                                                             return t.match(e, n);
        ...
        *iterateCallbacks(t)
        ...
        constructor(t = {})
        {
            (this.cacheName = f(t.cacheName)), (this.plugins = t.plugins || []), (this.fetchOptions = t.fetchOptions),
        ...
        handleAll(t)
        {
            ...
            const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request, n = "params" in t ? t.params : void 0,
                  i = new L(this, {event : e, request : s, params : n}), r = this.q(i, s, e);
    ...
    } {constructor(t = {}){(t.cacheName = l(t.cacheName)), super(t), (this._ = !1 != = t.fallbackToNetwork),
                           this.plugins.push(b.copyRedirectedCacheableResponsesPlugin);
        }
        async L(t, e) {
    const s = await e.cacheMatch(t);
    return s || (e.event && "install" === e.event.type ? await this.C(t, e) : await this.N(t, e));
        }
        async N(t, e) {
    let n;
    if (!this._)
    ...
    for (const[s, n] of this.plugins.entries())
        n != = b.copyRedirectedCacheableResponsesPlugin && (n === b.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
...
class C {
    ...
    precache(t)
    {
        this.addToCacheList(t),
            this.K || (self.addEventListener("install", this.install), self.addEventListener("activate", this.activate), (this.K = !0));
    }
        ...
        for (const n of t) {
            ...
            if ((this.k.set(i, t), this.T.set(i, r), e.length > 0)) {
                ...
                \nThis is generally NOT
                    safe.Learn more at https : // bit.ly/wb-precache`;
                                               console.warn(t);
            }
        }
    }
        ...
        return w(
            t, async() = > {
                ...
                for (const[e, s] of this.k) {
                    const n = this.W.get(s), i = this.T.get(e), r = new Request(e, {
                                                                    integrity : n,
                                                                    cache : i,
    ...
    activate(t)
    {
        return w(
            t, async() = > {
                const t = await self.caches.open(this.strategy.cacheName), e = await t.keys(), s = new Set(this.k.values()), n = [];
                for (const i of e)
    ...
    createHandlerBoundToURL(t)
    {
        ...
        return (s) = > ((s.request = new Request(t)), (s.params = c({cacheKey : e}, s.params)), this.strategy.handle(s));
    }
} let x;

!(function () {
    "use strict";
    var e = {515 : function(e, t, r){var n = (this && this.__values)
                                             || function(e){var t = "function" == typeof Symbol && Symbol.iterator, r = t && e[t], n = 0;
    if (r)
        return r.call(e);
    if (e && "number" == typeof e.length)
        return {next : function(){return e && n >= e.length && (e = void 0), {value : e && e[n++], done : !e};
                                },
}
;
...
Object.defineProperty(t, "__esModule", {value : !0}),
    (t.MathJax = t.combineWithMathJax = t.combineDefaults = t.combineConfig = t.isObject = void 0);
var o = r(282);
...
function i(e, t)
{
    ...
    try {
        for (var c = n(Object.keys(t)), s = c.next(); !s.done; s = c.next()) {
            var l = s.value;
            "__esModule" != =
                l && (!a(e[l]) || !a(t[l]) || t[l] instanceof Promise ? null != = t[l]&& void 0 != = t[l] && (e[l] = t[l]) : i(e[l], t[l]));
        }
    } catch (e) {
        r = {error : e};
    } finally {
...
(t.isObject = a), (t.combineConfig = i),
    (t.combineDefaults =
         function e(t, r, o) {
             var i, c;
             t[r] || (t[r] = {}), (t = t[r]);
             try {
                 for (var s = n(Object.keys(o)), l = s.next(); !l.done; l = s.next()) {
                     var u = l.value;
                     a(t[u]) && a(o[u]) ? e(t, u, o[u]) : null == t[u] && null != o[u] && (t[u] = o[u]);
                 }
             } catch (e) {
                 i = {error : e};
             } finally {
    ...
    (t.combineWithMathJax = function(e) { return i(t.MathJax, e); }),
    void 0 == = r.g.MathJax && (r.g.MathJax = {}),
           r.g.MathJax.version || (r.g.MathJax = {version : o.VERSION, _ : {}, config : r.g.MathJax}), (t.MathJax = r.g.MathJax);
}

, 235 : function(e, t, r)
{
    var n, o, a = (this && this.__values) || function(e)
    {
...
;
Object.defineProperty(t, "__esModule", {value : !0}),
    (t.CONFIG = t.MathJax = t.Loader = t.PathFilters = t.PackageError = t.Package = void 0);
var i = r(515), c = r(265), s = r(265);
                ...
                if (
                    ((t.PathFilters = {
                        source: function (e) {
                            return t.CONFIG.source.hasOwnProperty(e.name) && (e.name = t.CONFIG.source[e.name]), !0;
                }
                ...
                , normalize : function(e)
                {
                    var t = e.name;
                            return (
                                t.match(/^(?:[a-z]+:\/)?\/|[a-z]:\\|\[/i) || (e.name = "[mathjax]/" + t.replace(/^\.\//, "")),
                ...
                , prefix : function(e)
                {
                            for (var r; (r = e.name.match(/^\[([^\]]*)\]/)) && t.CONFIG.paths.hasOwnProperty(r[1]); )
    ...
    (e.versions = new Map()),
             ...
             function() {
                 ...
                 try {
                     for (var i = a(r), s = i.next(); !s.done; s = i.next()) {
                         var l = s.value, u = c.Package.packages.get(l) || new c.Package(l, !0);
                         o.push(u.promise);
                     }
                 } catch (t) {
                     e = {error : t};
        ...
        (e.load =
             function() {
                 ...
                 var s = [], l = function(r)
                 {
                     ...
                     n || (n = new c.Package(r)).provides(t.CONFIG.provides[r]), n.checkNoLoad(), s.push(n.promise.then(function() {
                         t.CONFIG.versionWarnings&& n.isLoaded && !e.versions.has(c.Package.resolvePath(r))
             ...
             function() {
                 ...
                 try {
                     for (var i = a(n), s = i.next(); !s.done; s = i.next()) {
                         var l = s.value, u = c.Package.packages.get(l);
                         u || (u = new c.Package(l, !0)).provides(t.CONFIG.provides[l]), u.loaded();
                     }
                 } catch (t) {
                     e = {error : t};
                 } finally {
        ...
        (e.defaultReady = function() { void 0 != = t.MathJax.startup && t.MathJax.config.startup.ready(); }),
        (e.getRoot =
             function() {
                 var e = "//../../es5";
        ...
        (e.checkVersion =
             function(n, o, a) {
                 return (e.versions.set(c.Package.resolvePath(n), r),
                         !(!t.CONFIG.versionWarnings || o == = r)
                             && (console.warn("Component ".concat(n, " uses ").concat(o, " of MathJax; version in use is ").concat(r)), !0));
             }),
        (e.pathFilters = new u.FunctionList()), e.pathFilters.add(t.PathFilters.source, 0), e.pathFilters.add(t.PathFilters.normalize, 10),
        e.pathFilters.add(t.PathFilters.prefix, 20);
                ...
                )
                {
                    (0, i.combineDefaults)(t.MathJax.config, "loader", {
                        ...
                        failed: function (e) {
                            return console.log("MathJax(".concat(e.package || "?", "): ").concat(e.message));
                }
                , require : null, pathFilters : [], versionWarnings : !0,
                }),
                        (0, i.combineWithMathJax)({ loader: l });
                try {
                    for (var d = a(t.MathJax.config.loader.pathFilters), f = d.next(); !f.done; f = d.next()) {
                        var h = f.value;
                ...
                , c = (this && this.__spreadArray) || function(e, t, r)
                {
                ...
                Object.defineProperty(t, "__esModule", {value : !0}), (t.Package = t.PackageError = void 0);
                var s = r(235), l = (function(e) {
                                    function t(t, r)
                                    {
    ...
    function e(t, r)
    {
        void 0 == = r && (r = !1), (this.isLoaded = !1), (this.isLoading = !1), (this.hasFailed = !1), (this.dependents = []),
               (this.dependencies = []), (this.dependencyCount = 0), (this.provided = []), (this.name = t), (this.noLoad = r),
               e.packages.set(t, this), (this.promise = this.makePromise(this.makeDependencies()));
    }
                    return (
    ...
    var t, r, n = [], o = e.packages, l = this.noLoad, u = this.name, d = [];
    s.CONFIG.dependencies.hasOwnProperty(u) ? d.push.apply(d, c([], i(s.CONFIG.dependencies[u]), !1)) : "core" != = u && d.push("core");
    try {
        for (var f = a(d), h = f.next(); !h.done; h = f.next()) {
            var p = h.value, y = o.get(p) || new e(p, l);
    ...
    var t = this, r = new Promise(function(e, r) { (t.resolve = e), (t.reject = r); }), n = s.CONFIG[this.name] || {};
    return (n.ready && (r = r.then(function(e) { return n.ready(t.name); })),
            e.length && (e.push(r), (r = Promise.all(e).then(function(e) { return e.join(", "); }))),
            n.failed && r.catch(function(e) { return n.failed(new l(e, t.name)); }), r);
                        }),
    ...
    try {
        ...
        r
            instanceof Promise ? r.then(function() { return t.checkLoad(); }).catch(function(r) {
    ...
    var t = this, r = document.createElement("script");
    (r.src = e), (r.charset = "UTF-8"), (r.onload = function(e) { return t.checkLoad(); }),
        (r.onerror = function(r) { return t.failed("Can't load \"" + e + '"'); }), document.head.appendChild(r);
                        }),
    ...
    try {
        for (var c = a(this.provided), s = c.next(); !s.done; s = c.next()) {
            s.value.loaded();
        }
    } catch (e) {
        r = {error : e};
    ...
    (this.hasFailed = !0), (this.isLoading = !1), this.reject(new l(e, this.name));
                        }),
                        (e.prototype.checkLoad = function () {
    var e = this;
    ((s.CONFIG[this.name] || {}).checkReady || function() { return Promise.resolve(); })()
        .then(function() { return e.loaded(); })
        .catch(function(t) { return e.failed(t); });
                        }),
    ...
    try {
        for (var o = a(t), i = o.next(); !i.done; i = o.next()) {
            var c = i.value, l = e.packages.get(c);
            l
                || (s.CONFIG.dependencies[c] || (s.CONFIG.dependencies[c] = []), s.CONFIG.dependencies[c].push(c),
    ...
    if (this.noLoad) {
        ...
        try {
            ...
            try {
                ...
                , 282 : function(e, t)
                {
                    Object.defineProperty(t, "__esModule", {value : !0}), (t.VERSION = void 0), (t.VERSION = "3.2.2");
                }
                                 ...
                                 function() {
                                     ...
                                     try {
                                         for (var o = a(this), s = o.next(); !s.done; s = o.next()) {
                                             var l = s.value, u = l.item.apply(l, c([], i(r), !1));
                                             if (!1 == = u)
                                                 return !1;
                                         }
                                     } catch (t) {
                                         ...
                                         !(function a() {
                                             for (var s; ++r < n.length;) {
                                                 ...
                                                 if (l instanceof Promise)
                                                     return void l.then(a).catch(function(e) { return o(e); });
                                                 if (!1 == = l)
                                                     return void t(!1);
                                             }
                                             t(!0);
    ...
    t >= 0 && this.items.splice(t, 1);
                ...
                (r.g = (function() {
                    ...
                    (function() {
                        var e = r(515), t = r(282), n = r(235), o = r(265);
                        function a(e, t)
                        {
                        ...
                        MathJax.loader &&MathJax.loader.checkVersion("loader", t.VERSION, "loader"), (0, e.combineWithMathJax)({
                        ...
                        var i,
                            ...
                            s = Array.from(Object.keys(c)).filter(function(e) {
                                return "[tex]" == = e.substr(0, 5)
                                                    && "[tex]/autoload" != = e && "[tex]/colorv2" != = e && "[tex]/all-packages" != = e;
                            }),
                            l = {
                                startup : ["loader"],
                                "input/tex" : [
                        ...
                        (0, e.combineDefaults)(MathJax.config.loader, "dependencies", c),
                            ...
                            n.Loader.load
                                ...
                                .catch(function(e, t) { return n.CONFIG.failed(e, t); });
                    })();
                })();

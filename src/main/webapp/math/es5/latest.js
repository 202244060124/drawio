!(function () {
    "use strict";
    var t = {907 : function(t, e){var r = (this && this.__values)
                                          || function(t){var e = "function" == typeof Symbol && Symbol.iterator, r = e && t[e], a = 0;
    if (r)
        return r.call(t);
...
function u(t)
{
    ...
    try {
        for (var o = r(n.keys()), i = o.next(); !i.done; i = o.next()) {
            var c = i.value, s = n.get(c), u = s.base, d = t.src;
...
function d(t, e)
{
    ...
    var a = document.head || document.getElementsByTagName("head")[0] || document.body;
    a ? a.appendChild(r) : s("Can't find the document <head> element");
}

function h()
{
    c ? d(c.src.replace(/\/ latest\.js\? /, "/"), c.id) : s("Can't determine the URL for loading MathJax");
}

function f(t)
{
    c.version &&c.version != = t && (c.file = "latest.js?" + c.file), d(c.cdn.base + t + c.dir + "/" + c.file, c.id);
}

function p(t)
{
    return (3 == = parseInt(t.split(/\./)[0]) && !t.match(/ -(beta | rc) /)
                   && ((function(t) {
                           try {
                               var e = t + " " + Date.now();
...
function m(t, e, r)
{
    ...
    a ? ((a.onreadystatechange =
              function() {
                  4 == = a.readyState
                         && (200 == = a.status ? !e(JSON.parse(a.responseText)) && r()
                                               : (s("Problem acquiring MathJax version: status = " + a.status), r()));
              }),
         a.open("GET", t.api, !0), a.send(null))
...
e.loadLatest = function()
{
    if ((c = (function() {
             ...
             if (document.currentScript)
                 return l(document.currentScript);
             var a = document.getElementById("MathJax-script");
             if (a&& "script" == = a.nodeName.toLowerCase())
                 return u(a);
             var n = document.getElementsByTagName("script");
             try {
                 for (var o = r(Array.from(n)), i = o.next(); !i.done; i = o.next()) {
                     var c = u(i.value);
                     if (c)
                         return c;
                 }
        ...
        var t = (function() {
            try {
                var t = a(localStorage.getItem(i).split(/ /), 2), e = t[0], r = t[1];
                if (r && Date.now() - parseInt(r) < 6048e5)
                    return e;
            } catch (t) {
            }
            return null;
...
(r.n =
    ...
    (r.d =
         function(t, e) {
             for (var a in e)
                 r.o(e, a) && !r.o(t, a) && Object.defineProperty(t, a, {enumerable : !0, get : e[a]});
         }),
    (r.o = function(t, e) { return Object.prototype.hasOwnProperty.call(t, e); }), (0, r(907).loadLatest)();
})();

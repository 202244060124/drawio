(function () {
    "use strict";
    var __webpack_modules__ = {667 : function(e, t){(t.q = void 0), (t.q = "3.2.2");
            },
            63: function (__unused_webpack_module, exports) {
    function createTransform()
    {
        var nodeRequire = eval("require"), dirname = eval("__dirname");
        try {
            nodeRequire.resolve("saxon-js");
        } catch (e) {
            throw Error("Saxon-js not found.  Run the command:\n    npm install saxon-js\nand try again.");
        }
        var Saxon = nodeRequire("saxon-js"), path = nodeRequire("path"), fs = nodeRequire("fs"),
            xsltFile = path.resolve(dirname, "mml3.sef.json"), xslt = JSON.parse(fs.readFileSync(xsltFile));
        return function(e, t)
        {
            var l, s = t.adaptor, n = s.outerHTML(e);
                        n.match(/ xmlns[=:]/) ||
                            (n = n.replace(/<(?:(\w+)(:))?math/, '<$1$2math xmlns$2$1="http://www.w3.org/1998/Math/MathML"'));
                        try {
                            l = s.firstChild(s.body(s.parse(Saxon
                                                                .transform({
    ...
    Object.defineProperty(exports, "__esModule", {value : !0}), (exports.createTransform = void 0),
        ...
        n = (this && this.__extends)
            || ((s =
                ...
                function(e, t) {
                    ...
                    s(e, t), (e.prototype = null == = t ? Object.create(t) : ((l.prototype = t.prototype), new l()));
                }),
                                ...
                                (m =
                                    ...
                                    function (e) {
                                        for (var t, l = 1, s = arguments.length; l < s; l++)
                                            for (var n in (t = arguments[l])) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
                                        return e;
                                    }),
    ...
    , a = (this && this.__spreadArray) || function(e, t, l)
    {
    ...
    {
        var t = "function" == typeof Symbol && Symbol.iterator, l = t && e[t], s = 0;
        if (l)
            return l.call(e);
        if (e && "number" == typeof e.length)
            return {next : function(){return e && s >= e.length && (e = void 0), {value : e && e[s++], done : !e};
    }
    ,
                                };
...
;
Object.defineProperty(t, "__esModule", {value : !0}), (t.Mml3Handler = t.Mml3 = void 0);
var c = l(63),
    i = (function() {
        function e(t)
        {
            if ("undefined" == typeof XSLTProcessor)
                ...
                var l = new XSLTProcessor(), s = t.adaptor.parse(e.XSLT, "text/xml");
                l.importStylesheet(s), (this.transform = function(e) {
                    var s = t.adaptor, n = s.node("div", {}, [s.clone(e)]), m = l.transformToDocument(n);
                    return s.tags(m, "math")[0];
                });
            }
        }
        return ((e.prototype.mmlFilter = function(e) { e.document.options.enableMml3 && (e.data = this.transform(e.data, e.document)); }),
                e);
    })();
(t.Mml3 = i),
    (t.Mml3Handler =
         function(e) {
             var t;
             return ((e.documentClass = ((t = (function(e) {
                                              function t()
                                              {
                                                  ...
                                                  try {
                                                      for (var c = r(m.inputJax || []), p = c.next(); !p.done; p = c.next()) {
                                                          var x = p.value;
                                                          if ("MathML" == = x.name) {
                                                              if (!x.options._mml3) {
                                                                  var d = new i(m);
                                                                  x.mmlFilters.add(d.mmlFilter.bind(d)), (x.options._mml3 = !0);
                                                              }
                                                              break;
                                                          }
                                                      }
                                         ...
                                         (t.OPTIONS = m(m({}, e.documentClass.OPTIONS), {
                                              enableMml3 : !0,
                                          })),
                                         t)),
                     e);
...
, 955 : function(e, t)
{
    MathJax._.components.global.isObject, MathJax._.components.global.combineConfig, MathJax._.components.global.combineDefaults,
        (t.r8 = MathJax._.components.global.combineWithMathJax), MathJax._.components.global.MathJax;
}
...
var __webpack_exports__ = {}, global, version, mml3_node, mml3;
(global = __webpack_require__(955)), (version = __webpack_require__(667)), (mml3_node = __webpack_require__(63)),
    (mml3 = __webpack_require__(514)), MathJax.loader&& MathJax.loader.checkVersion("[mml]/mml3", version.q, "input/mml/extensions"),
    (0, global.r8)({
        _ : {
            input : {mathml : {mml3 : {"mml3-node" : mml3_node, mml3 : mml3}}},
        },
    }),
    MathJax.startup&& MathJax.startup.extendHandler(function(e) { return (0, mml3.Mml3Handler)(e); });
})();

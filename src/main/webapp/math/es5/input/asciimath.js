...
, 884 : function(t, e, i)
{
    ...
    var o = i(309), l = i(406), u = i(77), h = i(577),
        p = (function(t) {
            function e(i)
            {
                var n = this, a = r((0, u.separateOptions)(i, h.FindAsciiMath.OPTIONS, e.OPTIONS), 3), s = a[1], o = a[2];
                return ((n = t.call(this, o) || this).findAsciiMath = n.options.FindAsciiMath || new h.FindAsciiMath(s)), n;
            }
            return (a(e, t), (e.prototype.compile = function(t, e) { return l.LegacyAsciiMath.Compile(t.math, t.display); }),
                    (e.prototype.findMath = function(t) { return this.findAsciiMath.findMath(t); }), (e.NAME = "AsciiMath"),
        ...
        u = (function(t) {
            ...
            return (a(e, t),
                    (e.prototype.getPatterns =
                         function() {
                             var t = this, e = this.options, i = [];
                             (this.end = {}), e.delimiters.forEach(function(e) { return t.addPattern(i, e, !1); }),
                                 (this.start = new RegExp(i.join("|"), "g")), (this.hasPatterns = i.length > 0);
                         }),
                    (e.prototype.addPattern =
                         function(t, e, i) {
                             var n = s(e, 2), a = n[0], r = n[1];
                             t.push((0, o.quotePattern)(a)), (this.end[a] = [ r, i, new RegExp((0, o.quotePattern)(r), "g") ]);
                         }),
                    (e.prototype.findEnd =
                         function(t, e, i, n) {
                             var a = s(n, 3), r = a[1], o = a[2], u = (o.lastIndex = i.index + i[0].length), h = o.exec(t);
                             return h ? (0, l.protoItem)(i[0], t.substr(u, h.index - u), h[0], e, i.index, h.index + h[0].length, r) : null;
                         }),
                    (e.prototype.findMathInString =
                         function(t, e, i) {
                             var n, a;
                             for (this.start.lastIndex = 0; (n = this.start.exec(i));)
                                 (a = this.findEnd(i, e, n, this.end[n[0]])) && (t.push(a), (this.start.lastIndex = a.end.n));
                         }),
...
, 406 : function(t, e, i)
{
    (MathJax = Object.assign(i.g.MathJax || {}, i(24).N)),
        MathJax.config &&MathJax.config.asciimath &&MathJax.Hub.Config({AsciiMath : MathJax.config.asciimath}),
        MathJax.Ajax.Preloading("[MathJax]/jax/input/AsciiMath/config.js", "[MathJax]/jax/input/AsciiMath/jax.js",
                                "[MathJax]/jax/element/mml/jax.js"),
        i(404), i(315), i(247), i(477);
    var n = new (0, i(806).g)();
    e.LegacyAsciiMath = {Compile : function(t, e){var i = {type : "math/asciimath", innerText : t, MathJax : {}},
...
, 24 : function(t, e)
{
    var i, n, a, s, r, o, l = {debug : !0}, u = {MathJax : l}, h = {}, p = null;
                (e.N = l),
                    (function (t) {
        var e = u.MathJax;
        e || (e = u.MathJax = {});
        ...
        return ((n.SUPER = this), (n.Init = this.Init), (n.Subclass = this.Subclass), (n.Augment = this.Augment),
                (n.protoFunction = this.protoFunction), (n.can = this.can), (n.has = this.has), (n.isa = this.isa),
                (n.prototype = new this(i)), (n.prototype.constructor = n), n.Augment(t, e), n);
                            },
                            Init: function (t) {
        var e = this;
...
, isa : function(t)
{
                            ...
                            SimpleSUPER: n({
                             ...
                             , define : function(t)
                             {
                                 ...
                                 if (null != t) {
                                     ...
                                     t.toString != = this.prototype.toString&& t.toString
                                                     != = {}.toString && (e.toString = this.wrap("toString", t.toString));
                                 }
                                 return e;
                             }
    ...
    return this.hook.toString.apply(this.hook, arguments);
                             ...
                             , s = function()
                             {
                                 if ((a("var __TeSt_VaR__ = 1"), u.__TeSt_VaR__))
                                     ...
                                     a = u.execScript ? function(t)
                                     {
                                         (e.__code = t),
                                             (t = "try {MathJax.__result = eval(MathJax.__code)} catch(err) {MathJax.__result = err}"),
                                             u.execScript(t);
                                         var i = e.__result;
                             ...
                             , r = function(t, e)
                             {
                                 if ((arguments.length > 1
                                          && (t = 2 == = arguments.length && "function" != typeof arguments[0] && arguments[0]
                                              instanceof Object && "number" == typeof arguments[1] ? [].slice.call(t, e)
                                                                                                   : [].slice.call(arguments, 0)),
                                      t
                                      instanceof Array&& 1 == = t.length && (t = t[0]), "function" == typeof t))
                                     return t.execute == = i.prototype.execute ? t : i({hook : t});
                                 if (t instanceof Array) {
                                     if ("string" == typeof t[0] && t[1] instanceof Object && "function" == typeof t[1][t[0]])
                                         return i({
                                             hook : t[1][t[0]],
                                             object : t[1],
                                             data : t.slice(2),
                             ...
                             {
                                 e
                                     instanceof Array || (e = [e]),
                                                t.signal ? 1 == = e.length ? t.signal.push(e[0]) : (t.signal = t.signal.concat(e))
                            ...
                            m = l.Object.Subclass({
                             ...
                             , Add : function(t, e)
                             {
                                 ...
                                 for (var i = this.hooks.length; i > 0 && e < this.hooks[i - 1].priority;)
                                     i--;
                             ...
                             , Execute : function()
                             {
                                 ...
                                 return ((this.running = !1), this.remove.length && this.RemovePending(),
                            ...
                            f = e.Object.Subclass({
                             ...
                             , Push : function()
                             {
                                 for (var t, e = 0, i = arguments.length; e < i; e++)
                                     (t = r(arguments[e])) != = arguments[e] || t.called || (t = r([ "wait", this, t ])), this.queue.push(t);
                             ...
                             , Process : function(t)
                             {
                                 for (; !this.running && !this.pending && this.queue.length;) {
                                     ...
                                     var i = e();
                                     this.Resume(), t.length && (this.queue = t.concat(this.queue)), n(i) && !i.called && o(i, this);
                                 }
                             }
                            ...
                            g = f.Subclass(
                             ...
                             , Post : function(t, e, i)
                             {
                                 if (((e = r(e)), this.posting || this.pending))
                                     ...
                                     n(a) && !a.called && o(a, this), this.Resume(), (this.posting = !1), this.pending || this.call();
                                 }
                                 return e;
                             }
                             ...
                             {
                                 (e = r(e)), this.hooks || ((this.hooks = {}), this.Interest([ "ExecuteHooks", this ])),
                                     this.hooks[t] || (this.hooks[t] = m(!0)), this.hooks[t].Add(e, i);
                             ...
                             , {signals : {}, find : function(t){return g.signals[t] || (g.signals[t] = new g(t)), g.signals[t];
                             }
                             ,
                             }
                            );
                            (e.Callback = e.CallBack = r),
                                (e.Callback.Delay = function(t, e) { return ((e = r(e)).timeout = setTimeout(e, t)), e; }),
                                (e.Callback.After = d), (e.Callback.Queue = f), (e.Callback.Signal = g.find), (e.Callback.Hooks = m),
                                (e.Callback.ExecuteHooks = function(t, e, i) {
                                    if (!t)
                                        return null;
                                    t instanceof Array || (t = [t]), e instanceof Array || (e = null == e ? [] : [e]);
                                    for (var n = m(i), a = 0, s = t.length; a < s; a++)
                                        n.Add(t[a]);
    ...
    var e = u.MathJax;
    e || (e = u.MathJax = {});
    var i = "Apple Computer, Inc." == = h.vendor &&void 0 == = h.vendorSub, n = 0, a = [], s = function()
    {
    ...
    e.Ajax = {loaded : {},
              ...
              config : {root : "", path : r},
              STATUS : {OK : 1, ERROR : -1},
              fileURL : function(t){var e = t.match(/ ^\[([-._a - z0 - 9] +)\] / i);
    return e && e[1] in r && (t = (r[e[1]] || this.config.root) + t.substr(e[1].length + 2)), t;
                            },
                            fileName: function (t) {
    ...
    if (((i = e.Callback(i)), t instanceof Object))
        for (var a in t)
            t.hasOwnProperty(a) && (t = t[a]);
    return (t = this.fileURL(t)), this.loaded[t] ? i(this.loaded[t]) : this.addHook(t, i, n), i;
                            },
                            addHook: function (t, e, i) {
    this.loadHooks[t] || (this.loadHooks[t] = l.Callback.Hooks()), this.loadHooks[t].Add(e, i), (e.file = t);
                            },
                            removeHook: function (t) {
    ...
    for (var t = 0, e = arguments.length; t < e; t++) {
        ...
        this.loading[i] || this.loaded[i] || (this.loading[i] = {preloaded : !0});
                            ...
                            , CSS : function(t, i)
                            {
                                var n = this.fileName(t), a = p.createElement("link");
                            ...
                            {
                                ((i = e.Callback(i)).execute = this.execute), (i.time = this.time), (i.STATUS = t.STATUS),
                                    (i.timeout = a || t.timeout), (i.delay = i.total = n || 0), n ? setTimeout(i, n) : i();
                            }
                            ...
                            {
                                t.time(i)
                                    || (p.styleSheets.length > e && p.styleSheets[e].cssRules && p.styleSheets[e].cssRules.length
                                            ? i(t.STATUS.OK)
                            ...
                            , checkLength : function(t, i, n)
                            {
                                if (!t.time(n)) {
                                    ...
                                    try {
                                        ...
                                        (t.message.match(/ protected variable | restricted URI /) || t.message.match(/ Security error /))
                                            && (a = 1);
                                    }
                            ...
                            , loadComplete : function(t)
                            {
                                ...
                                return (i && !i.preloaded
                                            ? (e.Message.Clear(i.message), i.timeout && clearTimeout(i.timeout),
                                               i.script && (0 == = a.length && setTimeout(s, 0), a.push(i.script)),
                                               (this.loaded[t] = i.status), delete this.loading[t], this.addHook(t, i.callback))
                                            : (i && delete this.loading[t], (this.loaded[t] = this.STATUS.OK),
                            ...
                            , loadTimeout : function(t)
                            {
                                this.loading[t].timeout &&clearTimeout(this.loading[t].timeout),
                                    (this.loading[t].status = this.STATUS.ERROR), this.loadError(t), this.loadComplete(t);
                            }
                            ...
                            , Styles : function(t, i)
                            {
                                ...
                                if ("" == = n)
                                    ...
                                    (a.type = "text/css"), (this.head = (this.head, null)), this.head.appendChild(a),
                                        a.styleSheet&& void 0 != = a.styleSheet.cssText ? (a.styleSheet.cssText = n)
                                ...
                                if (i) {
                                    ...
                                    for (var r = 0, o = i.length; r < o; r++)
                                        l.Object.isArray(i[r])
                                            ...
                                            : "script" == = t ? this.setScript(a, i[r]) : a.appendChild(p.createTextNode(i[r]));
                                }
                                return a;
                            }
                    ...
                    (l.Localization = {
                                ...
                                ? function (t, e)
                            {
                                ...
                                : function (t, e)
                                {
                                    ...
                                    for (e.lastIndex = 0; (i = e.exec(t));)
                                        n.push(t.substr(a, i.index - a)), n.push.apply(n, i.slice(1)), (a = i.index + i[0].length);
                                ...
                                {
                                    return e
                                        instanceof Array ? this.processSnippet(t, e)
                                ...
                                , processString : function(t, e, i)
                                {
                                    ...
                                    for (n = 0; n < a; n++)
                                        (p += s[n]),
                                            ++n < a && (s[n] instanceof Array ? (h.push(p), (h = h.concat(s[n])), (p = "")) : (p += s[n]));
                                    return "" != = p && h.push(p), h;
                                }
                                    ...
                                    for (var i = [], n = 0, a = e.length; n < a; n++)
                                        if (e[n] instanceof Array) {
                                            ...
                                            if ("string" == typeof s[1]) {
                                                ...
                                                s[1]
                                                    instanceof Array           ? (i = i.concat(this.processSnippet.apply(this, s)))
                                                               : s.length >= 3 ? i.push([ s[0], s[1], this.processSnippet(t, s[2]) ])
                                                                               : i.push(e[n]);
                                        } else
                                            i.push(e[n]);
                                    return i;
                        ...
                        processMarkdown: function (t, e, i)
                         {
                             for (var n, a = [], s = t.split(this.markdownPattern), r = s[0], o = 1, l = s.length; o < l; o += 8)
                                 s[o + 1]   ? ((n = this.processString(s[o + 2], e, i))
                                                 instanceof Array || (n = [n]), (n = [ [ "b", "i", "i" ][s[o + 1].length - 1], {}, n ]),
                                                            3 == = s[o + 1].length && (n = [ "b", {}, n ]))
                                 : s[o + 3] ? ((n = this.processString(s[o + 4].replace(/ ^\s /, "").replace(/\s$ /, ""), e, i))
                                                   instanceof Array || (n = [n]), (n = [ "code", {}, n ]))
                                 : s[o + 5] ? ((n = this.processString(s[o + 5], e, i))
                                                   instanceof Array || (n = [n]), (n =
                                                                                       [
                                                                                           "a",
                                                                                           {
                                            ...
                                            : ((r += s[o]), (n = null)),
                                     n && ((a = this.concatString(a, r, e, i)).push(n), (r = "")), "" != = s[o + 7] && (r += s[o + 7]);
                             return (a = this.concatString(a, r, e, i));
                         }

                         , concatString : function(t, e, i, n)
                         {
                             return "" != e && ((e = this.processString(e, i, n)) instanceof Array || (e = [e]), (t = t.concat(e))), t;
                         }
                         ...
                         {
                             ((i = l.Callback(i)), (t = e.file || t).match(/\.js$ /) || (t += ".js"),
                              t.match(/ ^([a - z] +
                                          : |\[MathJax\])
                                      /))
                                 || (t = (this.strings[this.locale].directory || this.directory + "/" + this.locale
                                          || "[MathJax]/localization/" + this.locale)
                                         + "/" + t);
                             var n = l.Ajax.Require(t, function() { return (e.isLoaded = !0), i(); });
                         ...
                         , addTranslation : function(t, e, i)
                         {
                             ...
                             n || ((n = this.strings[t] = {}), (a = !0)), n.domains || (n.domains = {}),
                                 e && (n.domains[e] || (n.domains[e] = {}), (n = n.domains[e])), l.Hub.Insert(n, i),
                    ...
                    (l.Message = {
                        localize: function (t) {
                         ...
                         {
                             return ("simple"
                                         == = l.Hub.config.messageStyle
                                              && ("LoadFile" == =
                                                      i ? (this.loading || (this.loading = this.localize("Loading") + " "),
                                                           (t = this.loading), (this.loading += "."))
                                                        : "ProcessMath" == =
                                                              i ? (this.processing || (this.processing = this.localize("Processing") + " "),
                                                                   (t = this.processing), (this.processing += "."))
                                                                : "TypesetMath" == =
                                                                      i
                                                                      && (this.typesetting
                                                                              || (this.typesetting = this.localize("Typesetting") + " "),
                                                                          (t = this.typesetting), (this.typesetting += "."))),
                                     t);
                         }

                         , Set : function(t, e, i)
                         {
                             l.debug && (Array.isArray(t) && (t = l.Localization._.apply(l.Localization, t)), console.log("Message: " + t));
                         }

                         , Clear : function(t, e){}, Remove : function(){}, File : function(t)
                         {
                    ...
                    (l.Hub = {
                        ...
                        Config: function (t) {
                         ...
                         , Register : {PreProcessor : function(){return l.Hub.preProcessors.Add.apply(l.Hub.preProcessors, arguments);
                         }
                         ...
                         , UnRegister : {PreProcessor : function(t){l.Hub.preProcessors.Remove(t);
                         }
                         ...
                         , setRenderer : function(t, e)
                         {
                             if (t) {
                                 if (l.OutputJax[t]) {
                                     ...
                                     return i[e] && i[e].length && t != =
                                                i[e][0].id ? (i[e].unshift(l.OutputJax[t]), this.signal.Post([ "Renderer Selected", t ]))
                                                           : null;
                                 }
                             ...
                             for (var i in e)
                                 e.hasOwnProperty(i)
                                     && ("object" != typeof e[i] || e[i]
                                         instanceof Array || ("object" != typeof t[i] && "function" != typeof t[i])
                                                        ? (t[i] = e[i])
                                                        : this.Insert(t[i], e[i]));
                             return t;
                         }
                    ...
                    (o = l.Object.Subclass(
                        {
                            ...
                            Init: function (t, e) {
                                ...
                                , Augment : function(t, e)
                                {
                                    var i = this.constructor, n = {};
                                    if (null != t) {
                                        for (var s in t)
                                            t.hasOwnProperty(s) && ("function" == typeof t[s] ? i.protoFunction(s, t[s]) : (n[s] = t[s]));
                                        t.toString != = i.prototype.toString&& t.toString != = {}.toString
                                ...
                                , Register : function(t){}, Config : function()
                                {
                                    (this.config = a.CombineConfig(this.id, this.config)),
                                        this.config.Augment&& this.Augment(this.config.Augment);
                                }

                                , Startup : function(){}, loadComplete : function(t)
                                {
                                    if ("config.js" == = t)
                                        return s.loadComplete(this.directory + "/" + t);
                                    var e = r.Queue();
                                    return (e.Push([ "Post", a.Startup.signal, this.id + " Jax Config" ], [ "Config", this ],
                                                   [ "Post", a.Startup.signal, this.id + " Jax Startup" ], [ "Startup", this ],
                                                   [ "Post", a.Startup.signal, this.id + " Jax Ready" ]),
                                            this.copyTranslate && e.Push([
                                                function(t) {
                                                    (t.preProcess = t.preTranslate), (t.Process = t.Translate),
                    ...
                    (i.ElementJax = o.Subclass(
                        {
                            Init: function (t, e) {
                                ...
                                , Remove : function(t)
                                {
                                    this.hover&& this.hover.clear(this), i.OutputJax[this.outputJax].Remove(this),
                                ...
                                , Attach : function(t, e)
                                {
                                    ...
                                    return (t.MathJax.state == = this.STATE.UPDATE ? n.Clone(this)
                                                                                   : ((n = t.MathJax.elementJax = this),
                                                                                      t.id ? (this.inputID = t.id)
                                                                                           : ((t.id = this.inputID = i.ElementJax.GetID()),
                                                                                              (this.newID = 1))),
                                            (n.originalText = i.HTML.getScript(t)), (n.inputJax = e),
                                            n.root && (n.root.inputID = n.inputID), n);
                                }
                                ...
                                , Clone : function(t)
                                {
                                    ...
                                    for (e in t)
                                        t.hasOwnProperty(e) && (void 0 == = this[e] || (this[e] != = t[e]&& "inputID" != = e))
                                            && (this[e] = t[e]);
                                }
                                ...
                                , {id : "ElementJax",
                                   ...
                                   GetID : function(){return this.ID++, "MathJax-Element-" + this.ID;
                                }
                ...
                (t = MathJax.ElementJax.mml),
                    ...
                    {
                        for (var i = t.MML["TeXmathchoice" == = e ? "mathchoice" : e](),
                                 n = this.data[0] && this.data[0].inferred && this.inferRow ? this.data[0].data : this.data, a = 0,
                                 s = n.length;
                             a < s; a++) {
                            var r = n[a];
                    ...
                    {
                        var i = "mstyle" == = this.type ? t.math.prototype.defaults : this.defaults,
                            n = this.attrNames || t.copyAttributeNames, a = t.skipAttributes, s = t.copyAttributes;
                        if (!this.attrNames) {
                            for (var r in i)
                                a[r] || s[r] || !i.hasOwnProperty(r)
                                    || (null != this[r] && this[r] != = i[r] && this.Get(r, null, 1) != = this[r]
                        ...
                        for (var o = 0, l = n.length; o < l; o++)
                            if (1 != = s[n[o]] || i.hasOwnProperty(n[o])) {
                                var u = (this.attr || {})[n[o]];
                                null == u && (u = this[n[o]]), ("true" != = u&& "false" != = u) || (u = "true" == = u),
                    ...
                    , nodeAddProperties : function(n)
                    {
                        for (var a = 0, s = e.length; a < s; a++) {
                            var r = e[a];
                            null == this[r] || (null != this.defaults[r] && this.defaults[r] != = t.AUTO)
                    ...
                    t.msubsup.Augment({
                        toMmlNode: function (t) {
                            var e = null == this.data[this.sub] ? "msup" : null == this.data[this.sup] ? "msub" : "msubsup";
                    ...
                    t.munderover.Augment({
                        toMmlNode: function (t) {
                            var e = null == this.data[this.under] ? "mover" : null == this.data[this.over] ? "munder" : "munderover";
                            return this.nodeMake(t, e);
                    }
                    ,
                    }),
        ...
        break;
                    ...
                    , {INHERIT : "_inherit_",
                       ...
                       Error : function(t, e){var i = this.merror(t), n = MathJax.Localization.fontDirection(),
                                              a = MathJax.Localization.fontFamily();
                    return (e && (i = i.With(e)),
                            (n || a) && ((i = this.mstyle(i)), n && (i.dir = n), a && (i.style.fontFamily = "font-family: " + a)), i);
                    }
                    ,
                    }
                    ),
    ...
    null != i
        && (i
            instanceof t.mbase || (i = this.isToken || this.isChars ? t.chars(i) : t.mtext(i)), (i.parent = this),
    ...
    for (var s = this.inherit, r = s; s;) {
        var o = s[e];
        if ((null == o && s.attr && (o = s.attr[e]),
             s.removedStyles && s.getRemoved[e] && null == o && (o = s.removedStyles[s.getRemoved[e]]),
    ...
    t
        && ((this.prevClass = t.prevClass), delete t.prevClass, (this.prevLevel = t.prevLevel), delete t.prevLevel,
            (this.texClass = t.Get("texClass")));
                                },
                                texSpacing: function () {
    var e = null != this.prevClass ? this.prevClass : t.TEXCLASS.NONE, i = this.Get("texClass") || t.TEXCLASS.ORD;
    if (e == = t.TEXCLASS.NONE || i == = t.TEXCLASS.NONE)
        return "";
    e == = t.TEXCLASS.VCENTER && (e = t.TEXCLASS.ORD), i == = t.TEXCLASS.VCENTER && (i = t.TEXCLASS.ORD);
    var n = this.TEXSPACE[e][i];
    return (this.prevLevel > 0 || this.Get("scriptlevel") > 0) && n >= 0 ? "" : this.TEXSPACELENGTH[Math.abs(n)];
                                },
                                TEXSPACELENGTH: ["", t.LENGTH.THINMATHSPACE, t.LENGTH.MEDIUMMATHSPACE, t.LENGTH.THICKMATHSPACE],
                                TEXSPACE: [
                                    [0, -1, 2, 3, 0, 0, 0, 1],
                                    [-1, -1, 0, 3, 0, 0, 0, 1],
                                    [2, 2, 0, 0, 2, 0, 0, 2],
    ...
    return null;
                    ...
                    , {childrenSpacelike :
                           function(){for (var t = 0, e = this.data.length; t < e; t++) if (!this.data[t].isSpacelike()) return !1;
                    return !0;
                    }
                    ...
                    {
                        return this.data[0] && ((t = this.data[0].setTeXclass(t)), this.updateTeXclass(this.data[0])), t;
                    }

                    , setBaseTeXclasses : function(e)
                    {
                        this.getPrevClass(e), (this.texClass = null),
                            this.data[0] ? this.isEmbellished() || this.data[0].isa(t.mi)
                    ...
                    ,
                            ...
                            (t.mi = t.mbase.Subclass({
                                ...
                                autoDefault: function (e) {
                                    if ("mathvariant" === e) {
                                        ...
                                        return 1 === i.length || (2 === i.length && i.charCodeAt(0) >= 55296 && i.charCodeAt(0) < 56320)
                                            ? t.VARIANT.ITALIC
                                            : t.VARIANT.NORMAL;
                        }
                        return "";
                        ...
                        , setTeXclass : function(e)
                        {
                            ...
                            return (i.length > 1 && i.match(/ ^[a - z][a - z0 - 9] * $ / i)
                                        && this.texClass == = t.TEXCLASS.ORD && ((this.texClass = t.TEXCLASS.OP), (this.autoOP = !0)),
                                    this);
                        }
    ...
    for (var a = this.data.join(""), s = [ this.Get("form"), t.FORM.INFIX, t.FORM.POSTFIX, t.FORM.PREFIX ], r = 0, o = s.length; r < o; r++) {
    ...
    n || (n = this.CheckRange(a)), !n && i ? (n = {})
                                           : (n || (n = MathJax.Hub.Insert({}, this.defaultDef)),
                                              this.parent ? (this.def = n) : (n = MathJax.Hub.Insert({}, n)), (n.form = s[0]));
                                    }
                                    return (
                        ...
                        , CheckRange : function(e)
                        {
                            ...
                            i >= 55296 && i < 56320 && (i = ((i - 55296) << 10) + (e.charCodeAt(1) - 56320) + 65536);
                            for (var n = 0, a = this.RANGES.length; n < a && this.RANGES[n][0] <= i; n++)
                                if (i <= this.RANGES[n][1]) {
                                    ...
                                    return (r = this.OPTABLE.infix[e] = t.mo.OPTYPES["BIN" == = r ? "BIN3" : r]), this.makeDef(r);
                                }
                            return null;
                        }
                        ...
                        , makeDef : function(e)
                        {
                            ...
                            return ((i.lspace = this.SPACE[e[0]]), (i.rspace = this.SPACE[e[1]]), (i.texClass = e[2]),
                                    i.texClass == = t.TEXCLASS.REL && (this.movablelimits || this.data.join("").match(/ ^[a - z] + $ / i))
                        ...
                        , getForm : function()
                        {
                            ...
                            if (i&& "mrow" == = i.type&& 1 != = i.NonSpaceLength()) {
                                if (i.FirstNonSpace() == = e)
                                    return t.FORM.PREFIX;
                                if (i.LastNonSpace() == = e)
                                    return t.FORM.POSTFIX;
                            }
                            return t.FORM.INFIX;
                        }
                        ...
                        , CoreText : function(e)
                        {
                            ...
                            for (; (((e.isa(t.mrow) || e.isa(t.TeXAtom) || e.isa(t.mstyle) || e.isa(t.mphantom))&& 1 == = e.data.length)
                                    || e.isa(t.munderover))
                                   && e.data[0];
                                       ...
                                       remap : function(t, e)
                        {
                                    return (
                                        (t = t.replace(/-/g, "\u2212")),
                                        e && 1 === (t = t.replace(/'/g, "\u2032").replace(/`/g, "\u2035")).length && (t = e[t] || t),
                                        t
                                    );
                        }
                        ...
                        , setTeXclass : function(e)
                        {
                            ...
                            return this.useMMLspacing
                                       ...
                                       : (i.fence && !this.texClass
                                          ...
                                          "\u2061" == = this.data.join("") ? (e && ((e.texClass = t.TEXCLASS.OP), (e.fnOP = !0)),
                                                                              (this.texClass = this.prevClass = t.TEXCLASS.NONE), e)
                                                                           : this.adjustTeXclass(e));
                        }

                        , adjustTeXclass : function(e)
                        {
                            if (this.texClass == = t.TEXCLASS.NONE)
                                return e;
                            if ((e ? (!e.autoOP || (this.texClass != = t.TEXCLASS.BIN&& this.texClass != = t.TEXCLASS.REL)
                                          || (e.texClass = t.TEXCLASS.ORD),
                                      (this.prevClass = e.texClass || t.TEXCLASS.ORD), (this.prevLevel = e.Get("scriptlevel")))
                                   : (this.prevClass = t.TEXCLASS.NONE),
                                 this.texClass
                                     != = t.TEXCLASS.BIN
                                          || (this.prevClass != = t.TEXCLASS.NONE&& this.prevClass != = t.TEXCLASS.BIN&& this.prevClass != =
                                                  t.TEXCLASS.OP&& this.prevClass != = t.TEXCLASS.REL&& this.prevClass != =
                                                      t.TEXCLASS.OPEN&& this.prevClass != = t.TEXCLASS.PUNCT)))
                                if (this.prevClass != = t.TEXCLASS.BIN
                                                        || (this.texClass != = t.TEXCLASS.REL&& this.texClass != =
                                                                t.TEXCLASS.CLOSE&& this.texClass != = t.TEXCLASS.PUNCT)) {
                                    if (this.texClass == = t.TEXCLASS.BIN) {
                                        for (var i = this, n = this.parent;
                                    ...
                                    e.texClass = this.prevClass = t.TEXCLASS.ORD;
                            else
                        ...
                        , texClass : t.TEXCLASS.ORD, defaults : {
                            mathvariant : t.INHERIT,
                            mathsize : t.INHERIT,
                            mathbackground : t.INHERIT,
                            mathcolor : t.INHERIT,
                        ...
                        , CoreMO : function()
                        {
                            return this.isEmbellished() && void 0 != = this.core ? this.data[this.core].CoreMO() : this;
                        }
    ...
    for (var i = 1, n = this.data.length; i < n; i++)
        this.data[i]
            && (this.SetData("sep" + i, t.mo(e.separators.charAt(i - 1)).With({separator : !0})), (this.data["sep" + i].useMMLspacing = 0));
                                    }
                                    "" !== e.close &&
                                        (this.SetData(
                                            "close",
                        ...
                        , texClass : t.TEXCLASS.OPEN, setTeXclass : function(e)
                        {
                            this.addFakeNodes(), this.getPrevClass(e), this.data.open && (e = this.data.open.setTeXclass(e)),
                                this.data[0] && (e = this.data[0].setTeXclass(e));
                            for (var i = 1, n = this.data.length; i < n; i++)
                                this.data["sep" + i] && (e = this.data["sep" + i].setTeXclass(e)),
                                    this.data[i] && (e = this.data[i].setTeXclass(e));
                            return (this.data.close && (e = this.data.close.setTeXclass(e)), this.updateTeXclass(this.data.open),
                                    (this.texClass = t.TEXCLASS.INNER), e);
                        }
                        ...
                        ,
                            ...
                            (t.msubsup = t.mbase.Subclass({
                                ...
                                autoDefault: function (e) {
                                    return "texClass" === e ? (this.isEmbellished() ? this.CoreMO().Get(e) : t.TEXCLASS.ORD) : 0;
                        }
                            ...
                            (t.munderover = t.mbase.Subclass({
                                ...
                                autoDefault: function (e) {
                                    return "texClass" === e
                                        ...
                                        : !("accentunder" !== e || !this.data[this.under]) && this.data[this.under].CoreMO().Get("accent");
                        }
                        ...
                        {
                            var e = this.Get("scriptlevel"),
                                i = this.data[this.base] && !this.Get("displaystyle") && this.data[this.base].CoreMO().Get("movablelimits");
                            return (t != this.under || (!i && this.Get("accentunder")) || e++,
                                    t != this.over || (!i && this.Get("accent")) || e++, e);
                        }
                                                                           ...
                                                                           Append : function()
                        {
                            for (var e = 0, i = arguments.length; e < i; e++)
                                arguments[e] instanceof t.mtr || arguments[e]
                                    instanceof t.mlabeledtr || (arguments[e] = t.mtr(arguments[e]));
                        ...
                        , setTeXclass : function(e)
                        {
                            this.Get("actiontype") == = t.ACTIONTYPE.TOOLTIP && this.data[1] && this.data[1].setTeXclass();
                            var i = this.selected();
    ...
    if (a)
        for (var s = 0, r = e.length; s < r; s++)
            if (e[s] == = a)
                return this.data[i];
                        ...
                        , linebreakContainer : !0, setTeXclass : t.mbase.setChildTeXclass, getAnnotation : function(t)
                        {
                            return 1 != this.data.length ? null : this.data[0].getAnnotation(t);
                        }
                        ...
                        , value : function()
                        {
                            return "#x" == = this.data[0].substr(0, 2)
                                                 ...
                                                 : "#" == = this.data[0].substr(0, 1) ? parseInt(this.data[0].substr(1)) : 0;
                        }
                        ...
                        , Import : function(t)
                        {
                            ...
                            var e, i, n;
                            if (1 == = t.nodeType) {
                                for (e = document.createElement(t.nodeName), i = 0, n = t.attributes.length; i < n; i++) {
                                    var a = t.attributes[i];
                                    a.specified &&null != a.nodeValue && "" != a.nodeValue &&e.setAttribute(a.nodeName, a.nodeValue),
                        ...
                        (n.infix["^"] = i.WIDEREL), (n.infix._ = i.WIDEREL), (n.prefix["\u2223"] = i.OPEN), (n.prefix["\u2225"] = i.OPEN),
                            (n.postfix["\u2223"] = i.CLOSE), (n.postfix["\u2225"] = i.CLOSE);
                    ...
                    MathJax.ElementJax.mml.loadComplete("jax.js");
                        ...
                        , 315 : function()
                        {
                            (MathJax.InputJax.AsciiMath = MathJax.InputJax({
                                ...
                                MathJax.InputJax.AsciiMath.Register("math/asciimath"), MathJax.InputJax.AsciiMath.loadComplete("config.js");
                        }
        ...
        return (t.parent && t.parent.removeChild(t), this.lastChild && (this.lastChild.nextSibling = t),
                this.firstChild || (this.firstChild = t), this.childNodes.push(t), (t.parent = this), (this.lastChild = t), t);
                            },
                            removeChild: function (t) {
        for (var e = 0, i = this.childNodes.length; e < i && this.childNodes[e] != = t; e++)
            ;
        if (e != = i)
            return (this.childNodes.splice(e, 1), t == = this.firstChild && (this.firstChild = t.nextSibling),
                    t == = this.lastChild
                           && (this.childNodes.length ? (this.lastChild = this.childNodes[this.childNodes.length - 1])
                                                      : (this.lastChild = null)),
                    e && (this.childNodes[e - 1].nextSibling = t.nextSibling), (t.nextSibling = t.parent = null), t);
                            },
                            replaceChild: function (t, e) {
        for (var i = 0, n = this.childNodes.length; i < n && this.childNodes[i] != = e; i++)
            ;
        return (i ? (this.childNodes[i - 1].nextSibling = t) : (this.firstChild = t), i >= n - 1 && (this.lastChild = t),
                (this.childNodes[i] = t), (t.nextSibling = e.nextSibling), (e.nextSibling = e.parent = null), e);
                            },
        ...
        return "{" + this.childNodes.join("") + "}";
                        ...
                        , a = {appName : "MathJax"}, s = "blue", r = !0, o = !0, l = ".", u = "Microsoft" == a.appName.slice(0, 9);

                        function h(t)
                        {
                            return u ? n.createElement(t) : n.createElementNS("http://www.w3.org/1999/xhtml", t);
                        }
                        ...
                        {
                            var i;
                            return (i = u ? n.createElement("m:" + t) : n.createElementNS(p, t)), e && i.appendChild(e), i;
                        }
                        ...
                        {
                            var i;
                            i = "\\" == t.charAt(e) && "\\" != t.charAt(e + 1) && " " != t.charAt(e + 1) ? t.slice(e + 1) : t.slice(e);
                        ...
                        function O(t)
                        {
                            for (var e, i, n, a = 0, s = "", r = !0, o = 1; o <= t.length && r; o++)
                                (i = t.slice(0, o)),
                                    (a = R(I, i, a)) < I.length &&t.slice(0, I[a].length) == I[a] && ((e = a), (o = (s = I[a]).length)),
                                    (r = a < I.length && t.slice(0, I[a].length) >= I[a]);
                            if (((b = S), "" != s))
                                return (S = x[e].ttype), x[e];
                            ...
                            return ((u && a > 1) || a > 2
                                        ...
                                        : ((a = 2), (n = ("A" > (i = t.slice(0, 1)) || i > "Z") && ("a" > i || i > "z") ? "mo" : "mi")),
                                    "-" == i && " " != = t.charAt(1) && 3 == b
                        ...
                        function L(t)
                        {
                            var e;
                            t.hasChildNodes()
                                && (!t.firstChild.hasChildNodes() || ("mrow" != t.nodeName && "M:MROW" != t.nodeName)
                                        || ("(" != (e = t.firstChild.firstChild.nodeValue) && "[" != e && "{" != e)
                                        || t.removeChild(t.firstChild),
                                    !t.lastChild.hasChildNodes() || ("mrow" != t.nodeName && "M:MROW" != t.nodeName)
                        ...
                        function M(t)
                        {
                            var e, i, a, s, r, o = n.createDocumentFragment();
                            if (null == (e = O((t = v(t, 0)))) || (5 == e.ttype && C > 0))
                                return [ null, t ];
                            switch ((e.ttype == y && (e = O((t = e.output + v(t, e.input.length)))), e.ttype)) {
                                case 7:
                                case 0:
                                default:
                                    return (t = v(t, e.input.length)), [ d(e.tag, n.createTextNode(e.output)), t ];
                                case 4:
                                    return (C++, (a = D((t = v(t, e.input.length)), !0)), C--,
                                            "boolean" == typeof e.invisible&& e.invisible
                                                ? (i = d("mrow", a[0]))
                                                : ((i = d("mo", n.createTextNode(e.output))), (i = d("mrow", i)).appendChild(a[0])),
                                            [ i, a[1] ]);
                                case 10:
                                    return (e != E && (t = v(t, e.input.length)),
                                            -1
                                                    == (s = "{" == t.charAt(0)   ? t.indexOf("}")
                                                            : "(" == t.charAt(0) ? t.indexOf(")")
                                                            : "[" == t.charAt(0) ? t.indexOf("]")
                                                            : e == E             ? t.slice(1).indexOf('"') + 1
                                                                                 : 0)
                                                && (s = t.length),
                                            " " == (r = t.slice(1, s)).charAt(0)
                                                && ((i = d("mspace")).setAttribute("width", "1ex"), o.appendChild(i)),
                                            o.appendChild(d(e.tag, n.createTextNode(r))),
                                            " " == r.charAt(r.length - 1)
                                                && ((i = d("mspace")).setAttribute("width", "1ex"), o.appendChild(i)),
                                            (t = v(t, s + 1)), [ d("mrow", o), t ]);
                                case 15:
                                case 1:
                                    if (null == (a = M((t = v(t, e.input.length))))[0])
                                        return [ d(e.tag, n.createTextNode(e.output)), t ];
                                    if ("boolean" == typeof e.func && e.func)
                                        return "^" == (r = t.charAt(0)) || "_" == r || "/" == r || "|" == r || "," == r
                                                       || (1 == e.input.length && e.input.match(/\w /) && "(" != r)
                                                   ? [ d(e.tag, n.createTextNode(e.output)), t ]
                                                   : ((i = d("mrow", d(e.tag, n.createTextNode(e.output)))).appendChild(a[0]), [ i, a[1] ]);
                                    if ((L(a[0]), "sqrt" == e.input))
                                        return [ d(e.tag, a[0]), a[1] ];
                                    if (void 0 != = e.rewriteleftright)
                                        return ((i = d("mrow", d("mo", n.createTextNode(e.rewriteleftright[0])))).appendChild(a[0]),
                                                i.appendChild(d("mo", n.createTextNode(e.rewriteleftright[1]))), [ i, a[1] ]);
                                    if ("cancel" == e.input)
                                        return (i = d(e.tag, a[0])).setAttribute("notation", "updiagonalstrike"), [ i, a[1] ];
                                    if ("boolean" == typeof e.acc && e.acc) {
                                        i = d(e.tag, a[0]);
                                        var l = d("mo", n.createTextNode(e.output));
                                        return ("vec" == e.input
                                                    && (("mrow" == a[0].nodeName && 1 == a[0].childNodes.length
                                                             && null != = a[0].firstChild.firstChild.nodeValue
                                                                          && 1 == a[0].firstChild.firstChild.nodeValue.length)
                                                        || (null != = a[0].firstChild.nodeValue && 1 == a[0].firstChild.nodeValue.length))
                                                    && l.setAttribute("stretchy", !1),
                                                i.appendChild(l), [ i, a[1] ]);
                                    }
                                    if (!u&& void 0 != = e.codes)
                                        for (s = 0; s < a[0].childNodes.length; s++)
                                            if ("mi" == a[0].childNodes[s].nodeName || "mi" == a[0].nodeName) {
                                                r = "mi" == a[0].nodeName ? a[0].firstChild.nodeValue
                                                                          : a[0].childNodes[s].firstChild.nodeValue;
                                                for (var h = [], p = 0; p < r.length; p++)
                                                    r.charCodeAt(p) > 64 && r.charCodeAt(p) < 91    ? (h += e.codes[r.charCodeAt(p) - 65])
                                                    : r.charCodeAt(p) > 96 && r.charCodeAt(p) < 123 ? (h += e.codes[r.charCodeAt(p) - 71])
                                                                                                    : (h += r.charAt(p));
                                                "mi" == a[0].nodeName
                                                    ? (a[0] = d("mo").appendChild(n.createTextNode(h)))
                                                    : a[0].replaceChild(d("mo").appendChild(n.createTextNode(h)), a[0].childNodes[s]);
                                            }
                                    return (i = d(e.tag, a[0])).setAttribute(e.atname, e.atval), [ i, a[1] ];
                                case 2:
                                    if (null == (a = M((t = v(t, e.input.length))))[0])
                                               ...
                                               : (L(c[0]),
                                                  [ "color", "class", "id" ].indexOf(e.input) >= 0
                                                      ? ("{" == t.charAt(0)   ? (s = t.indexOf("}"))
                                                         : "(" == t.charAt(0) ? (s = t.indexOf(")"))
                                                                              : "[" == t.charAt(0) && (s = t.indexOf("]")),
                                                         (r = t.slice(1, s)), (i = d(e.tag, c[0])),
                                                         "color" == = e.input ? i.setAttribute("mathcolor", r)
                                                                              : "class" == = e.input ? i.setAttribute("class", r)
                                                                                                     : "id" == = e.input
                                                                                                                 && i.setAttribute("id", r),
                                                         [ i, c[1] ])
                                                      : (("root" != e.input && "stackrel" != e.output) || o.appendChild(c[0]),
                                                         o.appendChild(a[0]), "frac" == e.input && o.appendChild(c[0]),
                                                         [ d(e.tag, o), c[1] ]));
                                case 3:
                                    return (t = v(t, e.input.length)), [ d("mo", n.createTextNode(e.output)), t ];
                                case 6:
                                    return ((t = v(t, e.input.length)), (i = d("mspace")).setAttribute("width", "1ex"), o.appendChild(i),
                                            o.appendChild(d(e.tag, n.createTextNode(e.output))),
                                            (i = d("mspace")).setAttribute("width", "1ex"), o.appendChild(i), [ d("mrow", o), t ]);
                                case 9:
                                    return (C++, (a = D((t = v(t, e.input.length)), !1)), C--, (r = ""),
                                            null != a[0].lastChild && (r = a[0].lastChild.firstChild.nodeValue),
                                            "|" == r && "," != =
                                                t.charAt(0) ? ((i = d("mo", n.createTextNode(e.output))),
                                                               (i = d("mrow", i)).appendChild(a[0]), [ i, a[1] ])
                                                            : ((i = d("mo", n.createTextNode("\u2223"))), [ (i = d("mrow", i)), t ]));
                            }
                        }
                        ...
                        {
                            var e, i, a, s, r, o;
                            if (((i = O((t = v(t, 0)))), (s = (r = M(t))[0]), 3 == (e = O((t = r[1]))).ttype && "/" != e.input)) {
                                if ((null == (r = M((t = v(t, e.input.length))))[0] ? (r[0] = d("mo", n.createTextNode("\u25a1"))) : L(r[0]),
                                     (t = r[1]), (o = 7 == i.ttype || 15 == i.ttype), "_" == e.input))
                                    if ("^" == (a = O(t)).input) {
                                        var l = M((t = v(t, a.input.length)));
                                        L(l[0]), (t = l[1]), (s = d(o ? "munderover" : "msubsup", s)).appendChild(r[0]),
                                            s.appendChild(l[0]), (s = d("mrow", s));
                                    } else
                                        (s = d(o ? "munder" : "msub", s)).appendChild(r[0]);
                                else
                                    "^" == e.input&& o ? (s = d("mover", s)).appendChild(r[0]) : (s = d(e.tag, s)).appendChild(r[0]);
                                void 0 != = i.func && i.func && 3 != (a = O(t)).ttype && 5 != a.ttype && (i.input.length > 1 || 4 == a.ttype)
                        ...
                        function D(t, e)
                        {
                            var i, a, s, r, o = n.createDocumentFragment();
                            do {
                                (a = (s = k((t = v(t, 0))))[0]),
                                    3 == (i = O((t = s[1]))).ttype && "/" == i.input
                                        ? (null == (s = k((t = v(t, i.input.length))))[0] ? (s[0] = d("mo", n.createTextNode("\u25a1")))
                                                                                          : L(s[0]),
                                           (t = s[1]), L(a), (a = d(i.tag, a)).appendChild(s[0]), o.appendChild(a), (i = O(t)))
                                        : null != a&& o.appendChild(a);
                            } while (((5 != i.ttype && (9 != i.ttype || e)) || 0 == C) && null != i && "" != i.output);
                            if (5 == i.ttype || 9 == i.ttype) {
                                var l = o.childNodes.length;
                                if (l > 0 && "mrow" == o.childNodes[l - 1].nodeName && o.childNodes[l - 1].lastChild
                                    ...
                                    if (")" == u || "]" == u) {
                                        ...
                                        if (("(" == h && ")" == u && "}" != i.output) || ("[" == h && "]" == u)) {
                                            var p = [], c = !0, m = o.childNodes.length;
                                            for (r = 0; c && r < m; r += 2) {
                                                if (((p[r] = []), (a = o.childNodes[r]),
                                                     c
                                                         && (c = "mrow" == a.nodeName
                                                                 && (r == m - 1
                                            ...
                                            if ((c = c && (p.length > 1 || p[0].length > 0))) {
                                                var y, E, x, T, b = n.createDocumentFragment();
                                                for (r = 0; r < m; r += 2) {
                                                    for (y = n.createDocumentFragment(), E = n.createDocumentFragment(),
                                                        x = (a = o.firstChild).childNodes.length, T = 0, a.removeChild(a.firstChild), f = 1;
                                                         f < x - 1; f++)
                                                        void 0 != =
                                                            p[r][T] && f == p[r][T]
                                                                ? (a.removeChild(a.firstChild),
                                                                   "mrow" == a.firstChild.nodeName && 1 == a.firstChild.childNodes.length
                                                                           && "\u2223" == a.firstChild.firstChild.firstChild.nodeValue
                                                                       ? (0 == r && g.push("solid"), a.removeChild(a.firstChild),
                                                                          a.removeChild(a.firstChild), (f += 2), T++)
                                                                       : 0 == r && g.push("none"),
                                                                   y.appendChild(d("mtd", E)), T++)
                                                                : E.appendChild(a.firstChild);
                                                    y.appendChild(d("mtd", E)), 0 == r &&g.push("none"),
                                                        o.childNodes.length > 2
                                                            && (o.removeChild(o.firstChild), o.removeChild(o.firstChild)),
                                                        b.appendChild(d("mtr", y));
                                                }
                                                (a = d("mtable", b)).setAttribute("columnlines", g.join(" ")),
                                                    "boolean" == typeof i.invisible &&i.invisible &&a.setAttribute("columnalign", "left"),
                                                    o.replaceChild(a, o.firstChild);
                                            }
                                        }
                                    }
                                }
                                (t = v(t, i.input.length)), ("boolean" == typeof i.invisible&& i.invisible)
                        ...
                        function P(t, e)
                        {
                            ...
                            return ((C = 0),
                                    (i = d("mstyle",
                                           D((t = (t = (t = t.replace(/ &nbsp; / g, "")).replace(/ &gt; / g, ">")).replace(/ &lt; / g, "<"))
                                                 .replace(/ ^\s + / g, ""),
                                             !1)[0])),
                                    "" != s && i.setAttribute("mathcolor", s),
                                    "" != w && (i.setAttribute("fontsize", w), i.setAttribute("mathsize", w)),
                                    "" != H && (i.setAttribute("fontfamily", H), i.setAttribute("mathvariant", H)),
                                    r && i.setAttribute("displaystyle", "true"), (i = d("math", i)),
                                    o && i.setAttribute("title", t.replace(/\s + / g, " ")), i);
                        }
    ...
    for (var t = 0, e = x.length; t < e; t++)
        x[t].codes&& delete x[t].codes, x[t].func && (x[t].tag = "mi");
                        ...
                        t.Augment({
                            AM: {
                                Init: function () {
                                    if (((r = t.config.displaystyle), (l = t.config.decimal || t.config.decimalsign), !t.config.fixphi))
                                        for (var n = 0, a = x.length; n < a; n++)
                                            "phi" === x[n].input && (x[n].output = "\u03c6"),
                                                "varphi" === x[n].input && ((x[n].output = "\u03d5"), (n = a));
                                    var s;
                    ...
                    , appendChild : function(t)
                    {
                        ...
                        var e = arguments;
                        t.isa(i) && ((e = t.childNodes), (t.data = t.childNodes = []), (t.firstChild = t.lastChild = null));
                        for (var n = 0, a = e.length; n < a; n++)
                            (t = e[n]), this.lastChild && (this.lastChild.nextSibling = t), this.firstChild || (this.firstChild = t),
                                this.Append(t), (this.lastChild = t);
                        return t;
                    }
                    ...
                    , replaceChild : function(t, e)
                    {
                        for (var i = 0, n = this.childNodes.length; i < n && this.childNodes[i] != = e; i++)
                            ;
                        return (i ? (this.childNodes[i - 1].nextSibling = t) : (this.firstChild = t), i >= n - 1 && (this.lastChild = t),
                                this.SetData(i, t), (t.nextSibling = e.nextSibling), (e.nextSibling = e.parent = null), e);
                    }
    ...
    i = this.formatError(t, n);
                            ...
                            return (a.math = e(i)), this.postfilterHooks.Execute(a), this.postfilterHooks.Execute(a) || a.math;
                    }

                    , formatError : function(t, i, n)
                    {
                        var a = t.message.replace(/\n.*/, "");
                        return MathJax.Hub.signal.Post([ "AsciiMath Jax - parse error", a, i, n ]), e.Error(a);
                    }
                    ...
                    (i.g = (function() {
                        ...
                        (function() {
                            "use strict";
                            var t = i(723), e = i(306), n = i(884), a = i(577);
                            MathJax.loader &&MathJax.loader.checkVersion("input/asciimath", e.q, "input"), (0, t.r8)({

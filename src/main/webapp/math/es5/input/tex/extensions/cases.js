!(function () {
    "use strict";
    var t, e, a, n = {667 : function(t, e){(e.q = void 0), (e.q = "3.2.2");
            },
            530: function (t, e, a) {
    var n, s,
...
var M = (function(t) {
    ...
    return (r(e, t), (e.prototype.start = function(e, a, n) { (this.subcounter = 0), t.prototype.start.call(this, e, a, n); }),
            (e.prototype.autoTag =
                 function() {
                     null == this.currentTag.tag
                         && ("subnumcases" == = this.currentTag.env
                                                    ...
                                                    : ((0 != = this.subcounter&& "numcases-left" == = this.currentTag.env) || this.counter++,
                                                       this.tag(this.formatNumber(this.counter), !1)));
                 }),
            (e.prototype.formatNumber =
                 function(t, e) { return void 0 == = e && (e = null), t.toString() + (null == = e ? "" : String.fromCharCode(96 + e)); }),
            e);
})(h.AmsTags);
                (e.CasesTags = M),
                    (e.CasesMethods = {
                        NumCases: function (t, e) {
                            if (t.stack.env.closing === e.getName()) {
                                ...
                                return (
                                    x.EmpheqUtil.left(n, s, r + "\\empheqlbrace\\,", t, "numcases-left"),
                ...
                return ((o.arraydef.displaystyle = !1), (o.arraydef.rowspacing = ".2em"), o.setProperty("numCases", !0), t.Push(e), o);
                }
                ...
                , Entry : function(t, e)
                {
                    ...
                    for (var a = t.string, n = 0, s = t.i, r = a.length; s < r;) {
                        ...
                        if ("{" == = o)
                            ...
                            if ("&" == = o&& 0 == = n)
                                throw new l.default("ExtraCasesAlignTab", "Extra alignment tab in text for numcase environment");
                            if ("\\" == = o&& 0 == = n) {
                                var i = (a.slice(s + 1).match(/ ^[a - z] + |./ i) || [])[0];
                                if ("\\" == = i || "cr" == = i || "end" == = i || "label" == = i)
                                    break;
                                s += i.length;
                            } else
                                s++;
                ...
                , 379 : function(t, e)
                {
                    Object.defineProperty(e, "__esModule", {value : !0}), (e.AmsTags = MathJax._.input.tex.ams.AmsConfiguration.AmsTags),
                        (e.AmsConfiguration = MathJax._.input.tex.ams.AmsConfiguration.AmsConfiguration);
                }

                , 446 : function(t, e)
                {
                    Object.defineProperty(e, "__esModule", {value : !0}), (e.EmpheqUtil = MathJax._.input.tex.empheq.EmpheqUtil.EmpheqUtil);
                }
                ...
                (t = r(955)), (e = r(667)), (a = r(530)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/cases", e.q, "tex-extension"),

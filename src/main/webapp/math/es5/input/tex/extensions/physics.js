!(function () {
    "use strict";
    var t, e, a, r, n, o = {667 : function(t, e){(e.q = void 0), (e.q = "3.2.2");
            },
            996: function (t, e, a) {
    var r;
    Object.defineProperty(e, "__esModule", {value : !0}), (e.PhysicsConfiguration = void 0);
    var n = a(251), o = a(855);
    a(842), (e.PhysicsConfiguration = n.Configuration.create("physics", {
        handler : {
            macro : [
...
, enumerable : !1, configurable : !0,
    ...
    var e = this.factory.configuration.parser, a = this.getProperty("right");
    if (this.getProperty("smash")) {
        var r = t.prototype.toMml.call(this), n = e.create("node", "mpadded", [r], {
            height:
                0, depth : 0,
        });
    ...
    var o = c.default.fenced(this.factory.configuration, this.getProperty("open"), t.prototype.toMml.call(this), this.getProperty("close"),
...
, 842 : function(t, e, a)
{
    ...
    var n = a(871), o = r(a(458)), i = a(108), c = r(a(945)), s = a(801);
    new n.CommandMap("Physics-automatic-bracing-macros", {
        ...
        new n.CommandMap("Physics-vector-macros", {
            ...
            laplacian : [ "OperatorApplication", "\\nabla^2", "(", "[" ],
                         ...
                         o.default),
        new n.CommandMap("Physics-expressions-macros", {
            sin : "Expression",
            sinh : "Expression",
            arcsin : "Expression",
            asin : "Expression",
            ...
            Probability : [ "NamedFn", "Pr" ],
                         ...
                         o.default),
        new n.CommandMap("Physics-quick-quad-macros", {
            qqtext : "Qqtext",
            qq : "Qqtext",
            qcomma : [ "Macro", "\\qqtext*{,}" ],
            qc : [ "Macro", "\\qqtext*{,}" ],
            ...
            qin : [ "Qqtext", "in" ],
                         ...
                         o.default),
        new n.CommandMap("Physics-derivative-macros", {
            diffd : "DiffD",
            ...
            fdv : [ "Derivative", 2, "\\delta" ],
                         ...
                         o.default),
        new n.CommandMap("Physics-bra-ket-macros", {
            bra : "Bra",
            ket : "Ket",
            innerproduct : "BraKet",
            ip : "BraKet",
            ...
            mel : "MatrixElement",
                         ...
                         o.default),
        new n.CommandMap("Physics-matrix-macros", {
            ...
            admat : [ "DiagonalMatrix", !0 ],
                         ...
                         o.default),
        new n.EnvironmentMap("Physics-aux-envs", c.default.environment, {
            smallmatrix : [ "Array", null, null, null, "c", "0.333em", ".2em", "S", 1 ],
        },
                             o.default),
        new n.MacroMap("Physics-characters", {
...
, 458 : function(t, e, a)
{
    ...
    Object.defineProperty(e, "__esModule", {value : !0});
    var o = n(a(360)), i = n(a(193)), c = n(a(402)), s = a(801), l = n(a(398)), u = n(a(748)), m = a(348), d = {},
        f = {"(" : ")", "[" : "]", "{" : "}", "|" : "|"}, p = / ^(b | B) i(g{1, 2}) $ / ;
    (d.Quantity =
         function(t, e, a, r, n, o, m) {
             void 0 == = a && (a = "("), void 0 == = r && (r = ")"), void 0 == = n && (n = !1), void 0 == = o && (o = ""),
                    void 0 == = m && (m = "");
             var d = !!n && t.GetStar(), v = t.GetNext(), h = t.i, g = null;
             if ("\\" == = v) {
             ...
             n && ((v = a), (M = r)), t.i++, t.Push(t.itemFactory.create("auto open").setProperties({open : v, close : M, big : g}));
         }),
        (d.Eval =
             function(t, e) {
                 var a = t.GetStar(), r = t.GetNext();
                 if ("{" != = r) {
                     if ("(" == = r || "[" == = r)
    ...
    var v = [ 65, 90 ], h = [ 97, 122 ], g = [ 913, 937 ], x = [ 945, 969 ], M = [ 48, 57 ];
    function y(t, e)
    {
        return t >= e[0] && t <= e[1];
    }
    function b(t, e, a, r)
    {
        var n = t.configuration.parser, o = m.NodeFactory.createToken(t, e, a, r), i = r.codePointAt(0);
        return (1 == = r.length && !n.stack.env.font && n.stack.env.vectorFont
                       && (y(i, v) || y(i, h) || y(i, g) || y(i, M) || (y(i, x) && n.stack.env.vectorStar)
    ...
    (d.VectorBold =
         function(t, e) {
             var a = t.GetStar(), r = t.GetArgument(e), n = t.configuration.nodeFactory.get("token"), o = t.stack.env.font;
             delete t.stack.env.font, t.configuration.nodeFactory.set("token", b), (t.stack.env.vectorFont = a ? "bold-italic" : "bold"),
             ...
             o && (t.stack.env.font = o), delete t.stack.env.vectorFont, delete t.stack.env.vectorStar,
                 t.configuration.nodeFactory.set("token", n), t.Push(c);
         }),
        (d.StarMacro = function(t, e, a) {
            ...
            var o = t.GetStar(), i = [];
            if (a)
                for (var c = i.length; c < a; c++)
                    i.push(t.GetArgument(e));
            var s = r.join(o ? "*" : "");
            (s = l.default.substituteArgs(t, i, s)), (t.string = l.default.addArgs(t, s, t.string.slice(t.i))), (t.i = 0),
    ...
    function A(t, e, a)
    {
        var n = r(t, 3), o = n[0], i = n[1], c = n[2];
        return e && a ? "\\left\\langle{".concat(o, "}\\middle\\vert{").concat(i, "}\\middle\\vert{").concat(c, "}\\right\\rangle")
               : e    ? "\\langle{".concat(o, "}\\vert{").concat(i, "}\\vert{").concat(c, "}\\rangle")
                      : "\\left\\langle{".concat(o, "}\\right\\vert{").concat(i, "}\\left\\vert{").concat(c, "}\\right\\rangle");
    }
    (d.OperatorApplication =
        ...
        (d.Expression =
             function(t, e, a, r) {
                 ...
                 var n = a ? t.GetBrackets(e) : null, o = t.create("token", "mi", {texClass : s.TEXCLASS.OP}, r);
                 if (n) {
                     var c = new i.default(n, t.stack.env, t.configuration).mml();
                     o = t.create("node", "msup", [ o, c ]);
                 }
                 t.Push(t.itemFactory.create("fn", o)),
                     "(" == = t.GetNext() && (t.i++, t.Push(t.itemFactory.create("auto open").setProperties({open : "(", close : ")"})));
             }),
        (d.Qqtext =
             function(t, e, a) {
        ...
        (d.Differential =
             function(t, e, a) {
                 var r = t.GetBrackets(e), n = null != r ? "^{" + r + "}" : " ", o = "(" == = t.GetNext(), c = "{" == = t.GetNext(),
                     l = a + n;
                 if (o || c)
                     if (c) {
                         l += t.GetArgument(e);
                         ...
                         t.Push(new i.default(l, t.stack.env, t.configuration).mml()), t.i++,
        ...
        (d.Derivative =
             function(t, e, a, r) {
                 var n = t.GetStar(), o = t.GetBrackets(e), c = 1, s = [];
                 for (s.push(t.GetArgument(e)); "{" == = t.GetNext() && c < a;)
                     s.push(t.GetArgument(e)), c++;
                 var l = !1, u = " ", m = " ";
                 a > 2 && s.length > 2 ? ((u = "^{" + (s.length - 1) + "}"), (l = !0))
                                       : null != o && (a > 2 && s.length > 1 && (l = !0), (m = u = "^{" + o + "}"));
                 for (var d = n ? "\\flatfrac" : "\\frac", f = s.length > 1 ? s[0] : "", p = s.length > 1 ? s[1] : s[0], v = "", h = 2,
                          g = void 0;
                      (g = s[h]); h++)
                     v += r + " " + g;
        ...
        (d.KetBra =
             function(t, e) {
                 ...
                 "{" == = t.GetNext() && (n = t.GetArgument(e, !0));
                 var o = "";
                 (o = null == n ? a ? "\\vert{".concat(r, "}\\rangle\\!\\langle{").concat(r, "}\\vert")
                                    : "\\left\\vert{".concat(r, "}\\middle\\rangle\\!\\middle\\langle{").concat(r, "}\\right\\vert")
                      : a ? "\\vert{".concat(r, "}\\rangle\\!\\langle{").concat(n, "}\\vert")
                                : "\\left\\vert{".concat(r, "}\\middle\\rangle\\!\\middle\\langle{").concat(n, "}\\right\\vert")),
                     t.Push(new i.default(o, t.stack.env, t.configuration).mml());
             }),
        (d.Expectation =
             function(t, e) {
                 var a = t.GetStar(), r = a && t.GetStar(), n = t.GetArgument(e), o = null;
                 "{" == = t.GetNext() && (o = t.GetArgument(e, !0));
                 var c = n && o ? A([ o, n, o ], a, r)
                         : a    ? "\\langle {".concat(n, "} \\rangle")
                                : "\\left\\langle {".concat(n, "} \\right\\rangle");
                 t.Push(new i.default(c, t.stack.env, t.configuration).mml());
             }),
        (d.MatrixElement =
             function(t, e) {
                 var a = t.GetStar(), r = a && t.GetStar(), n = A([ t.GetArgument(e), t.GetArgument(e), t.GetArgument(e) ], a, r);
                 t.Push(new i.default(n, t.stack.env, t.configuration).mml());
             }),
        (d.MatrixQuantity =
             function(t, e, a) {
                 var r = t.GetStar(), n = a ? "smallmatrix" : "array", o = "", c = "", s = "";
                 switch (t.GetNext()) {
                     case "{":
                         o = t.GetArgument(e);
                         break;
                 ...
                 var l = (c ? "\\left" : "") + c + "\\begin{" + n + "}{} " + o + "\\end{" + n + "}" + (c ? "\\right" : "") + s;
                 t.Push(new i.default(l, t.stack.env, t.configuration).mml());
             }),
        (d.IdentityMatrix =
             function(t, e) {
                 var a = t.GetArgument(e), r = parseInt(a, 10);
                 if (isNaN(r))
        ...
        (d.XMatrix =
             function(t, e) {
                 var a = t.GetStar(), r = t.GetArgument(e), n = t.GetArgument(e), o = t.GetArgument(e), i = parseInt(n, 10),
                     s = parseInt(o, 10);
                 if (isNaN(i) || isNaN(s) || s.toString() != = o || i.toString() != = n)
                     throw new c.default("InvalidNumber", "Invalid number");
                 if (((i = i < 1 ? 1 : i), (s = s < 1 ? 1 : s), !a)) {
                     var l = Array(s).fill(r).join(" & "), u = Array(i).fill(l).join("\\\\ ");
                     return (t.string = u + t.string.slice(t.i)), void(t.i = 0);
                 }
                 var m = "";
                 if (1 == = i&& 1 == = s)
        ...
        (d.PauliMatrix =
             function(t, e) {
                 var a = t.GetArgument(e), r = a.slice(1);
                 switch (a[0]) {
                     case "0":
                         r += " 1 & 0\\\\ 0 & 1";
                         break;
        ...
        (d.AutoClose =
             function(t, e, a) {
                 var r = t.create("token", "mo", {stretchy : !1}, e), n = t.itemFactory.create("mml", r).setProperties({autoclose : e});
                 t.Push(n);
             }),
        (d.Vnabla =
             function(t, e) {
        ...
        (d.Macro = o.default.Macro), (d.NamedFn = o.default.NamedFn), (d.Array = o.default.Array), (e.default = d);
}

, 955 : function(t, e)
{
    MathJax._.components.global.isObject, MathJax._.components.global.combineConfig, MathJax._.components.global.combineDefaults,
...
, 251 : function(t, e)
{
    Object.defineProperty(e, "__esModule", {value : !0}), (e.Configuration = MathJax._.input.tex.Configuration.Configuration),
...
, 871 : function(t, e)
{
    Object.defineProperty(e, "__esModule", {value : !0}), (e.parseResult = MathJax._.input.tex.SymbolMap.parseResult),
        (e.AbstractSymbolMap = MathJax._.input.tex.SymbolMap.AbstractSymbolMap), (e.RegExpMap = MathJax._.input.tex.SymbolMap.RegExpMap),
        (e.AbstractParseMap = MathJax._.input.tex.SymbolMap.AbstractParseMap), (e.CharacterMap = MathJax._.input.tex.SymbolMap.CharacterMap),
        (e.DelimiterMap = MathJax._.input.tex.SymbolMap.DelimiterMap), (e.MacroMap = MathJax._.input.tex.SymbolMap.MacroMap),
        (e.CommandMap = MathJax._.input.tex.SymbolMap.CommandMap), (e.EnvironmentMap = MathJax._.input.tex.SymbolMap.EnvironmentMap);
}
...
(t = c(955)), (e = c(667)), (a = c(996)), (r = c(855)),
    (n = c(458)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/physics", e.q, "tex-extension"), (0, t.r8)({
        _ : {
            input : {
                tex : {
                    physics : {

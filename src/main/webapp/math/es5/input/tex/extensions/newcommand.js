!(function () {
    ...
    e.default = t;
                    ...
                    o =
                        ...
                        function (e)
                            ...
                            var l = n(251), f = n(205), c = u(n(406));
                            n(297);
                            var s = u(n(945)), d = o(n(871));
                t.NewcommandConfiguration = l.Configuration.create("newcommand", {
                    ...
                    init: function (e) {
                        new d.DelimiterMap(c.default.NEW_DELIMITER, s.default.delimiter, {}),
                            ...
                            new d.EnvironmentMap(c.default.NEW_ENVIRONMENT, s.default.environment, {}, {}),
                            e.append(
    ...
    return e.prototype.checkItem.call(this, t);
                ...
                , 297 : function(e, t, n)
                {
                    ...
                    var r = a(n(107));
                    new (n(871).CommandMap)("Newcommand-macros", {
    ...
    e.default = t;
                    ...
                    i =
                        ...
                        function (e)
                            ...
                            Object.defineProperty(t, "__esModule", {value : !0});
                            var u = o(n(402)), l = i(n(871)), f = o(n(360)), c = o(n(398)), s = o(n(406)),
                                d = {NewCommand : function(e, t){var n = s.default.GetCsNameArgument(e, t), a = s.default.GetArgCount(e, t),
                                                                 r = e.GetBrackets(t), i = e.GetArgument(t);
                            s.default.addMacro(e, n, d.Macro, [ i, a, r ]);
                            }

                            , NewEnvironment : function(e, t)
                            {
                                var n = c.default.trimSpaces(e.GetArgument(t)), a = s.default.GetArgCount(e, t), r = e.GetBrackets(t),
                                    i = e.GetArgument(t), o = e.GetArgument(t);
                                s.default.addEnvironment(e, n, d.BeginEnv, [ !0, i, o, a, r ]);
                            }

                            , MacroDef : function(e, t)
                            {
                                var n = s.default.GetCSname(e, t), a = s.default.GetTemplate(e, t, "\\" + n), r = e.GetArgument(t);
                                a
                                    instanceof Array ? s.default.addMacro(e, n, d.MacroWithTemplate, [r].concat(a))
                                                     : s.default.addMacro(e, n, d.Macro, [ r, a ]);
                            }

                            , Let : function(e, t)
                            {
                                var n = s.default.GetCSname(e, t), a = e.GetNext();
                                "=" == = a && (e.i++, (a = e.GetNext()));
                                var r = e.configuration.handlers;
                                if ("\\" != = a) {
                                    e.i++;
                                    var i = r.get("delimiter").lookup(a);
                                    i ? s.default.addDelimiter(e, "\\" + n, i.char, i.attributes) : s.default.addMacro(e, n, d.Macro, [a]);
                                } else {
                                    t = s.default.GetCSname(e, t);
                                    var o = r.get("delimiter").lookup("\\" + t);
                                    if (o)
                                        return void s.default.addDelimiter(e, "\\" + n, o.char, o.attributes);
                            ...
                            , MacroWithTemplate : function(e, t, n, a)
                            {
                                ...
                                if (o) {
                                    ...
                                    if ((e.GetNext(), r[0] && !s.default.MatchParam(e, r[0])))
                                        throw new u.default("MismatchUseDef", "Use of %1 doesn't match its definition", t);
                                    for (var f = 0; f < o; f++)
                                        l.push(s.default.GetParameter(e, t, r[f + 1]));
                                    n = c.default.substituteArgs(e, l, n);
                                }
                                (e.string = c.default.addArgs(e, n, e.string.slice(e.i))), (e.i = 0), c.default.checkMaxMacros(e);
                            }
                            ...
                            , BeginEnv : function(e, t, n, a, r, i)
                            {
                                if (t.getProperty("end")&& e.stack.env.closing == = t.getName()) {
                                    ...
                                    return ((e.string = a), (e.i = 0), e.Parse(), (e.string = o), (e.i = 0),
                                ...
                                if (r) {
                                    ...
                                    (n = c.default.substituteArgs(e, u, n)), (a = c.default.substituteArgs(e, [], a));
                                }
                                return ((e.string = c.default.addArgs(e, n, e.string.slice(e.i))), (e.i = 0),
                            ...
                            , 406 : function(e, t, n)
                            {
                                ...
                                Object.defineProperty(t, "__esModule", {value : !0});
                                var r, i = a(n(398)), o = a(n(402)), u = n(924);
                                !(function(e) {
                                    function t(e, t)
                                    {
                                        return e.string.substr(e.i, t.length) != =
                                                   t || (t.match(/\\[a - z] + $ / i) && e.string.charAt(e.i + t.length).match(/ [a - z] / i))
                                                       ? 0
                                                       : ((e.i += t.length), 1);
                                    }
                                    (e.disassembleSymbol =
                                         function(e, t) {
                                             ...
                                             if (t.attributes)
                                                 for (var a in t.attributes)
                                                     n.push(a), n.push(t.attributes[a]);
                                             return n;
                                         }),
                                        (e.assembleSymbol =
                                             function(e) {
                                        ...
                                        (e.GetCsNameArgument =
                                             function(e, t) {
                                                 ...
                                                 if (("\\" == = n.charAt(0) && (n = n.substr(1)), !n.match(/ ^(.| [a - z] +) $ / i)))
                                                     throw new o.default("IllegalControlSequenceName",
                                                                         "Illegal control sequence name for %1", t);
                                                 return n;
                                             }),
                                        (e.GetArgCount =
                                             function(e, t) {
                                                 ...
                                                 if (n && !(n = i.default.trimSpaces(n)).match(/ ^[0 - 9] + $ /))
                                                     throw new o.default("IllegalParamNumber",
                                                                         "Illegal number of parameters specified in %1", t);
                                                 return n;
                                             }),
                                        (e.GetTemplate =
                                             function(e, t, n) {
                                                 for (var a = e.GetNext(), r = [], i = 0, u = e.i; e.i < e.string.length;) {
                                                     if ("#" == = (a = e.GetNext())) {
                                                         if ((u != = e.i && (r[i] = e.string.substr(u, e.i - u)),
                                                              !(a = e.string.charAt(++e.i)).match(/ ^[1 - 9] $ /)))
                                                             throw new o.default("CantUseHash2", "Illegal use of # in template for %1", n);
                                                         if (parseInt(a) != = ++i)
                                                             throw new o.default("SequentialParam",
                                                                                 "Parameters for %1 must be numbered sequentially", n);
                                                         u = e.i + 1;
                                                     } else if ("{" == = a)
                                                         return u != = e.i && (r[i] = e.string.substr(u, e.i - u)),
                                                                  r.length > 0 ? [i.toString()].concat(r) : i;
                                                     e.i++;
                                                 }
                                                 throw new o.default("MissingReplacementString",
                                                                     "Missing replacement string for definition of %1", t);
                                             }),
                                        (e.GetParameter =
                                             function(e, n, a) {
                                                 if (null == a)
                                                     return e.GetArgument(n);
                                        ...
                                        (e.addDelimiter =
                                             function(t, n, a, r) {
                                                 t.configuration.handlers.retrieve(e.NEW_DELIMITER).add(n, new u.Symbol(n, a, r));
                                             }),
                                        (e.addMacro =
                                             function(t, n, a, r, i) {
                                                 void 0 == = i && (i = ""),
                                                        t.configuration.handlers.retrieve(e.NEW_COMMAND).add(n, new u.Macro(i || n, a, r));
                                             }),
                                        (e.addEnvironment =
                                             function(t, n, a, r) {
                                                 t.configuration.handlers.retrieve(e.NEW_ENVIRONMENT).add(n, new u.Macro(n, a, r));
                                             }),
                                        (e.NEW_DELIMITER = "new-Delimiter"), (e.NEW_COMMAND = "new-Command"),
                            ...
                            , 924 : function(e, t)
                            {
                                Object.defineProperty(t, "__esModule", {value : !0}), (t.Symbol = MathJax._.input.tex.Symbol.Symbol),
                            ...
                            (e = l(955)), (t = l(667)), (n = l(48)), (a = l(205)), (r = l(107)),
                                (i = l(406)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/newcommand", t.q, "tex-extension"),
                                (0, e.r8)({
                                    _ : {
                                        input : {
                                            tex : {

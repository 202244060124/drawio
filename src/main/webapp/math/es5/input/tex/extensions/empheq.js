!(function () {
    "use strict";
    var e, t, a, n, r = {667 : function(e, t){(t.q = void 0), (t.q = "3.2.2");
            },
            79: function (e, t, a) {
    var n, r,
    ...
    return (t.isKind("end") && t.getName() == = this.getName() && this.setProperty("end", !1), e.prototype.checkItem.call(this, t));
                    ...
                    (t.EmpheqMethods = {
                        Empheq: function (e, t) {
                            if (e.stack.env.closing === t.getName()) {
                                ...
                                var a = e.stack.Top();
                                c.EmpheqUtil.adjustTable(a, e), e.Push(e.itemFactory.create("end").setProperty("name", "empheq"));
                }
                else
                {
                    h.default.checkEqnEnv(e), delete e.stack.global.eqnenv;
                    var n = e.GetBrackets("\\begin{" + t.getName() + "}") || "",
                        r = o((e.GetArgument("\\begin{" + t.getName() + "}") || "").split(/= /), 2), i = r[0], l = r[1];
                    if (!c.EmpheqUtil.checkEnv(i))
                        throw new s.default("UnknownEnv", 'Unknown environment "%1"', i);
                    n &&t.setProperties(c.EmpheqUtil.splitOptions(n, {left : 1, right : 1})), (e.stack.global.empheq = i),
                        (e.string = "\\begin{" + i + "}" + (l ? "{" + l + "}" : "") + e.string.slice(e.i)), (e.i = 0), e.Push(t);
                }
                }
                ...
                ,
                    ...
                    new m.EnvironmentMap("empheq-env", c.EmpheqUtil.environment, { empheq: ["Empheq", "empheq"] }, t.EmpheqMethods),
                    new m.CommandMap(
                        "empheq-macros",
                        {
                ...
                , 301 : function(e, t, a)
                {
                    ...
                    , r = (this && this.__spreadArray) || function(e, t, a)
                    {
                    ...
                    {
                        var t = "function" == typeof Symbol && Symbol.iterator, a = t && e[t], n = 0;
                        if (a)
                            return a.call(e);
                ...
                var l = o(a(398)), p = o(a(193));
                t.EmpheqUtil = {
                    environment :
                        function(e, t, a, i){var o = i[0], l = e.itemFactory.create(o + "-begin").setProperties({name : t, end : o});
                ...
                , columnCount : function(e)
                {
                    ...
                    try {
                        for (var r = i(e.childNodes), o = r.next(); !o.done; o = r.next()) {
                            var l = o.value, p = l.childNodes.length - (l.isKind("mlabeledtr") ? 1 : 0);
                            p > n && (n = p);
                        }
                    } catch (e) {
                        t = {error : e};
                ...
                , cellBlock : function(e, t, a, n)
                {
                    var r, o,
                        ...
                        m = new p.default(e, a.stack.env, a.configuration), h = m.mml();
                    n&& m.configuration.tags.label && ((m.configuration.tags.currentTag.env = n), m.configuration.tags.getTag(!0));
                    try {
                        for (var s = i(h.isInferred ? h.childNodes : [h]), u = s.next(); !u.done; u = s.next()) {
                            var c = u.value;
                            l.appendChild(c);
                        }
                    } catch (e) {
                    ...
                    return l.appendChild(a.create("node", "mphantom",
                                                  [a.create("node", "mpadded", [t],
                                                            {
                                                                width:
                                                                    0
                                                            })])),
                ...
                , topRowTable : function(e, t)
                {
                    ...
                    return (a.setChildren(a.childNodes.slice(0, 1)), a.attributes.set("align", "baseline 1"),
                            e.factory.create("mphantom", {}, [t.create("node", "mpadded", [a], {
                                                 width:
                                                     0
                                             })]));
                }
                ...
                {
                    e.appendChild(n.create("node", "mpadded", [this.cellBlock(t, l.default.copyNode(a, n), n, r), this.topRowTable(a, n)], {
                        height:
                ...
                {
                    var o, l, p;
                    void 0 == = r && (r = ""), e.attributes.set("columnalign", "right " + (e.attributes.get("columnalign") || "")),
                           e.attributes.set("columnspacing", "0em " + (e.attributes.get("columnspacing") || ""));
                    try {
                        for (var m = i(e.childNodes.slice(0).reverse()), h = m.next(); !h.done; h = m.next()) {
                            var s = h.value;
                            (p = n.create("node", "mtd")), s.childNodes.unshift(p), (p.parent = s),
                                s.isKind("mlabeledtr") && ((s.childNodes[0] = s.childNodes[1]), (s.childNodes[1] = p));
                        }
                    } catch (e) {
                        o = {error : e};
                    } finally {
                ...
                {
                    void 0 == = i && (i = ""), 0 == = e.childNodes.length && e.appendChild(r.create("node", "mtr"));
                    for (var o = t.EmpheqUtil.columnCount(e), l = e.childNodes[0]; l.childNodes.length < o;)
                        l.appendChild(r.create("node", "mtd"));
                    var p = l.appendChild(r.create("node", "mtd"));
                    t.EmpheqUtil.rowspanCell(p, n, a, r, i),
                        e.attributes.set("columnalign", (e.attributes.get("columnalign") || "").split(/ /).slice(0, o).join(" ") + " left"),
                        e.attributes.set("columnspacing",
                                         (e.attributes.get("columnspacing") || "").split(/ /).slice(0, o - 1).join(" ") + " 0em");
                }

                , adjustTable : function(e, t)
                {
                    var a = e.getProperty("left"), n = e.getProperty("right");
                    if (a || n) {
                        var r = e.Last, i = l.default.copyNode(r, t);
                ...
                , 871 : function(e, t)
                {
                    Object.defineProperty(t, "__esModule", {value : !0}), (t.parseResult = MathJax._.input.tex.SymbolMap.parseResult),
                        ...
                        (t.MacroMap = MathJax._.input.tex.SymbolMap.MacroMap), (t.CommandMap = MathJax._.input.tex.SymbolMap.CommandMap),
                ...
                , 935 : function(e, t)
                {
                    Object.defineProperty(t, "__esModule", {value : !0}), (t.StartItem = MathJax._.input.tex.base.BaseItems.StartItem),
                        ...
                        (t.LeftItem = MathJax._.input.tex.base.BaseItems.LeftItem), (t.Middle = MathJax._.input.tex.base.BaseItems.Middle),
                        ...
                        (t.CellItem = MathJax._.input.tex.base.BaseItems.CellItem), (t.MmlItem = MathJax._.input.tex.base.BaseItems.MmlItem),
                        (t.FnItem = MathJax._.input.tex.base.BaseItems.FnItem), (t.NotItem = MathJax._.input.tex.base.BaseItems.NotItem),
                ...
                (e = o(955)), (t = o(667)), (a = o(79)),
                    (n = o(301)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/empheq", t.q, "tex-extension"), (0, e.r8)({
                        _ : {

!(function () {
    ...
    function t()
    {
        ...
        return (t.leftLabel = null), (t.rigthLabel = null), (t.innerStack = new d.default(t.factory, {}, !0)), t;
    }
                        return (
                            n(t, e),
    ...
    if (e.isKind("end")&& "prooftree" == = e.getName()) {
        var t = this.toMml();
        return c.setProperty(t, "proof", !0), [ [ this.factory.create("mml", t), e ], !0 ];
    }
    if (e.isKind("stop"))
    ...
    var t = e.prototype.toMml.call(this), r = this.innerStack.Top();
    ...
    return this.create("node", "mrow", [o, t], {});
                ...
                , 116 : function(e, t, r)
                {
                    ...
                    var n = o(r(827)), a = o(r(945)), i = r(871);
    ...
    e.default = t;
                    ...
                    a =
                        ...
                        function (e)
                            ...
                            Object.defineProperty(t, "__esModule", {value : !0});
                            var f = u(r(402)), s = u(r(193)), d = u(r(398)), c = a(r(378)),
                                p = {Prooftree : function(e, t){return (e.Push(t), e.itemFactory.create("proofTree").setProperties({
                                    name : t.getName(),
                                    line : "solid",
                                    currentLine : "solid",
                                    rootAtTop : !1,
                            ...
                            , Axiom : function(e, t)
                            {
                                var r = e.stack.Top();
                                if ("proofTree" != = r.kind)
                                    throw new f.default("IllegalProofCommand", "Proof commands only allowed in prooftree environment.");
                            ...
                            , m = function(e, t)
                            {
                                ...
                                var o = e.create("node", "mspace", [],
                                                 {
                                                     width:
                                                         ".5ex"
                                                 }),
                                    n = e.create("node", "mspace", [], {
                                        width:
                                            ".5ex"
                                    });
                            ...
                            function h(e, t, r, o, n, a, i)
                            {
                                ...
                                return (m = e.create("node", "mrow", f)), c.setProperty(m, "labelledRule", s), m;
                            }

                            function y(e, t)
                            {
                                if ("$" != = e.GetNext())
                                    throw new f.default("IllegalUseOfCommand", "Use of %1 does not match it's definition.", t);
                                e.i++;
                                var r = e.GetUpTo(t, "$");
                                if (-1 == = r.indexOf("\\fCenter"))
                                    throw new f.default("IllegalUseOfCommand", "Missing \\fCenter in %1.", t);
                                var o = i(r.split("\\fCenter"), 2), n = o[0], a = o[1],
                                    l = new s.default(n, e.stack.env, e.configuration).mml(),
                                    u = new s.default(a, e.stack.env, e.configuration).mml(),
                                    d = new s.default("\\fCenter", e.stack.env, e.configuration).mml(), p = e.create("node", "mtd", [l], {}),
                                    m = e.create("node", "mtd", [d], {}), h = e.create("node", "mtd", [u], {}),
                                    y = e.create("node", "mtr", [p, m, h], {}), v = e.create("node", "mtable", [y], {
                                        columnspacing:
                                            ".5ex", columnalign : "center 2",
                                    });
                                return c.setProperty(v, "sequent", !0), e.configuration.addNode("sequent", y), v;
                            }
                            ...
                            (p.Inference =
                                 function(e, t, r) {
                                     ...
                                     var n = o.getProperty("rootAtTop"), a = 1 != = r || o.Peek()[0].childNodes.length ? r : 0, i = [];
                                     do {
                                         i.length &&i.unshift(e.create("node", "mtd", [], {})),
                                             i.unshift(e.create("node", "mtd", [o.Pop()],
                                                                {
                                                                    rowalign:
                                                                        n ? "top" : "bottom",
                                                                })),
                                     ...
                                     var l = e.create("node", "mtr", i, {}),
                                         u = e.create("node", "mtable", [l],
                                                      {
                                                          framespacing:
                                                              "0 0"
                                                      }),
                                         s = m(e, e.GetArgument(t)), d = o.getProperty("currentLine");
                                     d != = o.getProperty("line") && o.setProperty("currentLine", o.getProperty("line"));
                                     var p = h(e, u, [s], o.getProperty("left"), o.getProperty("right"), d, n);
                                     o.setProperty("left", null), o.setProperty("right", null), c.setProperty(p, "inference", a),
                                         e.configuration.addNode("inference", p), o.Push(p);
                                 }),
                                (p.Label =
                                     function(e, t, r) {
                                         var o = e.stack.Top();
                                ...
                                (p.InferenceF =
                                     function(e, t, r) {
                                         ...
                                         var l = e.create("node", "mtr", i, {}),
                                             ...
                                             s = y(e, t), d = o.getProperty("currentLine");
                                         d != = o.getProperty("line") && o.setProperty("currentLine", o.getProperty("line"));
                                         var p = h(e, u, [s], o.getProperty("left"), o.getProperty("right"), d, n);
                                         o.setProperty("left", null), o.setProperty("right", null), c.setProperty(p, "inference", a),
                                             e.configuration.addNode("inference", p), o.Push(p);
                            ...
                            , 378 : function(e, t, r)
                            {
                                var o, n = (this && this.__read) || function(e, t)
                                {
                                    var r = "function" == typeof Symbol && e[Symbol.iterator];
                                    if (!r)
                                        return e;
                                ...
                                , a = (this && this.__values) || function(e)
                                {
                                    ...
                                    if (e && "number" == typeof e.length)
                                        return {
                                            next : function(){return e && o >= e.length && (e = void 0), {value : e && e[o++], done : !e};
                                }
                                ,
                            };
                            ...
                            Object.defineProperty(t, "__esModule", {value : !0}),
                                (t.clearDocument = t.saveDocument = t.makeBsprAttributes = t.removeProperty = t.getProperty =
                                     t.setProperty = t.balanceRules = void 0);
                            var l = i(r(748)), u = i(r(398)), f = null, s = null, d = function(e)
                            {
                            ...
                            , c = function(e)
                            {
                                for (var t = 0; e && !l.default.isType(e, "mtable");) {
                                    if (l.default.isType(e, "text"))
                                        return null;
                                    l.default.isType(e, "mrow") ? ((e = e.childNodes[0]), (t = 0)) : ((e = e.parent.childNodes[t]), t++);
                                }
                                return e;
                            }
                            , p = function(e, t)
                            {
                                return e.childNodes["up" == = t ? 1 : 0].childNodes[0].childNodes[0].childNodes[0].childNodes[0];
                            }
                            , m = function(e, t)
                            {
                            ...
                            , _ = function(e, t, r)
                            {
                                ...
                                if (e == = t)
                                    return o;
                                if (e != = t.parent) {
                                    var n = e.childNodes, a = r ? n.length - 1 : 0;
                                    l.default.isType(n[a], "mspace") && (o += d(n[a])), (e = t.parent);
                                }
                                if (e == = t)
                                    return o;
                                var i = e.childNodes, u = r ? i.length - 1 : 0;
                                return i[u] != = t && (o += d(i[u])), o;
                            }
                            , x = function(e, r)
                            {
                                void 0 == = r && (r = !1);
                                var o = c(e), n = v(o, (0, t.getProperty)(o, "inferenceRule"));
                                return _(e, o, r) + (d(o) - d(n)) / 2;
                            }
                            , M = function(e, r, o, n)
                            {
                                if ((void 0 == = n && (n = !1),
                                     (0, t.getProperty)(r, "inferenceRule") || (0, t.getProperty)(r, "labelledRule"))) {
                                    var a = e.nodeFactory.create("node", "mrow");
                                    r.parent.replaceChild(a, r), a.setChildren([r]), w(r, a), (r = a);
                                }
                                var i = n ? r.childNodes.length - 1 : 0, f = r.childNodes[i];
                                l.default.isType(f, "mspace")
                                    ? l.default.setAttribute(f, "width",
                                                             u.default.Em(u.default.dimen2em(l.default.getAttribute(f, "width")) + o))
                            ...
                            , C = function(e, r, o, n, a)
                            {
                                ...
                                if ("left" == = n) {
                                    ...
                                    r.childNodes[o].appendChild(i);
                                (0, t.setProperty)(r.parent, "sequentAdjust_" + n, a);
                            }
                            , T = function(e, r)
                            {
                                for (var o = r.pop(); r.length;) {
                                    var a = r.pop(), i = n(I(o, a), 2), l = i[0], u = i[1];
                                    (0, t.getProperty)(o.parent, "axiom")
                                        && (C(e, l < 0 ? o : a, 0, "left", Math.abs(l)), C(e, u < 0 ? o : a, 2, "right", Math.abs(u))),
                                        (o = a);
                                }
                            }
                            , I = function(e, t)
                            {
                                var r = d(e.childNodes[2]), o = d(t.childNodes[2]);
                            ...
                            t.balanceRules = function(e)
                            {
                                        ...
                                        for (var o = r.length - 1, n = void 0; (n = r[o]); o--)
                                            if ((0, t.getProperty)(n, "sequentProcessed"))
                                                ...
                                                if (1 == = (0, t.getProperty)(i, "inference")) {
                                                    for (a.push(n); 1 == = (0, t.getProperty)(i, "inference");) {
                                                        i = c(i);
                                ...
                                try {
                                    for (var l = a(i), u = l.next(); !u.done; u = l.next()) {
                                        var f = u.value, d = (0, t.getProperty)(f, "proof"), m = c(f),
                                            w = p(m, (0, t.getProperty)(m, "inferenceRule")), C = h(w);
                                        ...
                                        if (null != (0, t.getProperty)(S, "inference")) {
                                            var N = x(S, !0);
                                            M(n, S, -N, !0);
                                            var j = _(f, m, !0), O = (0, t.getProperty)(f, "maxAdjust");
                            ...
                            var A = "bspr_", S = (((o = {}).bspr_maxAdjust = !0), o);
                            ...
                            t.makeBsprAttributes = function(e)
                            {
                                e.data.root.walkTree(function(e, t) {
                                    var r = [];
                                    e.getPropertyNames().forEach(
                                        function(t) { !S[t] && t.match(RegExp("^bspr_")) && r.push(t + ":" + e.getProperty(t)); }),
                            ...
                            , 748 : function(e, t)
                            {
                                Object.defineProperty(t, "__esModule", {value : !0}), (t.default = MathJax._.input.tex.NodeUtil.default);
                            }

                            , 945 : function(e, t)
                            {
                                Object.defineProperty(t, "__esModule", {value : !0}), (t.default = MathJax._.input.tex.ParseMethods.default);
                            }

                            , 398 : function(e, t)
                            {
                                Object.defineProperty(t, "__esModule", {value : !0}), (t.default = MathJax._.input.tex.ParseUtil.default);
                            }

                            , 935 : function(e, t)
                            {
                                Object.defineProperty(t, "__esModule", {value : !0}), (t.default = MathJax._.input.tex.Stack.default);
                            }

                            , 76 : function(e, t)
                            {
                                Object.defineProperty(t, "__esModule", {value : !0}), (t.MmlStack = MathJax._.input.tex.StackItem.MmlStack),
                            ...
                            , 402 : function(e, t)
                            {
                                Object.defineProperty(t, "__esModule", {value : !0}), (t.default = MathJax._.input.tex.TexError.default);
                            }

                            , 193 : function(e, t)
                            {
                                Object.defineProperty(t, "__esModule", {value : !0}), (t.default = MathJax._.input.tex.TexParser.default);
                            }
                            ...
                            (e = u(955)), (t = u(667)), (r = u(333)), (o = u(854)), (n = u(827)),
                                (a = u(378)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/bussproofs", t.q, "tex-extension"),
                                (0, e.r8)({
                                    _ : {
                                        input : {
                                            tex : {

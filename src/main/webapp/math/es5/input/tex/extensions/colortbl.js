!(function () {
        ...
        n = (this && this.__extends)
            || ((o =
                ...
                function(t, e) {
                    ...
                    o(t, e), (t.prototype = null == = e ? Object.create(e) : ((a.prototype = e.prototype), new a()));
                }),
    ...
    var i = a(935), s = a(251), l = a(871), p = r(a(402)),
        u = (function(t) {
            function e()
            {
                    ...
                    (e.prototype.EndEntry =
                         function() {
                             ...
                             var e = this.row[this.row.length - 1],
                                 a = this.color.cell || this.color.row || this.color.col[this.row.length - 1];
                             a && (e.attributes.set("mathbackground", a), (this.color.cell = ""), (this.hasColor = !0));
                         }),
                    (e.prototype.EndRow = function() { t.prototype.EndRow.call(this), (this.color.row = ""); }),
                    (e.prototype.createMml =
                         function() {
                             var e = t.prototype.createMml.call(this), a = e.isKind("mrow") ? e.childNodes[1] : e;
                             return (a.isKind("menclose") && (a = a.childNodes[0].childNodes[0]),
                                     this.hasColor && "none" == = a.attributes.get("frame") && a.attributes.set("frame", ""), e);
                         }),
                    e);
        })(i.ArrayItem);
                (e.ColorArrayItem = u),
                        ...
                        },
                        {
                            TableColor: function (t, e, a) {
                                var o = t.configuration.packageData.get("color").model,
                                    ...
                                    i = t.stack.Top();
                                if (!(i instanceof u)) throw new p.default("UnsupportedTableColor", "Unsupported use of %1", t.currentCS);
                                if ("col" === a) {
        if (i.table.length)
            throw new p.default("ColumnColorNotTop", "%1 must be in the top row", e);
        (i.color.col[i.row.length] = r), t.GetBrackets(e, "") && t.GetBrackets(e, "");
                                } else if (((i.color[a] = r), "row" === a && (i.Size() || i.row.length)))
                                    throw new p.default("RowColorNotFirst", "%1 must be at the beginning of a row", e);
                            },
}
                    );
                    ...
                    (t = r(955)), (e = r(667)),
                        (a = r(558)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/colortbl", e.q, "tex-extension"), (0, t.r8)({
                            _ : {input : {tex : {colortbl : {ColortblConfiguration : a}}}},
                        });
                    })();

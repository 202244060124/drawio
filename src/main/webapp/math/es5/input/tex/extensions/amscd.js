                        ...
                        function (e)
                            {
                                ...
                                if (null != e)
                                    for (var a in e)
                                        "default" != = a && Object.prototype.hasOwnProperty.call(e, a) && r(t, e, a);
                                return o(t, e), t;
                            }
                            ...
                            var l = n(a(871)), c = i(a(945)), s = i(a(834));
                            new l.EnvironmentMap("amscd_environment", c.default.environment, {CD : "CD"}, s.default),
                                new l.CommandMap("amscd_macros", {
                            ...
                            , 834 : function(e, t, a)
                            {
                                ...
                                Object.defineProperty(t, "__esModule", {value : !0});
                                var o = r(a(193)), n = a(379), i = a(801), l = r(a(748)), c = {CD : function(e, t){e.Push(t);
                                var a = e.itemFactory.create("array"), r = e.configuration.options.amscd;
                            ...
                            , arrow : function(e, t)
                            {
                                ...
                                if (!a.match(/ [ > < VA.|= ] /))
                                    return (0, n.Other)(e, t);
                                e.i++;
                                var r = e.stack.Top();
                                (r.isKind("array") && !r.Size()) || (c.cell(e, t), (r = e.stack.Top()));
                                for (var s, u = r, d = u.table.length % 2 == 1, m = (u.row.length + (d ? 0 : 1)) % 2; m;)
                                    c.cell(e, t), m--;
                                var p = {minsize : u.getProperty("minw"), stretchy : !0}, M = {
                                ...
                                if ("." == = a)
                                    ...
                                    s = e.create("token", "mo", M, "\u2225");
                                else if ("=" == = a)
                                    s = e.create("token", "mo", p, "=");
                                else {
                                    var f = {
                                        ">" : "\u2192",
                                        "<" : "\u2190",
                                        ...
                                        h = e.GetUpTo(t + a, a), _ = e.GetUpTo(t + a, a);
                                    if (">" == = a || "<" == = a) {
                                        if (((s = e.create("token", "mo", p, f)), h || (h = "\\kern " + u.getProperty("minw")), h || _)) {
                                            var x = {width : "+.67em", lspace : ".33em"};
                                            if (((s = e.create("node", "munderover", [s])), h)) {
                                                var b = new o.default(h, e.stack.env, e.configuration).mml(),
                                                    v = e.create("node", "mpadded", [b], x);
                                                l.default.setAttribute(v, "voffset", ".1em"), l.default.setChild(s, s.over, v);
                                            }
                                            if (_) {
                                                var g = new o.default(_, e.stack.env, e.configuration).mml();
                                                l.default.setChild(s, s.under, e.create("node", "mpadded", [g], x));
                                            }
                                            e.configuration.options.amscd.hideHorizontalLabels && (s = e.create("node", "mpadded", s, {
                                                depth : 0,
                                                height : ".67em",
                                            }));
                                        }
                                                ...
                                                && ((s = e.create("node", "mrow")),
                                                    h
                                                        && l.default.appendChildren(s,
                                                                                    [
                                                                                        new o
                                                                                            .default("\\scriptstyle\\llap{" + h + "}",
                                                                                                     e.stack.env, e.configuration)
                                                                                            .mml(),
                                                                                    ]),
                                                    (C.texClass = i.TEXCLASS.ORD), l.default.appendChildren(s, [C]),
                                                    _ && l.default.appendChildren(s, [
                                                        new o.default("\\scriptstyle\\rlap{" + _ + "}", e.stack.env, e.configuration).mml(),
                                                    ]));
                                    }
                                }
                            ...
                            {
                                var a = e.stack.Top();
                                (a.table || []).length % 2 == 0 && 0
                                    == = (a.row || []).length
                                         && e.Push(e.create("node", "mpadded", [],
                                                            {
                                                                height:
                                                                    "8.5pt", depth : "2pt",
                                                            })),
                            ...
                            , 801 : function(e, t)
                            {
                                Object.defineProperty(t, "__esModule", {value : !0}), (t.TEXCLASS = MathJax._.core.MmlTree.MmlNode.TEXCLASS),
                            ...
                            (e = i(955)), (t = i(667)), (a = i(769)),
                                (r = i(834)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/amscd", t.q, "tex-extension"), (0, e.r8)({
                                    _ : {
                                        input : {tex : {amscd : {AmsCdConfiguration : a, AmsCdMethods : r}}},
                                    },
                                });
                            })();

!(function () {
    "use strict";
    var t, e, a, r, n, i = {667 : function(t, e){(e.q = void 0), (e.q = "3.2.2");
            },
            577: function (t, e, a) {
    var r, n,
    ...
    var l = a(251), o = a(971), s = a(680), u = a(16);
    a(829);
    var m = a(871), d = (function(t) {
                        function e()
                        {
...
, 971 : function(t, e, a)
{
    ...
    if (1 != = this.row.length)
        throw new m.default("MultlineRowsOneCol", "The rows within the %1 environment must have exactly one column", "multline");
    ...
    if ((t.prototype.EndTable.call(this), this.table.length)) {
        var e = this.table.length - 1, a = -1;
        u.default.getAttribute(u.default.getChildren(this.table[0])[0], "columnalign")
            || u.default.setAttribute(u.default.getChildren(this.table[0])[0], "columnalign", d.TexConstant.Align.LEFT),
            u.default.getAttribute(u.default.getChildren(this.table[e])[0], "columnalign")
                || u.default.setAttribute(u.default.getChildren(this.table[e])[0], "columnalign", d.TexConstant.Align.RIGHT);
        var r = this.factory.configuration.tags.getTag();
        if (r) {
            a = this.arraydef.side == = d.TexConstant.Align.LEFT ? 0 : this.table.length - 1;
            var n = this.table[a], i = this.create("node", "mlabeledtr", [r].concat(u.default.getChildren(n)));
...
e.MultlineItem = c;
    ...
    function e(e, a, r, n, i)
    {
        ...
        return ((l.name = a), (l.numbered = r), (l.padded = n), (l.center = i), l.factory.configuration.tags.start(a, r, r), l);
    }
                    return (
                        n(e, t),
                        Object.defineProperty(e.prototype, "kind", {
    ...
    if (e && this.row.length > e)
        throw new m.default("XalignOverflow", "Extra %1 in row of %2", "&", this.name);
                        }),
                        (e.prototype.EndRow = function () {
    for (var e, a = this.row, r = this.getProperty("xalignat"); a.length < r;)
        a.push(this.create("node", "mtd"));
    for (this.row = [], this.padded && this.row.push(this.create("node", "mtd")); (e = a.shift());)
        this.row.push(e), (e = a.shift()) && this.row.push(e), (a.length || this.padded) && this.row.push(this.create("node", "mtd"));
    ...
    if (this.getProperty("zeroWidthLabel") && n.isKind("mlabeledtr")) {
        var l = u.default.getChildren(n)[0], o = this.factory.configuration.options.tagSide,
            s = i({width : 0}, "right" == = o ? {lspace : "-1width"} : {}), m = this.create("node", "mpadded", u.default.getChildren(l), s);
        l.setChildren([m]);
    }
                        }),
                        (e.prototype.EndTable = function () {
                        ...
                        function (t)
                            {
                                ...
                                if (null != t)
                                    for (var a in t)
                                        "default" != = a && Object.prototype.hasOwnProperty.call(t, a) && r(e, t, a);
                                return n(e, t), e;
                            }
                            , l = (this && this.__importDefault) || function(t)
                            {
                            ...
                            var o = a(16), s = i(a(871)), u = a(108), m = l(a(945)), d = l(a(398)), c = a(801), h = a(230);
                            new s.CharacterMap("AMSmath-mathchar0mo", m.default.mathchar0mo, {
                                ...
                                new s.CommandMap("AMSmath-macros", {
                                    ...
                                    xleftarrow : [ "xArrow", 8592, 10, 5 ],
                                                 ...
                                                 o.AmsMethods),
                                new s.EnvironmentMap("AMSmath-environment", m.default.environment, {
                                    "equation*" : [ "Equation", null, !1 ],
                                    "eqnarray*" :
                                        [ "EqnArray", null, !1, !0, "rcl", d.default.cols(0, h.MATHSPACE.thickmathspace), ".5em" ],
                            ...
                            , 16 : function(t, e, a)
                            {
                                ...
                                var l = i(a(398)), o = i(a(945)), s = i(a(748)), u = a(108), m = i(a(193)), d = i(a(402)), c = a(924),
                                    h = i(a(360)), p = a(801);
                                function f(t)
                                {
                                ...
                                (e.AmsMethods = {}),
                                    ...
                                    (e.AmsMethods.AlignAt =
                                         function(t, a, r, n) {
                                             var i, o, s = a.getName(), u = "", m = [];
                                             if ((n || (o = t.GetBrackets("\\begin{" + s + "}")),
                                             ...
                                             var h = m.join(" ");
                                             if (n)
                                                 return e.AmsMethods.EqnArray(t, a, r, n, u, h);
                                    ...
                                    (e.AmsMethods.XalignAt =
                                         function(t, a, r, n) {
                                             ...
                                             if (i.match(/ [^0 - 9] /))
                                                 throw new d.default("PositiveIntegerArg", "Argument to %1 must me a positive integer",
                                                                     "\\begin{" + a.getName() + "}");
                                             var l = n ? "crl" : "rlc", o = n ? "fit auto auto" : "auto auto fit",
                                                 s = e.AmsMethods.FlalignArray(t, a, r, n, !1, l, o, !0);
                                             return s.setProperty("xalignat", 2 * parseInt(i)), s;
                                         }),
                                    (e.AmsMethods.FlalignArray =
                                         function(t, e, a, r, n, i, o, s) {
                                             void 0 == = s && (s = !1), t.Push(e), l.default.checkEqnEnv(t),
                                                    (i = i.split("")
                                                             .join(" ")
                                                             .replace(/ r / g, "right")
                                                             .replace(/ l / g, "left")
                                             ...
                                             return ((u.arraydef = {
                                                     ...
                                                     u.setProperty("zeroWidthLabel", s), u);
                                         }),
                                    (e.NEW_OPS = "ams-declare-ops"),
                                    (e.AmsMethods.HandleDeclareOp =
                                         function(t, a) {
                                             var r = t.GetStar() ? "*" : "", n = l.default.trimSpaces(t.GetArgument(a));
                                             "\\" == = n.charAt(0) && (n = n.substr(1));
                                             var i = t.GetArgument(a);
                                             t.configuration.handlers.retrieve(e.NEW_OPS)
                                                 .add(n,
                                                      new c.Macro(n, e.AmsMethods.Macro, ["\\operatorname".concat(r, "{").concat(i, "}")]));
                                         }),
                                    (e.AmsMethods.HandleOperatorName =
                                         function(t, e) {
                                             var a = t.GetStar(), n = l.default.trimSpaces(t.GetArgument(e)),
                                                 i = new m
                                                         .default(n, r(r({}, t.stack.env), {
                                                                  ...
                                                                  t.configuration)
                                                         .mml();
                                             if ((i.isKind("mi") || (i = t.create("node", "TeXAtom", [i])), s.default.setProperties(i, {
                                                     movesupsub : a,
                                                     movablelimits : !0,
                                                     texClass : p.TEXCLASS.OP,
                                                 }),
                                                  !a)) {
                                                 var o = t.GetNext(), d = t.i;
                                    ...
                                    (e.AmsMethods.SideSet =
                                         function(t, e) {
                                             var a = n(f(t.ParseArg(e)), 2), r = a[0], i = a[1], o = n(f(t.ParseArg(e)), 2), u = o[0],
                                                 m = o[1], d = t.ParseArg(e), c = d;
                                             r
                                                 && (i ? r.replaceChild(t.create("node", "mphantom",
                                                                                 [
                                                       ...
                                                       : ((c = t.create("node", "mmultiscripts", [d])),
                                                          u
                                                              && s.default.appendChildren(c,
                                                                                          [
                                                                                              s.default.getChildAt(u, 1)
                                                                                                  || t.create("node", "none"),
                                                                                              s.default.getChildAt(u, 2)
                                                                                                  || t.create("node", "none"),
                                                                                          ]),
                                                 ...
                                                 u&& c == = d && (u.replaceChild(d, s.default.getChildAt(u, 0)), (c = u));
                                             var h = t.create("node", "TeXAtom", [], {
                                                 texClass:
                                                     p.TEXCLASS.OP, movesupsub : !0, movablelimits : !0,
                                             });
                                             i && (r && h.appendChild(r), h.appendChild(i)), h.appendChild(c), m &&h.appendChild(m),
                                                 t.Push(h);
                                         }),
                                    (e.AmsMethods.operatorLetter =
                                         function(t, e) { return !!t.stack.env.operatorLetters && o.default.variable(t, e); }),
                                    (e.AmsMethods.MultiIntegral =
                                         function(t, e, a) {
                                             var r = t.GetNext();
                                             if ("\\" == = r) {
                                                 var n = t.i;
                                                 (r = t.GetArgument(e)), (t.i = n),
                                                     "\\limits" == = r
                                                                     && (a = "\\idotsint" == = e ? "\\!\\!\\mathop{\\,\\," + a + "}"
                                                                                                 : "\\!\\!\\!\\mathop{\\,\\,\\," + a + "}");
                                             }
                                    ...
                                    (e.AmsMethods.xArrow =
                                         function(t, e, a, r, n) {
                                             var i = {
                                                 ...
                                                 o = t.GetBrackets(e), u = t.ParseArg(e),
                                                 d = t.create("node", "mspace", [],
                                                              {
                                                                  depth:
                                                                      ".25em"
                                                              }),
                                                 c = t.create("token", "mo", {stretchy : !0, texClass : p.TEXCLASS.REL},
                                                              String.fromCodePoint(a));
                                             c = t.create("node", "mstyle", [c], {
                                                 scriptlevel:
                                                     0
                                             });
                                             var h = t.create("node", "munderover", [c]), f = t.create("node", "mpadded", [ u, d ], i);
                                             if ((s.default.setAttribute(f, "voffset", "-.2em"),
                                                  s.default.setAttribute(f, "height", "-.2em"), s.default.setChild(h, h.over, f), o)) {
                                                 var g = new m.default(o, t.stack.env, t.configuration).mml(),
                                                     M = t.create("node", "mspace", [], {
                                                         height:
                                                             ".75em"
                                                     });
                                                 (f = t.create("node", "mpadded", [ g, M ], i)),
                                                     s.default.setAttribute(f, "voffset", ".15em"),
                                                     s.default.setAttribute(f, "depth", "-.15em"), s.default.setChild(h, h.under, f);
                                             }
                                    ...
                                    (e.AmsMethods.CFrac =
                                         function(t, e) {
                                             var a = l.default.trimSpaces(t.GetBrackets(e, "")), r = t.GetArgument(e), n = t.GetArgument(e),
                                                 i = {
                                                     l : u.TexConstant.Align.LEFT,
                                                     r : u.TexConstant.Align.RIGHT,
                                                     "" : "",
                                                 },
                                                 o = new m.default("\\strut\\textstyle{" + r + "}", t.stack.env, t.configuration).mml(),
                                                 c = new m.default("\\strut\\textstyle{" + n + "}", t.stack.env, t.configuration).mml(),
                                    ...
                                    (e.AmsMethods.Genfrac =
                                         function(t, e, a, r, n, i) {
                                             null == a && (a = t.GetDelimiterArg(e)), null == r && (r = t.GetDelimiterArg(e)),
                                                 null == n && (n = t.GetArgument(e)),
                                                 null == i && (i = l.default.trimSpaces(t.GetArgument(e)));
                                             var o = t.ParseArg(e), u = t.ParseArg(e), m = t.create("node", "mfrac", [ o, u ]);
                                             if (("" != = n && s.default.setAttribute(m, "linethickness", n),
                                                  (a || r)
                                                      && (s.default.setProperty(m, "withDelims", !0),
                                                          (m = l.default.fixedFence(t.configuration, a, m, r))),
                                                  "" != = i)) {
                                                 var c = parseInt(i, 10), h = [ "D", "T", "S", "SS" ][c];
                                                 if (null == h)
                                                     throw new d.default("BadMathStyleFor", "Bad math style for %1", t.currentCS);
                                                 (m = t.create("node", "mstyle", [m])), "D" == = h ? s.default.setProperties(m, {
                                                     displaystyle : !0,
                                                     scriptlevel : 0,
                                                 })
                                    ...
                                    (e.AmsMethods.HandleTag =
                                         function(t, e) {
                                             ...
                                             var a = t.GetStar(), r = l.default.trimSpaces(t.GetArgument(e));
                                             t.tags.tag(r, a);
                                         }),
                            ...
                            , 680 : function(t, e)
                            {
                                Object.defineProperty(e, "__esModule", {value : !0}), (e.Label = MathJax._.input.tex.Tags.Label),
                                    ...
                                    (e.AbstractTags = MathJax._.input.tex.Tags.AbstractTags), (e.NoTags = MathJax._.input.tex.Tags.NoTags),
                                    (e.AllTags = MathJax._.input.tex.Tags.AllTags), (e.TagsFactory = MathJax._.input.tex.Tags.TagsFactory);
                            }
                            ...
                            (t = o(955)), (e = o(667)), (a = o(577)), (r = o(971)),
                                (n = o(16)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/ams", e.q, "tex-extension"), (0, t.r8)({
                                    _ : {
                                        input : {

!(function () {
    "use strict";
    var t, e, a, r, o, n, l, i = {667 : function(t, e){(e.q = void 0), (e.q = "3.2.2");
            },
            205: function (t, e, a) {
    var r, o = (this && this.__values) || function(t)
    {
        var e = "function" == typeof Symbol && Symbol.iterator, a = e && t[e], r = 0;
        if (a)
            return a.call(t);
...
var l = a(251), i = a(871), s = n(a(748)), u = a(74);
a(926);
var c = a(262), d = a(298), m = a(144);

function h(t)
{
    var e, a, r, n, l, i, u = t.data;
    try {
        for (var c = o(u.getList("mmultiscripts")), d = c.next(); !d.done; d = c.next()) {
            var m = d.value;
            if (m.getProperty("fixPrescript")) {
                var h = s.default.getChildren(m), p = 0;
                try {
                    for (var f = ((r = void 0), o([ 1, 2 ])), M = f.next(); !M.done; M = f.next()) {
                        h[(v = M.value)] || (s.default.setChild(m, v, u.nodeFactory.create("node", "none")), p++);
                    }
                } catch (t) {
                    r = {error : t};
                } finally {
                ...
                try {
                    for (var x = ((l = void 0), o([ 4, 5 ])), g = x.next(); !g.done; g = x.next()) {
                        var v = g.value;
                        s.default.isType(h[v], "mrow")&& 0 == = s.default.getChildren(h[v]).length
                                                                && s.default.setChild(m, v, u.nodeFactory.create("node", "none"));
                    }
                } catch (t) {
                    l = {error : t};
                } finally {
        ...
        try {
            ...
            if (e)
                ...
                , config : function(t, e)
                {
                    var a, r, n = e.parseOptions, l = n.options.mathtools.pairedDelimiters;
                    try {
                        for (var i = o(Object.keys(l)), s = i.next(); !s.done; s = i.next()) {
                            var u = s.value;
    ...
    if (((this.Size() || this.row.length) && (this.EndEntry(), this.EndRow()), this.table.length > 1)) {
        var e = this.factory.configuration.options.mathtools, a = e.multlinegap, r = e["firstline-afterskip"] || a,
            o = e["lastline-preskip"] || a, n = i.default.getChildren(this.table[0])[0];
        i.default.getAttribute(n, "columnalign") != = s.TexConstant.Align.RIGHT && n.appendChild(this.create("node", "mspace", [], {
            width:
                r
        }));
    ...
    t.prototype.EndTable.call(this);
                ...
                , 926 : function(t, e, a)
                {
                    ...
                    var o = r(a(945)), n = a(871), l = a(108), i = a(178);
                    new n.CommandMap("mathtools-macros", {
                        ...
                        mathtoolsset : "SetOptions",
                                     ...
                                     i.MathtoolsMethods),
                        new n.EnvironmentMap("mathtools-environments", o.default.environment, {
                        ...
                        new n.CommandMap("mathtools-characters", {":" : [ "CenterColon", !0 ]}, i.MathtoolsMethods);
                }
                ...
                var i = l(a(398)), s = a(939), u = l(a(360)), c = l(a(193)), d = l(a(402)), m = l(a(748)), h = a(801), p = a(230),
                    f = a(74), M = l(a(892)), x = l(a(432)), g = a(262);
                e.MathtoolsMethods = {MtMatrix : function(t, a, r, o){var n = t.GetBrackets("\\begin{".concat(a.getName(), "}"), "c");
                return e.MathtoolsMethods.Array(t, a, r, o, n);
                }

                , MtSmallMatrix : function(t, a, r, o, n)
                {
                    return (n || (n = t.GetBrackets("\\begin{".concat(a.getName(), "}"), t.options.mathtools["smallmatrix-align"])),
                            e.MathtoolsMethods.Array(t, a, r, o, n, i.default.Em(1 / 3), ".2em", "S", 1));
                }

                , MtMultlined : function(t, e)
                {
                    var a, r = "\\begin{".concat(e.getName(), "}"), n = t.GetBrackets(r, t.options.mathtools["multlined-pos"] || "c"),
                           l = n ? t.GetBrackets(r, "") : "";
                    n && !n.match(/ ^[cbt] $ /) && ((l = (a = o([ n, l ], 2))[0]), (n = a[1])), t.Push(e);
                ...
                , HandleShove : function(t, e, a)
                {
                    ...
                    var o = t.GetBrackets(e), n = t.ParseArg(e);
                    if (o) {
                        var l = t.create("node", "mrow", []), i = t.create("node", "mspace", [], {
                            width:
                                o
                        });
                        "left" == = a ? (l.appendChild(i), l.appendChild(n)) : (l.appendChild(n), l.appendChild(i)), (n = l);
                    }
                    t.Push(n);
                }
                ...
                , SpreadLines : function(t, e)
                {
                    ...
                    if (t.stack.env.closing == = e.getName()) {
                        ...
                        var o = t.stack.Pop(), l = o.toMml(), i = o.getProperty("spread");
                        if (l.isInferred)
                            try {
                                for (var s = n(m.default.getChildren(l)), u = s.next(); !u.done; u = s.next()) {
                                    var c = u.value;
                            ...
                            g.MathtoolsUtil.spreadLines(l, i);
                        t.Push(l);
                    } else {
                ...
                , Cases : function(t, e, a, r, o)
                {
                    ...
                    return ((n.arraydef = {
                            ...
                            "D" == = o && (n.arraydef.displaystyle = !0), n.setProperties({open : a, close : r}), t.Push(e), n);
                }
                            ...
                            l = t.create(
                                ...
                                [
                                    t.create(
                                        ...
                                        "mpadded",
                                        [t.ParseArg(e)],
                                        r({ width: 0 }, "r" === a ? {} : { lspace: "l" === a ? "-1width" : "-.5width" })
                                    ),
                                ],
                                { "data-cramped": o }
                            );
                    g.MathtoolsUtil.setDisplayLevel(l, n), t.Push(t.create("node", "TeXAtom", [l]));
                }

                , Cramped : function(t, e)
                {
                    var a = t.GetBrackets(e, "").trim(), r = t.ParseArg(e), o = t.create("node", "mstyle", [r], { "data-cramped" : !0 });
                    g.MathtoolsUtil.setDisplayLevel(o, a), t.Push(o);
                }

                , MtLap : function(t, e, a)
                {
                    var r = i.default.internalMath(t, t.GetArgument(e), 0), o = t.create("node", "mpadded", r, {width : 0});
                    "r" != = a && m.default.setAttribute(o, "lspace", "l" == = a ? "-1width" : "-.5width"), t.Push(o);
                }

                , MathMakeBox : function(t, e)
                {
                    var a = t.GetBrackets(e), r = t.GetBrackets(e, "c"), o = t.create("node", "mpadded", [t.ParseArg(e)]);
                ...
                {
                    var a = (0, p.length2em)(t.GetBrackets(e, ".1em"), 0.1), r = t.GetBrackets(e, ".2em"), n = t.GetArgument(e),
                        l = o("o" == = e.charAt(1) ? [ "over", "accent", "bottom" ] : [ "under", "accentunder", "top" ], 3), s = l[0],
                        u = l[1], d = l[2], h = (0, p.em)(a), f = new c.default(n, t.stack.env, t.configuration).mml(),
                        M = new c.default(n, t.stack.env, t.configuration).mml(),
                        x = t.create("node", "mpadded", [t.create("node", "mphantom", [M])],
                                     {
                                         style:
                                             "border: ".concat(h, " solid; border-").concat(d, ": none"), height : r, depth : 0,
                                     }),
                        g = i.default.underOver(t, f, x, s, !0), v = m.default.getChildAt(m.default.getChildAt(g, 0), 0);
                ...
                , Aboxed : function(t, e)
                {
                    ...
                    var r = t.GetArgument(e), o = t.string.substr(t.i);
                    (t.string = r + "&&\\endAboxed"), (t.i = 0);
                    var n = t.GetUpTo(e, "&"), l = t.GetUpTo(e, "&");
                    t.GetUpTo(e, "\\endAboxed");
                    var s = i.default.substituteArgs(t, [ n, l ],
                ...
                , ArrowBetweenLines : function(t, e)
                {
                    ...
                    var r = t.GetStar(), o = t.GetBrackets(e, "\\Updownarrow");
                    r && (a.EndEntry(), a.EndEntry());
                    var n = r ? "\\quad" + o : o + "\\quad", l = new c.default(n, t.stack.env, t.configuration).mml();
                            ...
                            i = t.create(
                                ...
                                [
                                    t.create(
                                        ...
                                        r({ width: 0, lspace: "-.5width" }, o ? { height: "-.6em", voffset: "-.18em" } : {})
                                    ),
                ...
                {
                    var r = t.stack.Top(), o = t.GetStar();
                    e.MathtoolsMethods.FlushSpaceAbove(t, "\\MTFlushSpaceAbove"), !o && r.EndEntry(),
                        e.MathtoolsMethods.VDotsWithin(t, "\\vdotswithin"), o && r.EndEntry(),
                ...
                {
                    var a = g.MathtoolsUtil.checkAlignment(t, e);
                    a.setProperty("flushspaceabove", a.table.length), a.addRowSpacing("-" + t.options.mathtools.shortvdotsadjustabove);
                }

                , FlushSpaceBelow : function(t, e)
                {
                    var a = g.MathtoolsUtil.checkAlignment(t, e);
                    a.Size() && a.EndEntry(), a.EndRow(), a.addRowSpacing("-" + t.options.mathtools.shortvdotsadjustbelow);
                }

                , PairedDelimiters : function(t, e, a, r, n, l, s, u)
                {
                    void 0 == = n && (n = "#1"), void 0 == = l && (l = 1), void 0 == = s && (s = ""), void 0 == = u && (u = "");
                    var c = t.GetStar(), d = c ? "" : t.GetBrackets(e),
                        m = o(c   ? [ "\\left", "\\right" ]
                              : d ? [ d + "l", d + "r" ]
                                  : [ "", "" ],
                              2),
                        h = m[0], p = m[1], f = c ? "\\middle" : d || "";
                    if (l) {
                        for (var M = [], x = M.length; x < l; x++)
                            M.push(t.GetArgument(e));
                        (s = i.default.substituteArgs(t, M, s)), (n = i.default.substituteArgs(t, M, n)),
                            (u = i.default.substituteArgs(t, M, u));
                    }
                    (n = n.replace(/\\delimsize / g, f)),
                        (t.string = [ s, h, a, n, p, r, u, t.string.substr(t.i) ].reduce(
                             function(e, a) { return i.default.addArgs(t, e, a); }, "")),
                        (t.i = 0), i.default.checkMaxMacros(t);
                }

                , DeclarePairedDelimiter : function(t, e)
                {
                    var a = M.default.GetCsNameArgument(t, e), r = t.GetArgument(e), o = t.GetArgument(e);
                    g.MathtoolsUtil.addPairedDelims(t.configuration, a, [ r, o ]);
                }

                , DeclarePairedDelimiterX : function(t, e)
                {
                    var a = M.default.GetCsNameArgument(t, e), r = M.default.GetArgCount(t, e), o = t.GetArgument(e), n = t.GetArgument(e),
                        l = t.GetArgument(e);
                ...
                {
                    var a = M.default.GetCsNameArgument(t, e), r = M.default.GetArgCount(t, e), o = t.GetArgument(e), n = t.GetArgument(e),
                        l = t.GetArgument(e), i = t.GetArgument(e), s = t.GetArgument(e);
                ...
                , CenterColon : function(t, e, a, o, n)
                {
                    ...
                    var l = t.options.mathtools, i = t.create("token", "mo", {}, ":");
                    if (a && (l.centercolon || o)) {
                        var s = l["centercolon-offset"];
                        i = t.create("node", "mpadded", [i],
                                     r({voffset : s, height : "+".concat(s), depth : "-".concat(s)},
                                       n ? {width : l["thincolon-dw"], lspace : l["thincolon-dx"]} : {}));
                    }
                    t.Push(i);
                }
                ...
                {
                    t.options.mathtools["use-unicode"] && r ? t.Push(t.create("token", "mo", {texClass : h.TEXCLASS.REL}, r))
                                                            : ((a = "\\mathrel{"
                                                                    + a.replace(/
                                                                                : / g, "\\MTThinColon")
                                                                          .replace(/ - / g, "\\mathrel{-}")
                                                                    + "}"),
                                                               (t.string = i.default.addArgs(t, a, t.string.substr(t.i))), (t.i = 0));
                }
                                ...
                                [
                                    ...
                                    t.create(
                                        ...
                                        [
                                            ...
                                            t.create("node", "mphantom", [t.create("token", "mtext", {}, a)]),
                                        ],
                ...
                {
                    var r = t.ParseArg(e), o = t.ParseArg(e);
                    t.Push(
                            t.create(
                                "node",
                                "mstyle",
                                    ...
                                    t.create(
                                        ...
                                        [
                                            t.create(
                                                "node",
                                                "mstyle",
                                                [r, t.create("token", "mi"), t.create("token", "mspace", { width: "1em" })],
                                                { scriptlevel: 0 }
                                            ),
                                            t.create(
                                                "node",
                ...
                {
                    var a = t.GetBrackets(e), r = t.GetArgument(e);
                ...
                {
                    var a = g.MathtoolsUtil.getScript(t, e, "sup"), r = g.MathtoolsUtil.getScript(t, e, "sub"),
                        o = g.MathtoolsUtil.getScript(t, e, "arg");
                    if (m.default.isType(a, "none") && m.default.isType(r, "none"))
                        t.Push(o);
                    else {
                        var n = t.create("node", "mmultiscripts", [o]);
                        m.default.getChildren(n).push(null, null), m.default.appendChildren(n, [ t.create("node", "mprescripts"), r, a ]),
                            n.setProperty("fixPrescript", !0), t.Push(n);
                    }
                }
                ...
                , NewTagForm : function(t, e, a)
                {
                    ...
                    var n = t.GetBrackets(e, ""), l = t.GetArgument(e), i = t.GetArgument(e);
                ...
                , UseTagForm : function(t, e)
                {
                    ...
                    if (r) {
                        if (!a.mtFormats.has(r))
                            throw new d.default("UndefinedTagForm", "Undefined tag form: %1", r);
                ...
                {
                    var a, r, o = t.options.mathtools;
                    if (!o["allow-mathtoolsset"])
                        throw new d.default("ForbiddenMathtoolsSet", "%1 is disabled", e);
                    var l = {};
                    Object.keys(o).forEach(
                        function(t) { "pariedDelimiters" != = t&& "tagforms" != = t&& "allow-mathtoolsset" != = t && (l[t] = 1); });
                    var s = t.GetArgument(e), u = i.default.keyvalOptions(s, l, !0);
                    try {
                ...
                , Array : u.default.Array, Macro : u.default.Macro, xArrow : s.AmsMethods.xArrow, HandleRef : s.AmsMethods.HandleRef,
                    AmsEqnArray : s.AmsMethods.AmsEqnArray, MacroWithTemplate : x.default.MacroWithTemplate,
                }
                ;
                }
                ...
                e.MathtoolsTagFormat = function(t, e)
                {
                    ...
                    var r = (function(t) {
                        function a()
                        {
                            var a, r, o = t.call(this) || this;
                            (o.mtFormats = new Map()), (o.mtCurrent = null);
                            var l = e.parseOptions.options.mathtools.tagforms;
                            try {
                                for (var i = n(Object.keys(l)), u = i.next(); !u.done; u = i.next()) {
                                    var c = u.value;
                                    if (!Array.isArray(l[c]) || 3 != = l[c].length)
                                        throw new s.default("InvalidTagFormDef",
                                                            'The tag form definition for "%1" should be an array fo three strings', c);
                        ...
                        return (o(a, t),
                                (a.prototype.formatTag =
                                     function(e) {
                                         if (this.mtCurrent) {
                                             var a = l(this.mtCurrent, 3), r = a[0], o = a[1], n = a[2];
                                             return n ? "".concat(r).concat(n, "{").concat(e, "}").concat(o)
                ...
                , 262 : function(t, e, a)
                {
                    ...
                    var n = a(935), l = o(a(398)), i = o(a(193)), s = o(a(402)), u = a(924), c = a(74), d = a(178), m = a(205);
                    e.MathtoolsUtil = {setDisplayLevel : function(t, e){if (e){var a = r((0, c.lookup)(e, {
                                                                                             "\\displaystyle" : [ !0, 0 ],
                                                                                             "\\textstyle" : [ !1, 0 ],
                                                                                             "\\scriptstyle" : [ !1, 1 ],
                                                                                         ...
                                                                                         2),
                                                                               o = a[0], n = a[1];
                    null != = o && (t.attributes.set("displaystyle", o), t.attributes.set("scriptlevel", n));
                }
                }
                ...
                , checkAlignment : function(t, e)
                {
                    ...
                    if (a.kind != = n.EqnArrayItem.prototype.kind)
                        throw new s.default("NotInAlignment", "%1 can only be used in aligment environments", e);
                    return a;
                }

                , addPairedDelims : function(t, e, a)
                {
                    t.handlers.retrieve(m.PAIREDDELIMS).add(e, new u.Macro(e, d.MathtoolsMethods.PairedDelimiters, a));
                }
                ...
                , spreadLines : function(t, e)
                {
                    if (t.isKind("mtable")) {
                        ...
                        if (a) {
                            ...
                            a = a.split(/ /).map(function(t) { return l.default.Em(Math.max(0, l.default.dimen2em(t) + r)); }).join(" ");
                        } else
                            a = e;
                ...
                , getScript : function(t, e, a)
                {
                    ...
                    return o && (r = "".concat(o, "{").concat(r, "}")), new i.default(r, t.stack.env, t.configuration).mml();
                }
                ...
                , 927 : function(t, e)
                {
                    Object.defineProperty(e, "__esModule", {value : !0}), (e.MultlineItem = MathJax._.input.tex.ams.AmsItems.MultlineItem),
                        (e.FlalignItem = MathJax._.input.tex.ams.AmsItems.FlalignItem);
                }

                , 939 : function(t, e)
                {
                    Object.defineProperty(e, "__esModule", {value : !0}), (e.AmsMethods = MathJax._.input.tex.ams.AmsMethods.AmsMethods),
                ...
                (t = u(955)), (e = u(667)), (a = u(205)), (r = u(144)), (o = u(178)), (n = u(298)),
                    (l = u(262)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/mathtools", e.q, "tex-extension"), (0, t.r8)({
                        _ : {
                            input : {
                                tex : {
                                    mathtools : {

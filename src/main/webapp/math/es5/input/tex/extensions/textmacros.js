!(function () {
    "use strict";
    var t, e, a, n, o, r = {667 : function(t, e){(e.q = void 0), (e.q = "3.2.2");
            },
            762: function (t, e, a) {
    ...
    var r = a(251), s = o(a(278)), i = a(680), c = a(935), l = a(787), u = a(807);
    function p(t, e, a, n)
    {
        var o = t.configuration.packageData.get("textmacros");
        return (t instanceof l.TextParser || (o.texParser = t), [new l.TextParser(e, n ? {mathvariant : n} : {}, o.parseOptions, a).mml()]);
    }
                a(557),
                    (e.TextBaseConfiguration = r.Configuration.create("text-base", {
                        ...
                        fallback: {
                            ...
                            macro: function (t, e) {
    var a = t.texParser, n = a.lookup("macro", e);
    n &&n._func != = u.TextMacrosMethods.Macro && t.Error("MathMacro", "%1 is only supported in math mode", "\\" + e),
                a.parse("macro", [ t, e ]);
                            },
}
,
    items : ((n = {}), (n[c.StartItem.prototype.kind] = c.StartItem), (n[c.StopItem.prototype.kind] = c.StopItem),
             (n[c.MmlItem.prototype.kind] = c.MmlItem), (n[c.StyleItem.prototype.kind] = c.StyleItem), n),
})),
                    (e.TextMacrosConfiguration = r.Configuration.create("textmacros", {
                        config: function (t, e) {
                            var a = new r.ParserConfiguration(e.parseOptions.options.textmacros.packages, ["tex", "text"]);
                            a.init();
...
, 557 : function(t, e, a)
{
    ...
    var n = a(871), o = a(108), r = a(807), s = a(230);
...
, 807 : function(t, e, a)
{
    ...
    var o = n(a(193)), r = a(832), s = n(a(360));
...
, Math : function(t, e)
{
    ...
    for (var a, n, r = t.i, s = 0; (n = t.GetNext());)
        switch (((a = t.i++), n)) {
            ...
            case "$":
                if (0 == = s&& e == = n) {
                    var i = t.texParser.configuration, c = new o.default(t.string.substr(r, a - r), t.stack.env, i).mml();
            ...
            case "{":
                ...
                break;
            case "}":
                0 == = s && t.Error("ExtraCloseMissingOpen", "Extra close brace or missing open brace"), s--;
        }
...
{
    var n = t.ParseArg(e), o = t.create("token", "mo", {}, a);
...
{
    var a = t.configuration.packageData.get("autoload"), n = t.texParser;
    e = e.slice(1);
...
, Macro : s.default.Macro, Spacer : s.default.Spacer, Hskip : s.default.Hskip, rule : s.default.rule, Rule : s.default.Rule,
...
, 787 : function(t, e, a)
{
    ...
    {
        var e = "function" == typeof Symbol && Symbol.iterator, a = e && t[e], n = 0;
        if (a)
            return a.call(t);
...
, i = (this && this.__spreadArray) || function(t, e, a)
{
...
Object.defineProperty(e, "__esModule", {value : !0}), (e.TextParser = void 0);
    ...
    e instanceof x.StyleItem ? (this.stack.env.mathcolor = this.stack.env.color) : e
        instanceof m.AbstractMmlNode && (this.addAttributes(e), this.nodes.push(e));
                            }),
                            (e.prototype.PushMath = function (t) {
    var e, a, n = this.stack.env;
    t.isKind("TeXAtom") || (t = this.create("node", "TeXAtom", [t]));
    try {
        for (var o = r([ "mathsize", "mathcolor" ]), s = o.next(); !s.done; s = o.next()) {
            var i = s.value;
            n[i] && !t.attributes.getExplicit(i)
                && (t.isToken || t.isKind("mstyle") || (t = this.create("node", "mstyle", [t])), h.default.setAttribute(t, i, n[i]));
        }
    } catch (t) {
        e = {error : t};
    } finally {
    ...
    if (t.isToken)
        try {
            for (var o = r([ "mathsize", "mathcolor", "mathvariant" ]), s = o.next(); !s.done; s = o.next()) {
                var i = s.value;
                n[i] && !t.attributes.getExplicit(i) && h.default.setAttribute(t, i, n[i]);
            }
        } catch (t) {
            e = {error : t};
        } finally {
    ...
    return new e(this.GetArgument(t), (a = Object.assign(Object.assign({}, this.stack.env), a)), this.configuration).mml();
                            }),
    ...
    for (var a = [], n = 2; n < arguments.length; n++)
        a[n - 2] = arguments[n];
    throw new (u.default.bind.apply(u.default, i([ void 0, t, e ], s(a), !1)))();
                            }),
                            e
                        );
                })(l.default);
                ...
                (t = i(955)), (e = i(667)), (a = i(762)), (n = i(807)),
                    (o = i(787)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/textmacros", e.q, "tex-extension"), (0, t.r8)({
                        _ : {
                            input : {
                                tex : {
                                    textmacros : {

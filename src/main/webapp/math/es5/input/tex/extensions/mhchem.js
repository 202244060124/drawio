!(function () {
    "use strict";
    var t, e, o, n = { 667 : function(t, e){(e.q = void 0), (e.q = "3.2.2");
            },
            78: function (t, e, o) {
    ...
    var a = o(251), r = o(871), i = n(o(402)), p = n(o(360)), c = o(939), u = o(652), s = {};
    (s.Macro = p.default.Macro), (s.xArrow = c.AmsMethods.xArrow),
        (s.Machine =
             function(t, e, o) {
    ...
    var o = (function() {
        ...
        return ((t.toTex = function(t, e) { return r.go(a.go(t, e), "tex" != = e); }), t);
    })();
    function n(t)
    {
        var e, o, n = {};
            ...
            for (o in t[e])
                for (a = t[e][o].stateArray || [], r = 0; r < a.length; r++) {
                    ...
                    for (var p = 0; p < i.action_.length; p++)
                        "string" == typeof i.action_[p] && (i.action_[p] = {type_ : i.action_[p]});
                    for (var c = e.split("|"), u = 0; u < c.length; u++)
                        if ("*" == = a[r]) {
                            var s = void 0;
                            for (s in n)
                                n[s].push({pattern : c[u], task : i});
                        } else
                            n[a[r]].push({pattern : c[u], task : i});
                }
        return n;
    }
    e.mhchemParser = o;
    ...
    for (var i = 10, p = [];;) {
        o != = t ? ((i = 10), (o = t)) : i--;
        var c = a.stateMachines[e], u = c.transitions[n] || c.transitions["*"];
    t:
...
empty: /^$/,
                                ...
                                "state of aggregation $": function (t)
    {
            ...
            1, 3}(?=[\),])/, ")", "");
                                    ...
                                    return o ? {match_ : o[0], remainder : t.substr(o[0].length)} : null;
},
    ...
    , "^a" : / ^\^ ([0 - 9] + | [^\\_]) /, "^\\x{}{}" : function(t)
    {
            ...
            var d = (function(t, e, o) {
                for (var n = 0; e < t.length;) {
                    var a = t.charAt(e), r = s(t.substr(e), o);
                    if (null != = r&& 0 == = n)
            ...
            e.match(/ ^[+\- ] /) && (o.push(e.substr(0, 1)), (e = e.substr(1)));
                                ...
                                return ((n[1] = n[1].replace(/\$ / g, "")), o.push({type_ : "frac", p1 : n[1], p2 : n[2]}),
                                        n[3] && ((n[3] = n[3].replace(/\$ / g, "")), o.push({type_ : "tex-math", p1 : n[3]})), o);
                            },
                            "9,9": function (t, e) {
            return a.go(e, "9,9");
                            },
    ...
    , stateMachines : {tex : {
                       ...
                       ce : {transitions : n({
                             ...
                             actions : {"o after d" : function(t, e){var o;
    if ((t.d || "").match(/ ^[1 - 9][0 - 9] * $ /)) {
        var n = t.d;
        (t.d = void 0), (o = this.output(t)).push({type_ : "tinySkip"}), (t.b = n);
    } else
        o = this.output(t);
    ...
    if (t.beginsWithBond) {
        var o = [];
        return a.concatArray(o, this.output(t)), a.concatArray(o, a.actions.bond(t, e, "-")), o;
    }
    t.d = e;
                                    },
                                    "- after o/d": function (t, e, o) {
    var n = a.patterns.match_("orbital", t.o || ""), r = a.patterns.match_("one lowercase greek letter $", t.o || ""),
        i = a.patterns.match_("one lowercase latin letter $", t.o || ""),
        p = a.patterns.match_("$one lowercase latin letter$ $", t.o || ""), c = "-" == = e && ((n&& "" == = n.remainder) || r || i || p);
    !c || t.a || t.b || t.p || t.d || t.q || n || !i || (t.o = "$" + t.o + "$");
    var u = [];
    return (c ? (a.concatArray(u, this.output(t)), u.push({type_ : "hyphen"}))
              : ((n = a.patterns.match_("digits", t.d || "")),
                 o && n && "" == = n.remainder ? (a.concatArray(u, a.actions["d="](t, e)), a.concatArray(u, this.output(t)))
                                               : (a.concatArray(u, this.output(t)), a.concatArray(u, a.actions.bond(t, e, "-")))),
            u);
                                    },
                                    "a to o": function (t) {
    (t.o = t.a), (t.a = void 0);
    ...
    return {type_ : "state of aggregation", p1 : a.go(e, "o")};
                                    ...
                                    comma: function (t, e) {
    var o = e.replace(/\s * $ /, "");
    return o != = e && 0 == = t.parenthesisLevel ? {type_ : "comma enumeration L", p1 : o} : {type_ : "comma enumeration M", p1 : o};
                                    },
                                    output: function (t, e, o) {
    var n;
    if (t.r) {
        var r = void 0;
        r = "M" == = t.rdt ? a.go(t.rd, "tex-math") : "T" == = t.rdt ? [ {type_ : "text", p1 : t.rd || ""} ] : a.go(t.rd, "ce");
        var i = void 0;
        (i = "M" == = t.rqt ? a.go(t.rq, "tex-math") : "T" == = t.rqt ? [ {type_ : "text", p1 : t.rq || ""} ] : a.go(t.rq, "ce")),
            (n = {type_ : "arrow", r : t.r, rd : r, rq : i});
    } else
        (n = []), (t.a || t.b || t.p || t.o || t.q || t.d || o)
                      && (t.sb && n.push({type_ : "entitySkip"}),
                          t.o || t.q || t.d || t.b || t.p
                              || 2 == = o ? t.o || t.q || t.d || (!t.b && !t.p)
    ...
    var o = ["{"];
    return a.concatArray(o, a.go(e, "oxidation")), o.push("}"), o;
                                    },
...
, pu : {transitions : n({
        ...
        actions : {enumber : function(t, e){var o = [];
return ("+-" == = e[0] || "+/-" == = e[0] ? o.push("\\pm ") : e[0] && o.push(e[0]),
        e[1]
            && (a.concatArray(o, a.go(e[1], "pu-9,9")),
                ...
                (e[3] || e[4]) && ("e" == = e[3] || "*" == = e[4] ? o.push({type_ : "cdot"}) : o.push({type_ : "times"}))),
        e[5] && o.push("10^{" + e[5] + "}"), o);
}
...
{
    var o = [];
    return ("+-" == = e[0] || "+/-" == = e[0] ? o.push("\\pm ") : e[0] && o.push(e[0]), a.concatArray(o, a.go(e[1], "pu-9,9")),
            o.push("^{" + e[2] + "}"), o);
}
...
, output : function(t)
{
    ...
    if ((n&& "" == = n.remainder && (t.q = n.match_),
        ...
        "//" == =
            t.o ? (e = {type_ : "pu-frac", p1 : r.d, p2 : r.q})
                : ((e = r.d), r.d.length > 1 || r.q.length > 1 ? e.push({type_ : " / "}) : e.push({type_ : "/"}), a.concatArray(e, r.q));
    } else
        e = a.go(t.d, "pu-2");
    for (var i in t)
        delete t[i];
...
, output : function(t)
{
    ...
    if (t.rm) {
        ...
        e = o&& "" == = o.remainder ? a.go(o.match_, "pu") : {type_ : "rm", p1 : t.rm};
    }
    for (var n in t)
        delete t[n];
    return e;
...
, "output-o" : function(t)
{
    var e = [];
    if (((t.text_ = t.text_ || ""), t.text_.length > 4)) {
        var o = t.text_.length - 3, n = void 0;
        for (n = 0; n < o; n += 3)
            e.push(t.text_.substr(n, 3)), e.push({type_ : "1000 separator"});
...
, r = {go : function(t, e){if (!t) return "";
for (var o = "", n = !1, a = 0; a < t.length; a++) {
    var i = t[a];
    "string" == typeof i ? (o += i) : ((o += r._go2(i)), "1st-level escape" == = i.type_ && (n = !0));
}
return e && !n && o && (o = "{" + o + "}"), o;
}
...
, _go2 : function(t)
{
    ...
    switch (t.type_) {
        case "chemfive":
            ...
            o.a && (o.a.match(/ ^[+\- ] /) && (o.a = "{" + o.a + "}"), (e += o.a + "\\,")),
                (o.b || o.p)
                    && ((e += "{\\vphantom{A}}"), (e += "^{\\hphantom{" + (o.b || "") + "}}_{\\hphantom{" + (o.p || "") + "}}"),
                        (e += "\\mkern-1.5mu"), (e += "{\\vphantom{A}}"), (e += "^{\\smash[t]{\\vphantom{2}}\\llap{" + (o.b || "") + "}}"),
                        (e += "_{\\vphantom{2}\\llap{\\smash[t]{" + (o.p || "") + "}}}")),
                o.o && (o.o.match(/ ^[+\- ] /) && (o.o = "{" + o.o + "}"), (e += o.o)),
                "kv" == = t.dType ? ((o.d || o.q) && (e += "{\\vphantom{A}}"), o.d && (e += "^{" + o.d + "}"),
                                     o.q && (e += "_{\\smash[t]{" + o.q + "}}"))
                                  : "oxidation" == = t.dType ? (o.d && ((e += "{\\vphantom{A}}"), (e += "^{" + o.d + "}")),
                                                                o.q && ((e += "{\\vphantom{A}}"), (e += "_{\\smash[t]{" + o.q + "}}")))
                                                             : (o.q && ((e += "{\\vphantom{A}}"), (e += "_{\\smash[t]{" + o.q + "}}")),
        ...
        case "roman numeral":
            ...
            break;
        case "text":
            t.p1.match(/ [\^ _] /) ? ((t.p1 = t.p1.replace(" ", "~").replace("-", "\\text{-}")), (e = "\\mathrm{" + t.p1 + "}"))
                                   : (e = "\\text{" + t.p1 + "}");
            break;
        ...
        case "color0":
            ...
            break;
        case "arrow":
            var i = {rd : r._goInner(t.rd), rq : r._goInner(t.rq)}, p = r._getArrow(t.r);
            i.rd || i.rq ? "<=>" == = t.r || "<=>>" == = t.r || "<<=>" == = t.r || "<--\x3e" == =
                               t.r ? ((p = "\\long" + p), i.rd && (p = "\\overset{" + i.rd + "}{" + p + "}"),
                                      i.rq
                                          && (p = "<--\x3e" == = t.r ? "\\underset{\\lower2mu{" + i.rq + "}}{" + p + "}"
                                                                     : "\\underset{\\lower6mu{" + i.rq + "}}{" + p + "}"),
                                      (p = " {}\\mathrel{" + p + "}{} "))
                                   : (i.rq && (p += "[{" + i.rq + "}]"), (p = " {}\\mathrel{\\x" + (p += "{" + i.rd + "}") + "}{} "))
                         : (p = " {}\\mathrel{\\long" + p + "}{} "),
                                 (e = p);
            break;
        case "operator":
...
(t = r(955)), (e = r(667)), (o = r(78)), MathJax.loader&& MathJax.loader.checkVersion("[tex]/mhchem", e.q, "tex-extension"), (0, t.r8)({

!(function () {
    ...
    var l = r(3309), u = r(9077), c = r(2982), f = s(r(199)), d = s(r(8321)), h = s(r(810)), p = s(r(3466)), m = s(r(6394)), g = r(7251),
        y = r(6552);
    r(3606);
                var v = (function (t) {
        function e(r)
        {
            void 0 == = r && (r = {});
            var n = this, a = i((0, u.separateOptions)(r, e.OPTIONS, c.FindTeX.OPTIONS), 3), o = a[0], s = a[1], l = a[2];
            (n = t.call(this, s) || this).findTeX = n.options.FindTeX || new c.FindTeX(l);
            var d = n.options.packages, h = (n.configuration = e.configure(d)),
                p = (n._parseOptions = new m.default(h, [ n.options, g.TagsFactory.OPTIONS ]));
            return ((0, u.userOptions)(p.options, o), h.config(n), e.tags(p, h), n.postFilters.add(f.default.cleanSubSup, -6),
                    n.postFilters.add(f.default.setInherited, -5), n.postFilters.add(f.default.moveLimits, -4),
                    n.postFilters.add(f.default.cleanStretchy, -3), n.postFilters.add(f.default.cleanAttributes, -2),
                    n.postFilters.add(f.default.combineRelations, -1), n);
        }
                    return (
                        a(e, t),
    ...
    try {
        var o = new h.default(this.latex, {display : a, isInner : !1}, this.parseOptions);
    ...
    return ((r = this.parseOptions.nodeFactory.create("node", "math", [r])),
            ...
            a && d.default.setAttribute(r, "display", "block"), this.parseOptions.tags.finishEquation(t), (this.parseOptions.root = r),
...
Object.defineProperty(e, "__esModule", {value : !0}), (e.ParserConfiguration = e.ConfigurationHandler = e.Configuration = void 0);
    ...
    {
        void 0 == = e && (e = {}), void 0 == = r && (r = {}), void 0 == = n && (n = {}), void 0 == = a && (a = {}),
               void 0 == = o && (o = {}), void 0 == = i && (i = {}), void 0 == = s && (s = []), void 0 == = l && (l = []),
               void 0 == = u && (u = null), void 0 == = c && (c = null), (this.name = t), (this.handler = e), (this.fallback = r),
               (this.items = n), (this.tags = a), (this.options = o), (this.nodes = i), (this.preprocessors = s), (this.postprocessors = l),
               (this.initMethod = u), (this.configMethod = c), (this.priority = f), (this.parser = d),
        ...
        var n = this;
        void 0 == = r && (r = {});
        var a = r.priority || u.PrioritizedList.DEFAULTPRIORITY, o = r.init ? this.makeProcessor(r.init, a) : null,
            i = r.config ? this.makeProcessor(r.config, a) : null,
            s = (r.preprocessors || []).map(function(t) { return n.makeProcessor(t, a); }),
            l = (r.postprocessors || []).map(function(t) { return n.makeProcessor(t, a); }), c = r.parser || "tex";
        return new t(e, r.handler || {}, r.fallback || {}, r.items || {}, r.tags || {}, r.options || {}, r.nodes || {}, s, l, o, i, a, c);
                            }),
        ...
        return void 0 == = e && (e = {}), t._create("", e);
                ...
                var d = (function() {
                    function t(t, e)
                    {
                        ...
                        void 0 == = e && (e = ["tex"]), (this.initMethod = new l.FunctionList()), (this.configMethod = new l.FunctionList()),
                               (this.configurations = new u.PrioritizedList()), (this.parsers = []), (this.handlers = new s.SubHandlers()),
                        ...
                        try {
                            for (var h = n(this.configurations), p = h.next(); !p.done; p = h.next()) {
                                var m = p.value, g = m.item, y = m.priority;
                                this.append(g, y);
                            }
                        } catch (t) {
                            o = {error : t};
                    ...
                    return ((t.prototype.init = function() { this.initMethod.execute(this); }),
                            ...
                            (t.prototype.add =
                                 function(t, e, r) {
                                     ...
                                     try {
                                         for (var u = n(Object.keys(s.items)), f = u.next(); !f.done; f = u.next()) {
                                             var d = f.value;
                                     ...
                                     c.TagsFactory.addTags(s.tags), (0, i.defaultOptions)(l.options, s.options),
                            ...
                            (t.prototype.addFilters =
                                 function(t, e) {
                                     ...
                                     try {
                                         for (var h = n(e.postprocessors), p = h.next(); !p.done; p = h.next()) {
                                             var m = a(p.value, 2), g = m[0];
                                             d = m[1];
                ...
                var o, i = r(8921), s = a(r(8321));
                !(function(t) {
                    (t.cleanStretchy =
                         function(t) {
                             var e, r, a = t.data;
                             try {
                                 for (var o = n(a.getList("fixStretchy")), i = o.next(); !i.done; i = o.next()) {
                                     var l = i.value;
                                     if (s.default.getProperty(l, "fixStretchy")) {
                                         var u = s.default.getForm(l);
                                         u&& u[3] && u[3].stretchy&& s.default.setAttribute(l, "stretchy", !1);
                                         var c = l.parent;
                        ...
                        (t.cleanAttributes =
                             function(t) {
                                 t.data.root.walkTree(
                                     function(t, e) {
                                         var r, a, o = t.attributes;
                                         if (o) {
                                             var i = new Set((o.get("mjx-keep-attrs") || "").split(/ /));
                                             delete o.getAllAttributes()["mjx-keep-attrs"];
                                             try {
                                                 for (var s = n(o.getExplicitNames()), l = s.next(); !l.done; l = s.next()) {
                                                     var u = l.value;
                                                     i.has(u) || o.attributes[u] != = t.attributes.getInherited(u) || delete o.attributes[u];
                                                 }
                                             } catch (t) {
                                                 r = {error : t};
                                             } finally {
                        ...
                        (t.combineRelations = function(t) {
                            var a, o, l, u, c = [];
                            try {
                                for (var f = n(t.data.getList("mo")), d = f.next(); !d.done; d = f.next()) {
                                    var h = d.value;
                                    if (!h.getProperty("relationsCombined") && h.parent && (!h.parent || s.default.isType(h.parent, "mrow"))
                                            && s.default.getTexClass(h) == = i.TEXCLASS.REL) {
                                        for (var p = h.parent, m = void 0, g = p.childNodes, y = g.indexOf(h) + 1,
                                                 v = s.default.getProperty(h, "variantForm");
                                             y < g.length && (m = g[y]) && s.default.isType(m, "mo") && s.default.getTexClass(m) == =
                                                 i.TEXCLASS.REL;

                                        ) {
                                            if (v != = s.default.getProperty(m, "variantForm") || !r(h, m)) {
                                                null == h.attributes.getExplicit("rspace") && s.default.setAttribute(h, "rspace", "0pt"),
                                                    null == m.attributes.getExplicit("lspace") && s.default.setAttribute(m, "lspace", "0pt");
                                                break;
                                            }
                                            s.default.appendChildren(h, s.default.getChildren(m)), e([ "stretchy", "rspace" ], h, m);
                                            try {
                                                for (var b = ((l = void 0), n(m.getPropertyNames())), A = b.next(); !A.done; A = b.next()) {
                                                    var M = A.value;
                                            ...
                                            g.splice(y, 1), c.push(m), (m.parent = null), m.setProperty("relationsCombined", !0);
                                        }
                    ...
                    {
                        var n = e.attributes, a = r.attributes;
                    ...
                    , a = function(t, e, r)
                    {
                        var a, o, i = [];
                        try {
                            for (var l = n(t.getList("m" + e + r)), u = l.next(); !u.done; u = l.next()) {
                                var c = u.value, f = c.childNodes;
                                if (!f[c[e]] || !f[c[r]]) {
                                    var d = c.parent, h = f[c[e]] ? t.nodeFactory.create("node", "m" + e, [ f[c.base], f[c[e]] ])
                                                                  : t.nodeFactory.create("node", "m" + r, [ f[c.base], f[c[r]] ]);
                                    s.default.copyAttributes(c, h), d ? d.replaceChild(h, c) : (t.root = h), i.push(c);
                                }
                            }
                        } catch (t) {
                            a = {error : t};
                        ...
                        try {
                            for (var l = n(t.getList(e)), u = l.next(); !u.done; u = l.next()) {
                                ...
                                if (!c.attributes.get("displaystyle")) {
                                    var f = c.childNodes[c.base], d = f.coreMO();
                                    if (f.getProperty("movablelimits") && !d.attributes.getExplicit("movablelimits")) {
                                        var h = t.nodeFactory.create("node", r, c.childNodes);
                                        s.default.copyAttributes(c, h), c.parent ? c.parent.replaceChild(h, c) : (t.root = h), i.push(c);
                                    }
                                }
                            }
                        } catch (t) {
                    ...
                    (t.moveLimits =
                         function(t) {
                             var e = t.data;
                             o(e, "munderover", "msubsup"), o(e, "munder", "msub"), o(e, "mover", "msup");
                         }),
                        ...
                        u = (function(t) {
                            ...
                            return (a(e, t),
                                    (e.prototype.getPatterns =
                                         function() {
                                             var t = this, e = this.options, r = [], n = [], a = [];
                                    ...
                                    (e.prototype.addPattern =
                                         function(t, e, r) {
                                             var n = o(e, 2), a = n[0], i = n[1];
                                             t.push((0, s.quotePattern)(a)), (this.end[a] = [ i, r, this.endPattern(i) ]);
                                         }),
                                    ...
                                    (e.prototype.findEnd =
                                         function(t, e, r, n) {
                                             for (var a, i = o(n, 3), s = i[0], u = i[1], c = i[2],
                                                         f = (c.lastIndex = r.index + r[0].length), d = 0;
                                                  (a = c.exec(t));

                                             ) {
                                                 if ((a[1] || a[0]) == = s&& 0 == = d)
                                                     return (0, l.protoItem)(r[0], t.substr(f, a.index - f), a[0], e, r.index,
                                                                             a.index + a[0].length, u);
                                                 "{" == = a[0] ? d++ : "}" == = a[0] && d && d--;
                                             }
                                             return null;
                                         }),
                                         ...
                                         function(t, e, r) {
                                             ...
                                             for (this.start.lastIndex = 0; (n = this.start.exec(r));) {
                                                 if (void 0 != = n[this.env] && this.env) {
                                                     var o = "\\\\end\\s*(\\{" + (0, s.quotePattern)(n[this.env]) + "\\})";
                                                     (a = this.findEnd(r, e, n, [ "{" + n[this.env] + "}", !0, this.endPattern(null, o) ]))
                                                         && ((a.math = a.open + a.math + a.close), (a.open = a.close = ""));
                                                 } else if (void 0 != = n[this.sub] && this.sub) {
                                                     var i = n[this.sub];
                                                     o = n.index + n[this.sub].length;
                                                     a = 2 == = i.length ? (0, l.protoItem)("", i.substr(1), "", e, n.index, o)
                                                                         : (0, l.protoItem)("", i, "", e, n.index, o, !1);
                                                 } else
                                                     a = this.findEnd(r, e, n, this.end[n[0]]);
                                 ...
                                 function(t, e, r) {
                                     ...
                                     try {
                                         for (var l = n(t.slice().reverse()), u = l.next(); !u.done; u = l.next()) {
                                             var c = u.value, f = o.getMap(c);
                                             if (!f)
                                                 return void this.warn("Configuration " + c + " not found! Omitted.");
                        ...
                        s = (function() {
                            ...
                            return ((t.createNode =
                                         function(t, e, r, n, a) {
                                             ...
                                             return o.setChildren(r), a && o.appendChild(a), i.default.setProperties(o, n), o;
                                         }),
                                    (t.createToken =
                                         function(t, e, r, n) {
                                             void 0 == = r && (r = {}), void 0 == = n && (n = "");
                ...
                !(function(t) {
                    ...
                    function r(t, r)
                    {
                        ...
                        try {
                            for (var i = n(Object.keys(r)), s = i.next(); !s.done; s = i.next()) {
                                var l = s.value, u = r[l];
                                "texClass" == = l ? ((t.texClass = u), t.setProperty(l, u))
                                                  : "movablelimits" == =
                                                        l ? (t.setProperty("movablelimits", u),
                    ...
                    (t.createEntity = function(t) { return String.fromCodePoint(parseInt(t, 16)); }),
                        ...
                        (t.copyAttributes = function(t, e) { (e.attributes = t.attributes), r(e, t.getAllProperties()); }), (t.isType = u),
                        ...
                        (t.isInferred = function(t) { return t.isInferred; }), (t.getForm = function(t) {
                            ...
                            if (!u(t, "mo"))
                                return null;
                            var a = t, o = a.getForms();
                            try {
                                for (var i = n(o), s = i.next(); !s.done; s = i.next()) {
                                    var c = s.value, f = l.MmlMo.OPTABLE[c][a.getText()];
                                    if (f)
                                        return f;
                                }
                            } catch (t) {
                ...
                , 4708 : function(t, e, r)
                {
                    ...
                    Object.defineProperty(e, "__esModule", {value : !0});
                    var i, s = o(r(8321)), l = r(7007), u = o(r(7702));
                    !(function(t) {
                        (t.variable =
                             function(t, e) {
                                 var r = u.default.getFontDef(t), n = t.stack.env;
                            ...
                            (t.digit =
                                 function(t, e) {
                                     var r, n = t.configuration.options.digits, a = t.string.slice(t.i - 1).match(n),
                                            o = u.default.getFontDef(t);
                                     a ? ((r = t.create("token", "mn", o, a[0].replace(/ [ {} ] / g, ""))), (t.i += a[0].length - 1))
                            ...
                            (t.environment = function(t, e, r, o) {
                                var i = o[0], s = t.itemFactory.create("begin").setProperties({name : e, end : i});
    ...
    function t(t, e)
    {
        void 0 == = e && (e = []), (this.options = {}), (this.packageData = new Map()), (this.parsers = []), (this.root = null),
               ...
               (this.itemFactory.configuration = this), c.defaultOptions.apply(void 0, a([this.options], n(e), !1)),
    ...
    if ((r || (r = this.nodeLists[t] = []), r.push(e), e.kind != = t)) {
        var n = u.default.getProperty(e, "in-lists") || "", a = (n ? n.split(/, /) : []).concat(t).join(",");
        u.default.setProperty(e, "in-lists", a);
    }
                            }),
                            (t.prototype.getList = function (t) {
    var e, r, n = this.nodeLists[t] || [], a = [];
    try {
    ...
    var r, n, a = this.nodeLists[t] || [];
    try {
        for (var i = o(e), s = i.next(); !s.done; s = i.next()) {
            var l = s.value, u = a.indexOf(l);
            u >= 0 && a.splice(u, 1);
        }
    } catch (t) {
        r = {error : t};
    ...
    return !!t;
                ...
                Object.defineProperty(e, "__esModule", {value : !0});
                var i, s = r(8921), l = o(r(8321)), u = o(r(810)), c = o(r(3466)), f = r(9029);
                !(function (t) {
    ...
    return t / 18;
                ...
                , o = "([-+]?([.,]\\d+|\\d+([.,]\\d*)?))", i = "(pt|em|ex|mu|px|mm|cm|in|pc)",
                  d = RegExp("^\\s*" + o + "\\s*" + i + "\\s*$"), h = RegExp("^\\s*" + o + "\\s*" + i + " ?");
                ...
                function v(t, e, r)
                {
                    if ((r.match(/ ^[a - z] / i) && e.match(/ (^ | [^\\])(\\\\) *\\[a - z] + $ / i) && (e += " "),
                        ...
                        throw new c.default("MaxBufferSize", "MathJax internal buffer size exceeded; is there a recursive macro call?");
                    return e + r;
                }
    ...
    var e = n(p(t), 2), a = e[0], o = e[1], i = parseFloat(a || "1"), s = r[o];
    return s ? s(i) : 0;
                        }),
                        (t.Em = m),
                        (t.cols = function () {
    ...
    var i, c = t.nodeFactory, f = c.create("node", "mrow", [], {
        open:
    ...
    return o && i.attributes.set("mathcolor", o), l.default.appendChildren(f, [i]), f;
                        }),
    ...
    return (e && l.default.appendChildren(a, [g(t, e, "l")]),
            l.default.isType(r, "mrow") ? l.default.appendChildren(a, l.default.getChildren(r)) : l.default.appendChildren(a, [r]),
            n && l.default.appendChildren(a, [g(t, n, "r")]), a);
                        }),
                        (t.mathPalette = g),
                        (t.fixInitialMO = function (t, e) {
    for (var r = 0, n = e.length; r < n; r++) {
        var a = e[r];
        if (a && !l.default.isType(a, "mspace")
            && (!l.default.isType(a, "TeXAtom")
                || (l.default.getChildren(a)[0] && l.default.getChildren(l.default.getChildren(a)[0]).length))) {
            if (l.default.isEmbellished(a) || (l.default.isType(a, "TeXAtom") && l.default.getTexClass(a) == = s.TEXCLASS.REL)) {
    ...
    var a, o, i = n || t.stack.env.font, s = i ? {mathvariant : i} : {}, l = [], f = 0, d = 0, h = "", p = 0;
                            if (e.match(/\\?[${}\\]|\\\(|\\(eq)?ref\s*\{/))
        {
            for (; f < e.length;)
                if ("$" == = (a = e.charAt(f++)))
                    "$" == = h&& 0 == = p ? ((o = t.create("node", "TeXAtom",
                                                           [
                                                               new u.default(e.slice(d, f - 1), {}, t.configuration).mml(),
                                                           ])),
                                             l.push(o), (h = ""), (d = f))
                                          : "" == = h && (d < f - 1 && l.push(y(t, e.slice(d, f - 1), s)), (h = "$"), (d = f));
                else if ("{" == = a&& "" != = h)
                    p++;
                else if ("}" == = a)
                    if ("}" == = h&& 0 == = p) {
                        var m = new u.default(e.slice(d, f), {}, t.configuration).mml();
                        (o = t.create("node", "TeXAtom", [m], s)), l.push(o), (h = ""), (d = f);
                    } else
                        "" != = h && p && p--;
                else if ("\\" == = a)
                        ...
                        {
                            var g = RegExp["$&"].length;
                            d < f - 1 && l.push(y(t, e.slice(d, f - 1), s)), (h = "}"), (d = f - 1), (f += g);
                        }
                        else
                                            "(" === (a = e.charAt(f++)) && "" === h
                                                ? (d < f - 2 && l.push(y(t, e.slice(d, f - 2), s)), (h = ")"), (d = f))
                                                : ")" === a && ")" === h && 0 === p
                                                ? ((o = t.create("node", "TeXAtom", [
                                                      new u.default(e.slice(d, f - 2), {}, t.configuration).mml(),
                                                  ])),
                                                  l.push(o),
                                                  (h = ""),
                                                  (d = f))
                                                : a.match(/[${}\\]/) && "" === h && (f--, (e = e.substr(0, f - 1) + e.substr(f)));
                        if ("" != = h)
            ...
            return (o
                    ...
                    l.default.setProperty(c, "subsupOK", !0), c);
                        }),
            ...
            if ((void 0 == = e && (e = !0), !(++t.macroCount <= t.configuration.options.maxMacros)))
                throw e
                    ? new c.default("MaxMacroSub1", "MathJax maximum macro substitution count exceeded; is here a recursive macro call?")
                    : new c.default("MaxMacroSub2", "MathJax maximum substitution count exceeded; is there a recursive latex environment?");
                        }),
            ...
            var s = (function(t) {
                var e, r, a, o, i, s = {}, l = t;
                for (; l;)
                    (o = (e = n(A(l, [ "=", "," ]), 3))[0]), (a = e[1]), (l = e[2]),
                        "=" == = a ? ((i = (r = n(A(l, [","]), 3))[0]), (a = r[1]), (l = r[2]),
                                      (i = "false" == = i || "true" == = i ? JSON.parse(i) : i), (s[o] = i))
                                   : o && (s[o] = !0);
                return s;
            })(t);
            if (e)
                try {
                    for (var l = a(Object.keys(s)), u = l.next(); !u.done; u = l.next()) {
                        ...
                        if (!e.hasOwnProperty(f)) {
                            if (r)
                                throw new c.default("InvalidOption", "Invalid option: %1", f);
                            delete s[f];
                        }
                    }
                } catch (t) {
    ...
    try {
        for (var l = n(r), u = l.next(); !u.done; u = l.next()) {
            ...
            if (c) {
                ...
                var d = a(this.stack.length ? this.Top().checkItem(f) : [ null, !0 ], 2), h = d[0], p = d[1];
                p
                    && (h ? (this.Pop(), this.Push.apply(this, o([], a(h), !1)))
                          : (this.stack.push(f),
                             f.env ? (f.copyEnv && Object.assign(f.env, this.env), (this.env = f.env)) : (f.env = this.env)));
            }
        }
    } catch (e) {
        t = {error : e};
    ...
    for (var e, r = [], n = 1; n < arguments.length; n++)
        r[n - 1] = arguments[n];
    return (e = this.factory.configuration.nodeFactory).create.apply(e, i([t], o(r), !1));
                            }),
                            t
                        );
                })();
    ...
    function e(e)
    {
        ...
        return (a.factory = e), (a.global = {}), (a._properties = {}), a.isOpen && (a._env = {}), a;
    }
                    return (
                        a(e, t),
    ...
    if (t.isClose && this.getErrors(t.kind)) {
        var r = o(this.getErrors(t.kind), 2), n = r[0], a = r[1];
    ...
    var e = o(t, 2), r = e[0], n = e[1], a = this.parserFor(n), i = this.lookup(n);
    return a && i ? c(a(r, i)) : null;
                ...
                var d = (function(t) {
                    ...
                    return (a(e, t), (e.prototype.contains = function(t) { return this._regExp.test(t); }),
                ...
                var h = (function(t) {
                    ...
                    return (a(e, t), (e.prototype.lookup = function(t) { return this.map.get(t); }),
                ...
                var p = (function(t) {
                    function e(e, r, n)
                    {
                        var a, s, u = t.call(this, e, r) || this;
                        try {
                            for (var c = i(Object.keys(n)), f = c.next(); !f.done; f = c.next()) {
                                var d = f.value, h = n[d], p = o("string" == typeof h ? [ h, null ] : h, 2), m = p[0], g = p[1],
                ...
                var g = (function(t) {
                    function e(e, r, n)
                    {
                        var a, s, u = t.call(this, e, null) || this;
                        try {
                            for (var c = i(Object.keys(r)), f = c.next(); !f.done; f = c.next()) {
                                var d = f.value, h = r[d], p = o("string" == typeof h ? [h] : h), m = p[0], g = p.slice(1),
                    ...
                    return (a(e, t),
                            ...
                            (e.prototype.parse =
                                 function(t) {
                                     var e = o(t, 2), r = e[0], n = e[1], a = this.lookup(n), i = this.parserFor(n);
                                     return a && i ? c(i.apply(void 0, s([ r, a.symbol ], o(a.args), !1))) : null;
                                 }),
                            e);
                })(h);
                e.MacroMap = g;
                ...
                var u = function(t, e, r, n, a, o, i, s)
                {
                    void 0 == = t && (t = ""), void 0 == = e && (e = !1), void 0 == = r && (r = !1), void 0 == = n && (n = null),
                           void 0 == = a && (a = ""), void 0 == = o && (o = ""), void 0 == = i && (i = !1), void 0 == = s && (s = ""),
                           (this.env = t), (this.taggable = e), (this.defaultTags = r), (this.tag = n), (this.tagId = a),
                           (this.tagFormat = o), (this.noTag = i), (this.labelId = s);
                };
                e.TagInfo = u;
                var c = (function () {
    function t()
    {
        (this.counter = 0), (this.allCounter = 0), (this.configuration = null), (this.ids = {}), (this.allIds = {}), (this.labels = {}),
            (this.allLabels = {}), (this.redo = !1), (this.refUpdate = !1), (this.currentTag = new u()), (this.history = []),
            (this.stack = []), (this.enTag = function(t, e) {
                var r = this.configuration.nodeFactory, n = r.create("node", "mtd", [t]), a = r.create("node", "mlabeledtr", [ e, n ]);
        ...
        this.currentTag&& this.stack.push(this.currentTag), (this.currentTag = new u(t, e, r));
                        }),
                        Object.defineProperty(t.prototype, "env", {
                            get: function () {
    ...
    (this.history = []), (this.stack = []), this.clearTag(), (this.currentTag = new u("", void 0, void 0)), (this.labels = {}),
        ...
        id:
            this.currentTag.tagId,
                ...
                var f = (function(t) {
                    ...
                    return (a(e, t), (e.prototype.autoTag = function(){}),
    ...
    for (var n = e.split(t.pattern), a = 1, o = n.length; a < o; a += 2) {
        var i = n[a].charAt(0);
        if (i >= "0" && i <= "9")
            (n[a] = r[parseInt(n[a], 10) - 1]), "number" == typeof n[a] && (n[a] = n[a].toString());
        else if ("{" == = i) {
            if ((i = n[a].substr(1)) >= "0" && i <= "9")
                (n[a] = r[parseInt(n[a].substr(1, n[a].length - 2), 10) - 1]), "number" == typeof n[a] && (n[a] = n[a].toString());
            else
                n[a].match(/^\{([a-z]+):%(\d+)\|(.*)\}$/) && (n[a] = "%" + n[a]);
        }
        null == n[a] && (n[a] = "???");
    }
    return n.join("");
    ...
    function t(t, e, r)
    {
        ...
        var i, s = e.hasOwnProperty("isInner"), u = e.isInner;
        ...
        this.configuration.pushParser(this), (this.stack = new l.default(this.itemFactory, i, !s || u)), this.Parse(),
    ...
    var t, e, r = "";
    try {
        for (var a = n(Array.from(this.configuration.handlers.keys())), o = a.next(); !o.done; o = a.next()) {
            var i = o.value;
    ...
    t instanceof c.AbstractMmlNode&& t.isInferred ? this.PushAll(t.childNodes) : this.stack.Push(t);
                            }),
    ...
    if ("{" == = this.GetNext()) {
        var e = this.GetArgument(t), r = a(s.default.matchDimen(e), 2), n = r[0], o = r[1];
        if (n)
            return n + o;
    } else {
        e = this.string.slice(this.i);
        var i = a(s.default.matchDimen(e, !0), 3), l = ((n = i[0]), (o = i[1]), i[2]);
        if (n)
            return (this.i += l), n + o;
    }
    ...
    for (var e, r = [], n = 1; n < arguments.length; n++)
        r[n - 1] = arguments[n];
    return (e = this.configuration.nodeFactory).create.apply(e, o([t], a(r), !1));
                            }),
                            t
                        );
                })();
                ...
                , 3946 : function(t, e, r)
                {
                    ...
                    var i = r(6552), s = r(3632), l = r(7251), u = r(2684);
                    r(8285);
                    var c = r(7628), f = (function(t) {
                                         function e()
                                         {
                                             return (null != = t && t.apply(this, arguments)) || this;
                                         }
    ...
    if (1 != = this.row.length)
        throw new c.default("MultlineRowsOneCol", "The rows within the %1 environment must have exactly one column", "multline");
    ...
    if ((t.prototype.EndTable.call(this), this.table.length)) {
        ...
        u.default.getAttribute(u.default.getChildren(this.table[0])[0], "columnalign")
            || u.default.setAttribute(u.default.getChildren(this.table[0])[0], "columnalign", f.TexConstant.Align.LEFT),
            u.default.getAttribute(u.default.getChildren(this.table[e])[0], "columnalign")
                || u.default.setAttribute(u.default.getChildren(this.table[e])[0], "columnalign", f.TexConstant.Align.RIGHT);
        var n = this.factory.configuration.tags.getTag();
        if (n) {
            r = this.arraydef.side == = f.TexConstant.Align.LEFT ? 0 : this.table.length - 1;
            var a = this.table[r], o = this.create("node", "mlabeledtr", [n].concat(u.default.getChildren(a)));
    ...
    if (e && this.row.length > e)
        throw new c.default("XalignOverflow", "Extra %1 in row of %2", "&", this.name);
                        }),
                        (e.prototype.EndRow = function () {
    ...
    if (this.getProperty("zeroWidthLabel") && a.isKind("mlabeledtr")) {
        var i = u.default.getChildren(a)[0], s = this.factory.configuration.options.tagSide,
            l = o({width : 0}, "right" == = s ? {lspace : "-1width"} : {}), c = this.create("node", "mpadded", u.default.getChildren(i), l);
        i.setChildren([c]);
    }
                        }),
                        (e.prototype.EndTable = function () {
    ...
    t.default = e;
                    ...
                    o =
                        ...
                        function (t)
                            ...
                            Object.defineProperty(e, "__esModule", {value : !0});
                            var s = r(2684), l = o(r(7628)), u = r(7007), c = i(r(4708)), f = i(r(7702)), d = r(8921), h = r(6914);
                            new l.CharacterMap("AMSmath-mathchar0mo", c.default.mathchar0mo, {
                                ...
                                new l.CommandMap("AMSmath-macros", {
                                    ...
                                    xleftarrow : [ "xArrow", 8592, 10, 5 ],
                                                 ...
                                                 s.AmsMethods),
                                new l.EnvironmentMap("AMSmath-environment", c.default.environment, {
                                    "equation*" : [ "Equation", null, !1 ],
                                    "eqnarray*" :
                                        [ "EqnArray", null, !1, !0, "rcl", f.default.cols(0, h.MATHSPACE.thickmathspace), ".5em" ],
                            ...
                            , 2684 : function(t, e, r)
                            {
                                ...
                                var i = o(r(7702)), s = o(r(4708)), l = o(r(8321)), u = r(7007), c = o(r(810)), f = o(r(3466)), d = r(4237),
                                    h = o(r(724)), p = r(8921);
                                function m(t)
                                {
                                ...
                                (e.AmsMethods = {}),
                                    ...
                                    (e.AmsMethods.AlignAt =
                                         function(t, r, n, a) {
                                             var o, s, l = r.getName(), u = "", c = [];
                                             if ((a || (s = t.GetBrackets("\\begin{" + l + "}")),
                                                  (o = t.GetArgument("\\begin{" + l + "}")).match(/ [^0 - 9] /)))
                                                 throw new f.default("PositiveIntegerArg", "Argument to %1 must me a positive integer",
                                                                     "\\begin{" + l + "}");
                                             for (var d = parseInt(o, 10); d > 0;)
                                                 (u += "rl"), c.push("0em 0em"), d--;
                                             var h = c.join(" ");
                                             if (a)
                                                 return e.AmsMethods.EqnArray(t, r, n, a, u, h);
                                    ...
                                    (e.AmsMethods.FlalignArray =
                                         function(t, e, r, n, a, o, s, l) {
                                             ...
                                             return ((u.arraydef = {
                                                     ...
                                                     u.setProperty("zeroWidthLabel", l), u);
                                         }),
                                    ...
                                    (e.AmsMethods.HandleDeclareOp =
                                         function(t, r) {
                                             ...
                                             t.configuration.handlers.retrieve(e.NEW_OPS)
                                                 .add(a,
                                                      new d.Macro(a, e.AmsMethods.Macro, ["\\operatorname".concat(n, "{").concat(o, "}")]));
                                         }),
                                    ...
                                    (e.AmsMethods.SideSet =
                                         function(t, e) {
                                             var r = a(m(t.ParseArg(e)), 2), n = r[0], o = r[1], s = a(m(t.ParseArg(e)), 2), u = s[0],
                                                 c = s[1], f = t.ParseArg(e), d = f;
                                             n
                                                       ...
                                                       : ((d = t.create("node", "mmultiscripts", [f])),
                                                          u
                                                              && l.default.appendChildren(d,
                                                                                          [
                                                                                              l.default.getChildAt(u, 1)
                                                                                                  || t.create("node", "none"),
                                                                                              l.default.getChildAt(u, 2)
                                                                                                  || t.create("node", "none"),
                                                                                          ]),
                                                 ...
                                                 u&& d == = f && (u.replaceChild(f, l.default.getChildAt(u, 0)), (d = u));
                                             var h = t.create("node", "TeXAtom", [], {
                                                 texClass:
                                                     p.TEXCLASS.OP, movesupsub : !0, movablelimits : !0,
                                             });
                                             o && (n && h.appendChild(n), h.appendChild(o)), h.appendChild(d), c &&h.appendChild(c),
                                                 t.Push(h);
                                         }),
                                    ...
                                    (e.AmsMethods.xArrow =
                                         function(t, e, r, n, a) {
                                             var o = {
                                                 ...
                                                 s = t.GetBrackets(e), u = t.ParseArg(e),
                                                 f = t.create("node", "mspace", [],
                                                              {
                                                                  depth:
                                                                      ".25em"
                                                              }),
                                                 d = t.create("token", "mo", {stretchy : !0, texClass : p.TEXCLASS.REL},
                                                              String.fromCodePoint(r));
                                             d = t.create("node", "mstyle", [d], {
                                                 scriptlevel:
                                                     0
                                             });
                                             var h = t.create("node", "munderover", [d]), m = t.create("node", "mpadded", [ u, f ], o);
                                             if ((l.default.setAttribute(m, "voffset", "-.2em"),
                                                  l.default.setAttribute(m, "height", "-.2em"), l.default.setChild(h, h.over, m), s)) {
                                                 ...
                                                 (m = t.create("node", "mpadded", [ g, y ], o)),
                                                     ...
                                                     l.default.setAttribute(m, "depth", "-.15em"), l.default.setChild(h, h.under, m);
                                             }
                                    ...
                                    (e.AmsMethods.HandleShove =
                                         function(t, e, r) {
                                             var n = t.stack.Top();
                                             if ("multline" != = n.kind)
                                                 throw new f.default("CommandOnlyAllowedInEnv", "%1 only allowed in %2 environment",
                                                                     t.currentCS, "multline");
                                             if (n.Size())
                                                 throw new f.default("CommandAtTheBeginingOfLine",
                                    ...
                                    (e.AmsMethods.CFrac =
                                         function(t, e) {
                                             var r = i.default.trimSpaces(t.GetBrackets(e, "")), n = t.GetArgument(e), a = t.GetArgument(e),
                                                 ...
                                                 s = new c.default("\\strut\\textstyle{" + n + "}", t.stack.env, t.configuration).mml(),
                                                 d = new c.default("\\strut\\textstyle{" + a + "}", t.stack.env, t.configuration).mml(),
                                                 h = t.create("node", "mfrac", [ s, d ]);
                                             if (null == (r = o[r]))
                                                 throw new f.default("IllegalAlign", "Illegal alignment specified in %1", t.currentCS);
                                    ...
                                    (e.AmsMethods.Genfrac =
                                         function(t, e, r, n, a, o) {
                                             ...
                                             var s = t.ParseArg(e), u = t.ParseArg(e), c = t.create("node", "mfrac", [ s, u ]);
                                             if (("" != = a && l.default.setAttribute(c, "linethickness", a),
                                                  (r || n)
                                                      && (l.default.setProperty(c, "withDelims", !0),
                                                          (c = i.default.fixedFence(t.configuration, r, c, n))),
                                                  "" != = o)) {
                                                 var d = parseInt(o, 10), h = [ "D", "T", "S", "SS" ][d];
                                                 if (null == h)
                                                     throw new f.default("BadMathStyleFor", "Bad math style for %1", t.currentCS);
                                                 (c = t.create("node", "mstyle", [c])), "D" == = h ? l.default.setProperties(c, {
                                                     displaystyle : !0,
                                                     scriptlevel : 0,
                                                 })
                                    ...
                                    (e.AmsMethods.HandleTag =
                                         function(t, e) {
                                             if (!t.tags.currentTag.taggable && t.tags.env)
                                                 throw new f.default("CommandNotAllowedInEnv", "%1 not allowed in %2 environment",
                                    ...
                                    (e.AmsMethods.HandleNoTag = h.default.HandleNoTag), (e.AmsMethods.HandleRef = h.default.HandleRef),
                                    (e.AmsMethods.Macro = h.default.Macro), (e.AmsMethods.Accent = h.default.Accent),
                                    (e.AmsMethods.Tilde = h.default.Tilde), (e.AmsMethods.Array = h.default.Array),
                                    (e.AmsMethods.Spacer = h.default.Spacer), (e.AmsMethods.NamedOp = h.default.NamedOp),
                                    (e.AmsMethods.EqnArray = h.default.EqnArray), (e.AmsMethods.Equation = h.default.Equation);
                            }
                            ...
                            var o = r(6552), i = r(7628), s = r(4237), l = r(4303), u = r(1993), c = r(9077);

                            function f(t, e, r, o)
                            {
                                var i, s, c, f;
                                if (u.Package.packages.has(t.options.require.prefix + r)) {
                                    var p = t.options.autoload[r], m = n(2 == = p.length && Array.isArray(p[0]) ? p : [ p, [] ], 2),
                                        g = m[0], y = m[1];
                                    try {
                            ...
                            var d = new i.CommandMap("autoload-macros", {}, {}), h = new i.CommandMap("autoload-environments", {}, {});
    ...
    for (var b = a(Object.keys(v)), A = b.next(); !A.done; A = b.next()) {
        var M = A.value, x = v[M], w = n(2 == = x.length && Array.isArray(x[0]) ? x : [ x, [] ], 2), O = w[0], S = w[1];
        try {
            for (var T = ((i = void 0), a(O)), P = T.next(); !P.done; P = T.next()) {
                var C = P.value;
                (g.lookup(C)&& "color" != = C) || d.add(C, new s.Macro(C, f, [ M, !0 ]));
            }
        } catch (t) {
            i = {error : t};
        } finally {
        ...
        try {
            for (var _ = ((c = void 0), a(S)), E = _.next(); !E.done; E = _.next()) {
                var k = E.value;
    ...
    try {
        ...
        if (r)
            throw r.error;
                ...
                , init : function(t)
                {
                    t.options.require || (0, c.defaultOptions)(t.options, l.RequireConfiguration.options);
                }
    ...
    t.default = e;
                    ...
                    l =
                        ...
                        function (t)
                            ...
                            var f = r(6552), d = r(2910), h = c(r(3466)), p = c(r(8321)), m = r(7628), g = l(r(8389)), y = r(7251);
                            r(4962);
                            var v = r(3857);
                            ...
                            function b(t, e)
                            {
                                var r = t.stack.env.font ? {mathvariant : t.stack.env.font} : {}, n = d.MapHandler.getMap("remap").lookup(e),
                                    a = (0, v.getRange)(e), o = a ? a[3] : "mo", i = t.create("token", o, r, n ? n.char : e);
                                a[4] && i.attributes.set("mathvariant", a[4]),
                                    "mo" == = o && (p.default.setProperty(i, "fixStretchy", !0), t.configuration.addNode("fixStretchy", i)),
                                         t.Push(i);
                            }
                ...
                (e.BaseTags = A),
                    (e.BaseConfiguration = f.Configuration.create("base", {
                        ...
                        fallback: {
                            character: b,
                            macro: function (t, e) {
                                throw new h.default("UndefinedControlSequence", "Undefined control sequence %1", "\\" + e);
                }
                ...
                ,
                    items : ((a = {}), (a[g.StartItem.prototype.kind] = g.StartItem), (a[g.StopItem.prototype.kind] = g.StopItem),
                             (a[g.OpenItem.prototype.kind] = g.OpenItem), (a[g.CloseItem.prototype.kind] = g.CloseItem),
                             (a[g.PrimeItem.prototype.kind] = g.PrimeItem), (a[g.SubsupItem.prototype.kind] = g.SubsupItem),
                             (a[g.OverItem.prototype.kind] = g.OverItem), (a[g.LeftItem.prototype.kind] = g.LeftItem),
                             (a[g.Middle.prototype.kind] = g.Middle), (a[g.RightItem.prototype.kind] = g.RightItem),
                             (a[g.BeginItem.prototype.kind] = g.BeginItem), (a[g.EndItem.prototype.kind] = g.EndItem),
                             (a[g.StyleItem.prototype.kind] = g.StyleItem), (a[g.PositionItem.prototype.kind] = g.PositionItem),
                             (a[g.CellItem.prototype.kind] = g.CellItem), (a[g.MmlItem.prototype.kind] = g.MmlItem),
                             (a[g.FnItem.prototype.kind] = g.FnItem), (a[g.NotItem.prototype.kind] = g.NotItem),
                             (a[g.NonscriptItem.prototype.kind] = g.NonscriptItem), (a[g.DotsItem.prototype.kind] = g.DotsItem),
                             (a[g.ArrayItem.prototype.kind] = g.ArrayItem), (a[g.EqnArrayItem.prototype.kind] = g.EqnArrayItem),
                             (a[g.EquationItem.prototype.kind] = g.EquationItem), a),
                            options
                    : {
                        maxMacros : 1e3,
                    ...
                    : [
                        [
                            function(t) {
                                var e, r, n = t.data;
                                try {
                                    for (var a = u(n.getList("nonscript")), o = a.next(); !o.done; o = a.next()) {
                                        var i = o.value;
    ...
    function e()
    {
        return (null != = t && t.apply(this, arguments)) || this;
                    ...
                    return (
                        ...
                        (e.prototype.checkItem = function (t) {
    var e = o(this.Peek(2), 2), r = e[0], n = e[1];
    return !h.default.isType(r, "msubsup") || h.default.isType(r, "msup") ? [ [ this.create("node", "msup", [ r, n ]), t ], !0 ]
    ...
    if (e.isKind("mml")) {
        if (this.getProperty("primes"))
            if (2 != = n)
                ...
                h.default.setProperty(this.getProperty("primes"), "variantForm", !0);
                var a = this.create("node", "mrow", [ this.getProperty("primes"), e.First ]);
                e.First = a;
            }
        return (h.default.setChild(r, n, e.First),
                null != this.getProperty("movesupsub") && h.default.setProperty(r, "movesupsub", this.getProperty("movesupsub")),
                [ [this.factory.create("mml", r)], !0 ]);
    }
    if (t.prototype.checkItem.call(this, e)[1]) {
        var s = this.getErrors([ "", "sub", "sup" ][n]);
        throw new (f.default.bind.apply(f.default, i([ void 0, s[0], s[1] ], o(s.splice(2)), !1)))();
    }
    return null;
                        }),
                        (e.errors = Object.assign(Object.create(p.BaseItem.errors), {
    ...
    function e(e)
    {
        ...
        return r.setProperty("name", "\\over"), r;
                ...
                , enumerable : !1, configurable : !0,
                        ...
                        (e.prototype.checkItem = function (e) {
    if (e.isKind("over"))
        throw new f.default("AmbiguousUseOf", "Ambiguous use of %1", e.getName());
    if (e.isClose) {
        var r = this.create("node", "mfrac", [ this.getProperty("num"), this.toMml(!1) ]);
        return (null != this.getProperty("thickness") && h.default.setAttribute(r, "linethickness", this.getProperty("thickness")),
    ...
    if (e.isKind("end")) {
        if (e.getName() != = this.getName())
            throw new f.default("EnvBadEnd", "\\begin{%1} ended with \\end{%2}", this.getName(), e.getName());
        return this.getProperty("end") ? p.BaseItem.fail : [ [this.factory.create("mml", this.toMml())], !0 ];
    }
    if (e.isKind("stop"))
        throw new f.default("EnvMissingEnd", "Missing \\end{%1}", this.getName());
    return t.prototype.checkItem.call(this, e);
                        }),
                        e
                    );
    ...
    function e()
    {
        return (null != = t && t.apply(this, arguments)) || this;
                    ...
                    return (
                        ...
                        (e.prototype.checkItem = function (e) {
    if (e.isClose)
        throw new f.default("MissingBoxFor", "Missing box for %1", this.getName());
    if (e.isFinal) {
        var r = e.toMml();
    ...
    if (r) {
        ...
        if (!e.isKind("fn")) {
            ...
            if (!e.isKind("mml") || !n)
                return [ [ r, e ], !0 ];
            if ((h.default.isType(n, "mstyle") && n.childNodes.length && h.default.isType(n.childNodes[0].childNodes[0], "mspace"))
        ...
        var o = this.create("token", "mo", {texClass : c.TEXCLASS.NONE}, u.entities.ApplyFunction);
        return [ [ r, o, e ], !0 ];
    }
    ...
    if (t.isKind("open") || t.isKind("left"))
        return p.BaseItem.success;
    if (t.isKind("mml") && (h.default.isType(t.First, "mo") || h.default.isType(t.First, "mi") || h.default.isType(t.First, "mtext"))
        && ((e = t.First),
            1 == = (r = h.default.getText(e)).length && !h.default.getProperty(e, "movesupsub")&& 1 == = h.default.getChildren(e).length))
        return (this.remap.contains(r) ? ((n = this.create("text", this.remap.lookup(r).char)), h.default.setChild(e, 0, n))
                                       : ((n = this.create("text", "\u0338")), h.default.appendChildren(e, [n])),
                [ [t], !0 ]);
    n = this.create("text", "\u29f8");
    var a = this.create(
            "node", "mtext", [], {}, n),
        o = this.create("node", "mpadded", [a], {
            width:
                0
        });
    return [
    ...
    if (t.isKind("mml")&& 1 == = t.Size()) {
        var e = t.First;
        if ((e.isKind("mstyle") && e.notParent && (e = h.default.getChildren(h.default.getChildren(e)[0])[0]), e.isKind("mspace"))) {
            if (e != = t.First) {
    ...
    if (e.isClose && !e.isKind("over")) {
        ...
        if (e.getProperty("isCR"))
            return this.EndEntry(), this.EndRow(), this.clearEnv(), p.BaseItem.fail;
    ...
    return (t && e.setProperty("scriptlevel", t),
            4 == = this.frame.length
                       ? h.default.setAttribute(e, "frame", this.dashed ? "dashed" : "solid")
                       : this.frame.length
    ...
    this.hfill.length
        && (0 == = this.hfill[0] && h.default.setAttribute(t, "columnalign", "right"),
            this.hfill[this.hfill.length - 1]
                == = this.Size() && h.default.setAttribute(t, "columnalign", h.default.getAttribute(t, "columnalign") ? "center" : "left")),
    ...
    function e(e)
    {
        for (var r = [], n = 1; n < arguments.length; n++)
            r[n - 1] = arguments[n];
        var a = t.call(this, e) || this;
        return (a.maxrow = 0), a.factory.configuration.tags.start(r[0], r[2], r[1]), a;
    }
                    return (
                        a(e, t),
                        Object.defineProperty(e.prototype, "kind", {
    ...
    if (this.arraydef[t]) {
        var r = this.arraydef[t].split(/ /), n = i([], o(r), !1);
        if (n.length > 1) {
            for (; n.length < e;)
                n.push.apply(n, i([], o(r), !1));
    ...
    t.default = e;
                    ...
                    o =
                        ...
                        function (t)
                            ...
                            Object.defineProperty(e, "__esModule", {value : !0});
                            var s = o(r(7628)), l = r(7007), u = i(r(724)), c = i(r(4708)), f = i(r(7702)), d = r(8921), h = r(6914);
                            new s.RegExpMap("letter", c.default.variable, / [a - z] / i),
                                new s.RegExpMap("digit", c.default.digit, /
                                                                              [
                                                                                  0 - 9.,
                                                                              ]
                                                                              /),
                                ...
                                new s.CommandMap("macros", {
                                    ...
                                    mmlToken : "MmlToken",
                                                 ...
                                                 u.default),
                                new s.EnvironmentMap("environment", c.default.environment, {
                                    array : ["AlignedArray"],
                                    equation : [ "Equation", null, !0 ],
                                    eqnarray : [ "EqnArray", null, !0, !0, "rcl", f.default.cols(0, h.MATHSPACE.thickmathspace), ".5em" ],
                                },
                                                     u.default),
    ...
    t.default = e;
                    ...
                    i =
                        ...
                        function (t)
                            ...
                            Object.defineProperty(e, "__esModule", {value : !0});
                            var u = i(r(8389)), c = l(r(8321)), f = l(r(3466)), d = l(r(810)), h = r(7007), p = l(r(7702)), m = r(8921),
                                g = r(7251), y = r(6914), v = r(9029), b = r(9077), A = {}, M = {
                                    fontfamily : 1,
                                    fontsize : 1,
                                    fontweight : 1,
                                    fontstyle : 1,
                            ...
                            function x(t, e)
                            {
                                ...
                                r.inRoot = !0;
                                var a = new d.default(e, r, t.configuration), o = a.mml(), i = a.stack.global;
                            ...
                            (A.Open = function(t, e) { t.Push(t.itemFactory.create("open")); }),
                                (A.Close = function(t, e) { t.Push(t.itemFactory.create("close")); }),
                                (A.Tilde = function(t, e) { t.Push(t.create("token", "mtext", {}, v.entities.nbsp)); }),
                                ...
                                (A.Superscript =
                                     function(t, e) {
                                         ...
                                         var o = t.stack.Top();
                                         o.isKind("prime") ? ((a = (r = s(o.Peek(2), 2))[0]), (n = r[1]), t.stack.Pop())
                                                           : (a = t.stack.Prev()) || (a = t.create("token", "mi", {}, ""));
                                         var i = c.default.getProperty(a, "movesupsub"), l = c.default.isType(a, "msubsup") ? a.sup : a.over;
                                         if ((c.default.isType(a, "msubsup") && !c.default.isType(a, "msup")
                                              && c.default.getChildAt(a, a.sup))
                                             || (c.default.isType(a, "munderover") && !c.default.isType(a, "mover")
                                                 && c.default.getChildAt(a, a.over) && !c.default.getProperty(a, "subsupOK")))
                                         ...
                                         (c.default.isType(a, "msubsup") && !c.default.isType(a, "msup"))
                                             || (i ? ((!c.default.isType(a, "munderover") || c.default.isType(a, "mover")
                                             ...
                                             t.Push(t.itemFactory.create("subsup", a)
                                ...
                                (A.Subscript =
                                     function(t, e) {
                                         ...
                                         if ((c.default.isType(a, "msubsup") && !c.default.isType(a, "msup")
                                             ...
                                             || (c.default.isType(a, "munderover") && !c.default.isType(a, "mover")
                                                 && c.default.getChildAt(a, a.under) && !c.default.getProperty(a, "subsupOK")))
                                ...
                                (A.Prime =
                                     function(t, e) {
                                         var r = t.stack.Prev();
                                         if ((r || (r = t.create("node", "mi")), c.default.isType(r, "msubsup")
                                                                                     && !c.default.isType(r, "msup")
                                                                                     && c.default.getChildAt(r, r.sup)))
                                             throw new f.default("DoubleExponentPrime",
                                ...
                                (A.SetFont = function(t, e, r) { t.stack.env.font = r; }),
                                (A.SetStyle =
                                     function(t, e, r, n, a) {
                                         (t.stack.env.style = r), (t.stack.env.level = a),
                                             t.Push(
                                                 t.itemFactory.create("style").setProperty("styles", {displaystyle : n, scriptlevel : a}));
                                     }),
                                (A.SetSize =
                                     function(t, e, r) {
                                         (t.stack.env.size = r),
                                     ...
                                     function(t, e, r) {
                                         ...
                                         if (!n
                                             || (c.default.getTexClass(c.default.getCoreMO(n))
                                                     != = m.TEXCLASS.OP && null == c.default.getProperty(n, "movesupsub")))
                                             throw new f.default("MisplacedLimits", "%1 is allowed only on operators", t.currentCS);
                                         var a, o = t.stack.Top();
                                         c.default.isType(n, "munderover") && !r
                                             ? ((a = t.create("node", "msubsup")), c.default.copyChildren(n, a), (n = o.Last = a))
                                             : c.default.isType(n, "msubsup") && r
                                                   && ((a = t.create("node", "munderover")), c.default.copyChildren(n, a), (n = o.Last = a)),
                                             c.default.setProperty(n, "movesupsub", !!r), c.default.setProperties(c.default.getCoreMO(n), {
                                                 movablelimits : !1,
                                             }),
                                             (c.default.getAttribute(n, "movablelimits") || c.default.getProperty(n, "movablelimits"))
                                ...
                                (A.Over =
                                     function(t, e, r, n) {
                                         ...
                                         r || n
                                             ...
                                             e.match(/ ^\\above /) ? a.setProperty("thickness", t.GetDimen(e))
                                                                   : (e.match(/ ^\\atop /) || r || n) && a.setProperty("thickness", 0),
                                             t.Push(a);
                                     }),
                                (A.Frac =
                                     function(t, e) {
                                         var r = t.ParseArg(e), n = t.ParseArg(e), a = t.create("node", "mfrac", [ r, n ]);
                                         t.Push(a);
                                     }),
                                (A.Sqrt =
                                     function(t, e) {
                                         ...
                                         (a = r ? t.create("node", "mroot", [ a, x(t, r) ]) : t.create("node", "msqrt", [a])), t.Push(a);
                                     }),
                                (A.Root =
                                     function(t, e) {
                                         var r = t.GetUpTo(e, "\\of"), n = t.ParseArg(e), a = t.create("node", "mroot", [ n, x(t, r) ]);
                                         t.Push(a);
                                     }),
                                (A.MoveRoot =
                                     function(t, e, r) {
                                         if (!t.stack.env.inRoot)
                                             throw new f.default("MisplacedMoveRoot", "%1 can appear only within a root", t.currentCS);
                                         if (t.stack.global[r])
                                             throw new f.default("MultipleMoveRoot", "Multiple use of %1", t.currentCS);
                                         var n = t.GetArgument(e);
                        if (!n.match(/-?[0-9]+/))
                            throw new f.default("IntegerArg", "The argument to %1 must be an integer", t.currentCS);
                        "-" != = (n = parseInt(n, 10) / 15 + "em").substr(0, 1) && (n = "+" + n), (t.stack.global[r] = n);
                                     }),
                                (A.Accent =
                                     function(t, e, r, a) {
                                         var o = t.ParseArg(e), i = n(n({}, p.default.getFontDef(t)), {
                                                                    accent : !0,
                                                                    mathaccent : !0,
                                                                }),
                                             s = c.default.createEntity(r), l = t.create("token", "mo", i, s);
                                         ...
                                         c.default.setChild(f, 0, o), c.default.setChild(f, 1, null), c.default.setChild(f, 2, l);
                                         var d = t.create("node", "TeXAtom", [f]);
                                         t.Push(d);
                                     }),
                                (A.UnderOver =
                                     function(t, e, r, n) {
                                         var a = c.default.createEntity(r), o = t.create("token", "mo", {stretchy : !0, accent : !0}, a),
                                ...
                                (A.Overset =
                                     function(t, e) {
                                         ...
                                         p.default.checkMovableLimits(n), r.isKind("mo") && c.default.setAttribute(r, "accent", !1);
                                ...
                                (A.Overunderset =
                                     function(t, e) {
                                         var r = t.ParseArg(e), n = t.ParseArg(e), a = t.ParseArg(e);
                                         p.default.checkMovableLimits(a), r.isKind("mo") && c.default.setAttribute(r, "accent", !1),
                                ...
                                (A.TeXAtom =
                                     function(t, e, r) {
                                         var n, a, o, i = {texClass : r};
                                         if (r == = m.TEXCLASS.OP) {
                                             i.movesupsub = i.movablelimits = !0;
                                             var s = t.GetArgument(e), l = s.match(/ ^\s*\\rm\s + ([a - zA - Z0 - 9] +) $ /);
                                             l ? ((i.mathvariant = h.TexConstant.Variant.NORMAL), (a = t.create("token", "mi", i, l[1])))
                                ...
                                (A.MmlToken =
                                     function(t, e) {
                                         var r, n = t.GetArgument(e), a = t.GetBrackets(e, "").replace(/ ^\s + /, ""), o = t.GetArgument(e),
                                                i = {}, s = [];
                                         try {
                                             r = t.create("node", n);
                                         } catch (t) {
                            ...
                            if (!l) throw new f.default("InvalidMathMLAttr", "Invalid MathML attribute: %1", a);
                            if (!r.attributes.hasDefault(l[1]) && !M[l[1]])
                                throw new f.default("UnknownAttrForElement", "%1 is not a recognized attribute for %2", l[1], n);
                            var u = p.default.MmlFilterAttribute(t, l[1], l[2].replace(/^(['"])(.*)\1$/, "$2"));
                            u &&
                                ("true" === u.toLowerCase() ? (u = !0) : "false" === u.toLowerCase() && (u = !1),
                                (i[l[1]] = u),
                                s.push(l[1])),
                                     ...
                                     function(t, e, r, n) {
                                         ...
                                         (r || n)
                                             && ((a = t.create("node", "mpadded", [a])),
                                                 n && (c.default.setAttribute(a, "height", 0), c.default.setAttribute(a, "depth", 0)),
                                     ...
                                     function(t, e) {
                                         ...
                                         switch (r) {
                                             ...
                                             case "t":
                                                 ...
                                                 break;
                                             default:
                                                 c.default.setAttribute(n, "height", 0), c.default.setAttribute(n, "depth", 0);
                                         }
                                ...
                                (A.Nonscript = function(t, e) { t.Push(t.itemFactory.create("nonscript")); }),
                                (A.Rule =
                                     function(t, e, r) {
                                         var n = {
                                             width : t.GetDimen(e),
                                ...
                                (A.rule =
                                     function(t, e) {
                                         var r = t.GetBrackets(e), n = t.GetDimen(e), a = t.GetDimen(e), o = t.create("node", "mspace", [], {
                                             width:
                                                 n, height : a, mathbackground : t.stack.env.color || "black",
                                         });
                                         r
                                             && ((o = t.create("node", "mpadded", [o],
                                                 ...
                                                 r.match(/ ^\- /) ? (c.default.setAttribute(o, "height", r),
                                ...
                                (A.BuildRel =
                                     function(t, e) {
                                         var r = t.ParseUpTo(e, "\\over"), n = t.ParseArg(e), a = t.create("node", "munderover");
                                         c.default.setChild(a, 0, n), c.default.setChild(a, 1, null), c.default.setChild(a, 2, r);
                                         var o = t.create("node", "TeXAtom", [a], {
                                             texClass:
                                                 m.TEXCLASS.REL,
                                         });
                                ...
                                (A.HBox = function(t, e, r, n) { t.PushAll(p.default.internalMath(t, t.GetArgument(e), r, n)); }),
                                (A.FBox =
                                     function(t, e) {
                                ...
                                (A.FrameBox =
                                     function(t, e) {
                                         ...
                                         var o = t.create("node", "TeXAtom", [t.create("node", "menclose", a, {notation : "box"})], {
                                             texClass:
                                                 m.TEXCLASS.ORD,
                                         });
                                         t.Push(o);
                                     }),
                                (A.Not = function(t, e) { t.Push(t.itemFactory.create("not")); }),
                                (A.Dots =
                                     function(t, e) {
                                         var r = c.default.createEntity("2026"), n = c.default.createEntity("22EF"),
                                ...
                                (A.Matrix =
                                     function(t, e, r, n, a, o, i, s, l, u) {
                                         var c = t.GetNext();
                                         if ("" == = c)
                                             throw new f.default("MissingArgFor", "Missing argument for %1", t.currentCS);
                                         "{" == = c ? t.i++ : ((t.string = c + "}" + t.string.slice(t.i + 1)), (t.i = 0));
                                         var d = t.itemFactory.create("array").setProperty("requireClose", !0);
                                         (d.arraydef = {
                                             rowspacing : i || "4pt",
                                             columnspacing : o || "1em",
                                         }),
                                             l &&d.setProperty("isCases", !0), u && (d.setProperty("isNumbered", !0), (d.arraydef.side = u)),
                                             (r || n) && (d.setProperty("open", r), d.setProperty("close", n)),
                                             "D" == = s && (d.arraydef.displaystyle = !0), null != a && (d.arraydef.columnalign = a),
                                                 t.Push(d);
                                     }),
                                (A.Entry =
                                     function(t, e) {
                                         ...
                                         if (r.getProperty("isCases") || n) {
                                             for (var a = t.string, o = 0, i = -1, s = t.i, l = a.length,
                                                      u = n ? new RegExp("^\\\\end\\s*\\{".concat(n.replace(/\* /, "\\*"), "\\}")) : null;
                                                  s < l;
                                                 ...
                                                 if ("{" == = c)
                                                     ...
                                                     if ("\\" == = c) {
                                                         var d = a.substr(s);
                                                         d.match(/ ^((\\cr)[^a - zA - Z] |\\\\) /) || (u && d.match(u)) ? (l = 0) : (s += 2);
                                                     } else
                                                         s++;
                                                 }
                                             }
                                             var h = a.substr(t.i, s - t.i);
                                             if (!h.match(/ ^\s*\\text[^a - zA - Z] /) || i != = h.replace(/\s + $ /, "").length - 1) {
                                                 var m = p.default.internalMath(t, p.default.trimSpaces(h), 0);
                                                 t.PushAll(m), (t.i = s);
                                             }
                                         }
                                     }),
                                (A.Cr = function(t, e) { t.Push(t.itemFactory.create("cell").setProperties({isCR : !0, name : e})); }),
                                (A.CrLaTeX =
                                     function(t, e, r) {
                                         var n;
                                         if ((void 0 == = r && (r = !1),
                                              !r && ("*" == = t.string.charAt(t.i) && t.i++, "[" == = t.string.charAt(t.i)))) {
                                             var a = t.GetBrackets(e, ""), o = s(p.default.matchDimen(a), 2), i = o[0], l = o[1];
                                             if (a && !i)
                                         ...
                                         var c, d = t.stack.Top();
                                         d
                                             instanceof u.ArrayItem ? n&& d.addRowSpacing(n)
                                                                    : (n
                                                                       ...
                                                                       (c = t.create("node", "mspace", [],
                                                                                     {
                                                                                         linebreak:
                                                                                             h.TexConstant.LineBreak.NEWLINE,
                                                                                     })),
                                                                       t.Push(c));
                                     }),
                                (A.HLine =
                                     function(t, e, r) {
                                         ...
                                         if (n.table.length) {
                                             for (var a = n.arraydef.rowlines ? n.arraydef.rowlines.split(/ /) : [];
                                ...
                                (A.HFill =
                                     function(t, e) {
                                         ...
                                         if (!(r instanceof u.ArrayItem))
                                             throw new f.default("UnsupportedHFill", "Unsupported use of %1", t.currentCS);
                                         r.hfill.push(r.Size());
                                     }),
                                (A.BeginEnd =
                                     function(t, e) {
                                         ...
                                         return ((c.arraydef = {
                                                 ...
                                                 u.match(/ [|:] /)
                                                     && (u.charAt(0).match(/ [|:] /)
                                                         ...
                                                         (c.arraydef.columnlines = u.split("")
                                                                                       .join(" ")
                                                                                       .replace(/ [^|:] / g, "none")
                                                                                       .replace(/\| / g, "solid")
                                                                                       .replace(/
                                                 ...
                                                 "'" == = (s || "").charAt(1) && ((c.arraydef["data-cramped"] = !0), (s = s.charAt(0))),
                                                 "D" == = s ? (c.arraydef.displaystyle = !0) : s && (c.arraydef.displaystyle = !1),
                                                 "S" == = s && (c.arraydef.scriptlevel = 1), l && (c.arraydef.useHeight = !1), t.Push(e), c);
                                     }),
                                (A.AlignedArray =
                                     function(t, e) {
                                         var r = t.GetBrackets("\\begin{" + e.getName() + "}"), n = A.Array(t, e);
                                         return p.default.setArrayAlign(n, r);
                                     }),
                                (A.Equation =
                                     function(t, e, r) {
                                         return t.Push(e), p.default.checkEqnEnv(t),
                                                t.itemFactory.create("equation", r).setProperty("name", e.getName());
                                     }),
                                (A.EqnArray =
                                     function(t, e, r, n, a, o) {
                                         t.Push(e), n &&p.default.checkEqnEnv(t),
                                             (a = (a = a.replace(/ [^clr] / g, "").split("").join(" "))
                                                      .replace(/ l / g, "left")
                                                      .replace(/ r / g, "right")
                                                      .replace(/ c / g, "center"));
                                ...
                                (A.HandleNoTag = function(t, e) { t.tags.notag(); }),
                                (A.HandleLabel =
                                     function(t, e) {
                                         var r = t.GetArgument(e);
                                ...
                                (A.HandleRef =
                                     function(t, e, r) {
                                         var n = t.GetArgument(e), a = t.tags.allLabels[n] || t.tags.labels[n];
                                ...
                                (A.Macro =
                                     function(t, e, r, n, a) {
                                         if (n) {
                                             ...
                                             for (var s = o.length; s < n; s++)
                                                 o.push(t.GetArgument(e));
                                             r = p.default.substituteArgs(t, o, r);
                                         }
                                         (t.string = p.default.addArgs(t, r, t.string.slice(t.i))), (t.i = 0), p.default.checkMaxMacros(t);
                                     }),
                                (A.MathChoice =
                                     function(t, e) {
                                         var r = t.ParseArg(e), n = t.ParseArg(e), a = t.ParseArg(e), o = t.ParseArg(e);
                            ...
                            var i = r(6552), s = r(9077), l = r(7628), u = o(r(4708)), c = r(4237), f = o(r(8562)), d = r(6706),
                                h = "configmacros-map", p = "configmacros-env-map";
                ...
                {
                    !(function(t) {
                        var e, r, n = t.parseOptions.handlers.retrieve(h), o = t.parseOptions.options.macros;
                        try {
                            for (var i = a(Object.keys(o)), s = i.next(); !s.done; s = i.next()) {
                                var l = s.value, u = "string" == typeof o[l] ? [o[l]] : o[l],
                                    d = Array.isArray(u[2]) ? new c.Macro(l, f.default.MacroWithTemplate, u.slice(0, 2).concat(u[2]))
                        ...
                        (function(t) {
                            var e, r, n = t.parseOptions.handlers.retrieve(p), o = t.parseOptions.options.environments;
                            try {
                                for (var i = a(Object.keys(o)), s = i.next(); !s.done; s = i.next()) {
                                    var l = s.value;
                                    n.add(l, new c.Macro(l, f.default.BeginEnv, [!0].concat(o[l])));
                                }
                            } catch (t) {
                                e = {error : t};
                            } finally {
    ...
    t.default = e;
                    ...
                    i =
                        ...
                        function (t)
                            ...
                            var l = r(6552), u = r(6706), c = s(r(5282));
                            r(6823);
                            var f = s(r(4708)), d = i(r(7628));
    ...
    t.default = e;
                    ...
                    o =
                        ...
                        function (t)
                            ...
                            Object.defineProperty(e, "__esModule", {value : !0});
                            var s = i(r(3466)), l = o(r(7628)), u = i(r(724)), c = i(r(7702)), f = i(r(5282)),
                                d = {NewCommand : function(t, e){var r = f.default.GetCsNameArgument(t, e), n = f.default.GetArgCount(t, e),
                            ...
                            {
                                var r = c.default.trimSpaces(t.GetArgument(e)), n = f.default.GetArgCount(t, e), a = t.GetBrackets(e),
                            ...
                            {
                                var r = f.default.GetCSname(t, e), n = f.default.GetTemplate(t, e, "\\" + r), a = t.GetArgument(e);
                                n
                                    instanceof Array ? f.default.addMacro(t, r, d.MacroWithTemplate, [a].concat(n))
                                                     : f.default.addMacro(t, r, d.Macro, [ a, n ]);
                            }

                            , Let : function(t, e)
                            {
                                var r = f.default.GetCSname(t, e), n = t.GetNext();
                                "=" == = n && (t.i++, (n = t.GetNext()));
                                var a = t.configuration.handlers;
                                if ("\\" != = n) {
                                    t.i++;
                                    var o = a.get("delimiter").lookup(n);
                                    o ? f.default.addDelimiter(t, "\\" + r, o.char, o.attributes) : f.default.addMacro(t, r, d.Macro, [n]);
                                } else {
                                    e = f.default.GetCSname(t, e);
                                    var i = a.get("delimiter").lookup("\\" + e);
                                    if (i)
                                        return void f.default.addDelimiter(t, "\\" + r, i.char, i.attributes);
                            ...
                            , MacroWithTemplate : function(t, e, r, n)
                            {
                                ...
                                (t.string = c.default.addArgs(t, r, t.string.slice(t.i))), (t.i = 0), c.default.checkMaxMacros(t);
                            }
                            ...
                            , BeginEnv : function(t, e, r, n, a, o)
                            {
                                ...
                                if (a) {
                                    ...
                                    (r = c.default.substituteArgs(t, s, r)), (n = c.default.substituteArgs(t, [], n));
                                }
                                return ((t.string = c.default.addArgs(t, r, t.string.slice(t.i))), (t.i = 0),
                            ...
                            , 5282 : function(t, e, r)
                            {
                                ...
                                Object.defineProperty(e, "__esModule", {value : !0});
                                var a, o = n(r(7702)), i = n(r(3466)), s = r(4237);
                                !(function(t) {
                                    function e(t, e)
                                    {
    ...
    try {
        ...
        if (r)
            throw r.error;
                ...
                var s = r(6552), l = r(7628), u = i(r(3466)), c = r(8723), f = r(1993), d = r(847), h = r(3184), p = r(9077),
                    m = c.MathJax.config;
                ...
                function g(t, e)
                {
                    ...
                    if (o.indexOf(i) < 0) {
                        ...
                        if (l) {
                            var u = m[e] || {};
                            l.options&& 1 == = Object.keys(l.options).length && l.options[i] && (((r = {})[i] = u), (u = r)),
                                          t.configuration.add(i, t, u);
                            var c = t.parseOptions.packageData.get("require").configured;
                            l.preprocessors.length && !c.has(i) && (c.set(i, !0), h.mathjax.retryAfter(Promise.resolve()));
                        }
                    }
                }
                ...
                function y(t, e)
                {
                    ...
                    if (!(n.hasOwnProperty(a) ? n[a] : n.hasOwnProperty(e) ? n[e] : r.defaultAllow))
                        throw new u.default("BadRequire", 'Extension "%1" is not allowed to be loaded', a);
                    f.Package.packages.has(a) ? g(t.configuration.packageData.get("require").jax, a)
                    ...
                    (e.RequireMethods = {
                        Require: function (t, e) {
                            ...
                            if (r.match(/[^_a-zA-Z0-9]/) || "" === r)
                                throw new u.default("BadPackageName", "Argument for %1 is not a valid package name", e);
                            y(t, r);
                }
                ,
                }),
                ...
                !(function() {
                    var t = r(8723), e = r(7306), n = r(7205), a = r(6552), o = r(199), i = r(2982), s = r(2910), l = r(8644), u = r(8321),
                        c = r(4708), f = r(6394), d = r(7702), h = r(9874), p = r(7044), m = r(3239), g = r(4237), y = r(7628), v = r(7251),
                        b = r(7007), A = r(3466), M = r(810), x = r(3946), w = r(3632), O = r(2684), S = r(1451), T = r(3606), P = r(8389),
                        C = r(724), _ = r(3274), E = r(2200), k = r(6706), I = r(8562), L = r(5282), N = r(8405), F = r(4303);
                    MathJax.loader &&MathJax.loader.checkVersion("input/tex", e.q, "input"), (0, t.combineWithMathJax)({
                        _ : {
                            input : {
                                tex_ts : n,
                                tex : {
                    ...
                    var j = r(9077);
                    r(847).Loader.preLoad("input/tex-base", "[tex]/ams", "[tex]/newcommand", "[tex]/noundefined", "[tex]/require",
                                          "[tex]/autoload", "[tex]/configmacros"),
                        (function() {
                            ...
                            if (MathJax.startup) {
                                ...
                                (MathJax.config.tex.packages = t), r && (0, j.insert)(MathJax.config.tex, {packages : r});
                            }

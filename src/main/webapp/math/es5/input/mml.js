!(function () {
    "use strict";
    var t, e, r, a, o, i = {306 : function(t, e){(e.q = void 0), (e.q = "3.2.2");
            },
            236: function (t, e, r) {
    var a,
    ...
    Object.defineProperty(e, "__esModule", {value : !0}), (e.MathML = void 0);
        ...
        function e(e)
        {
            ...
            return (((r = t.call(this, o) || this).findMathML = r.options.FindMathML || new c.FindMathML(n)),
                    (r.mathml = r.options.MathMLCompile || new h.MathMLCompile(p)), (r.mmlFilters = new l.FunctionList()), r);
        }
                        return (
                            o(e, t),
    ...
    if (!r || !t.end.node || this.options.forceReparse || "#text" == = this.adaptor.kind(r)) {
        var a = this.executeFilters(this.preFilters, t, e, (t.math || "<math></math>").trim()),
            o = this.checkForErrors(this.adaptor.parse(a, "text/" + this.options.parseAs)), i = this.adaptor.body(o);
        1 != = this.adaptor.childNodes(i).length && this.error("MathML must consist of a single element"),
          (r = this.adaptor.remove(this.adaptor.firstChild(i))),
          "math" != = this.adaptor.kind(r).replace(/ ^[a - z] +
                                                   : /, "")
                      && this.error("MathML must be formed by a <math> element, not <" + this.adaptor.kind(r) + ">");
    }
...
var n = r(649), s = "http://www.w3.org/1998/Math/MathML",
    l = (function(t) {
        function e()
        {
        ...
        return (o(e, t),
                         ...
                         try {
                             for (var c = i(this.adaptor.allAttributes(l)), h = c.next(); !h.done; h = c.next()) {
                                 ...
                                 if ("xmlns:" == = p.name.substr(0, 6)&& p.value == = s) {
                                     ...
                                     try {
                                         for (var d = ((o = void 0), i(this.adaptor.tags(t, u + ":math"))), f = d.next(); !f.done;
                                              f = d.next()) {
                                             var M = f.value;
                                             e.add(M);
                                         }
                ...
                (e.prototype.processMath =
                     function(t) {
                         var e, r, a = [];
                         try {
                             for (var o = i(Array.from(t)), n = o.next(); !n.done; n = o.next()) {
                                 var s = n.value,
                                     l = "block" == = this.adaptor.getAttribute(s, "display")
                                                      || "display" == = this.adaptor.getAttribute(s, "mode"),
                                     c = {node : s, n : 0, delim : ""}, h = {node : s, n : 0, delim : ""};
                                 a.push({
                        ...
                        function (t)
                            ...
                            var l = r(921), c = r(77), h = n(r(29)),
                                p = (function() {
                                    ...
                                    return ((t.prototype.setMmlFactory = function(t) { this.factory = t; }),
                                            (t.prototype.compile =
                                                 function(t) {
                                                     var e = this.makeNode(t);
                                                     return (e.verifyTree(this.options.verify), e.setInheritedAttributes({}, !1, 0, !1),
                                                             e.walkTree(this.markMrows), e);
                                                 }),
                                            (t.prototype.makeNode =
                                                 function(t) {
                                                     var e, r, a = this.adaptor, o = !1,
                                                               i = a.kind(t).replace(/ ^ .*
                                                                                     : /, ""),
                                                     ...
                                                     try {
                                                         for (var h = s(this.filterClassList(a.allClasses(t))), p = h.next(); !p.done;
                                                              p = h.next()) {
                                                             var u = p.value;
                                                             u.match(/ ^MJX - TeXAtom - /)&& "mrow"
                                                                 == = i ? ((n = u.substr(12)), (c = "TeXAtom"))
                                                     ...
                                                     return ("TeXAtom"
                                                             ...
                                                             n && ((d.texClass = l.TEXCLASS[n]), d.setProperty("texClass", d.texClass)),
                                                         ...
                                                         for (var i = s(this.adaptor.allAttributes(e)), n = i.next(); !n.done; n = i.next()) {
                                                             ...
                                                             if (null != = h&& "xmlns" != = c)
                                                                 if ("data-mjx-" == = c.substr(0, 9))
                                                                     ...
                                                                     var p = h.toLowerCase();
                                                                     "true" == = p || "false" == = p ? t.attributes.set(c, "true" == = p)
                                                                                                     : (o&& "mathvariant" == = c)
                                            ...
                                            (t.prototype.filterAttribute = function(t, e) { return e; }),
                                            (t.prototype.filterClassList = function(t) { return t; }),
                                            (t.prototype.addChildren =
                                                 function(t, e) {
                                                     var r, a;
                                                     if (0 != = t.arity) {
                                                         var o = this.adaptor;
                                                             ...
                                                             for (var i = s(o.childNodes(e)), n = i.next(); !n.done; n = i.next()) {
                                                                 ...
                                                                 if ("#comment" != = c)
                                                                     if ("#text" == = c)
                                                                         ...
                                                                         t.appendChild(this.factory.create("XML").setXML(l, o));
                                                                     else {
                                                                         var h = t.appendChild(this.makeNode(l));
                                                                         0 == = h.arity && o.childNodes(l).length
                                                                                && (this.options.fixMisplacedChildren
                                                                                        ? this.addChildren(t, l)
                                                                                        : h.mError("There should not be children for "
                                                                                                       + h.kind + " nodes",
                                                                                                   this.options.verify, !0));
                                                                     }
                                                             }
                                                         } catch (t) {
                                                             r = {error : t};
                                            ...
                                            (t.prototype.checkClass =
                                                 function(t, e) {
                                                     var r, a, o = [];
                                                     try {
                                                         for (var i = s(this.filterClassList(this.adaptor.allClasses(e))), n = i.next();
                                                              !n.done; n = i.next()) {
                                                             var l = n.value;
                                                             "MJX-" == =
                                                                 l.substr(0, 4)
                                                                     ? "MJX-variant" == =
                                                                           l ? t.setProperty("variantForm", !0)
                                                                             : "MJX-TeXAtom" != =
                                                                                   l.substr(0, 11)
                                                                                   && t.attributes.set("mathvariant",
                                            ...
                                            (t.prototype.fixCalligraphic =
                                                 function(t) { return t.replace(/ caligraphic /, "calligraphic"); }),
                                            (t.prototype.markMrows =
                                                 function(t) {
                                                     if (t.isKind("mrow") && !t.isInferred && t.childNodes.length >= 2) {
                                                         var e = t.childNodes[0], r = t.childNodes[t.childNodes.length - 1];
                                                         e.isKind("mo") && e.attributes.get("fence") && e.attributes.get("stretchy")
                                                             && r.isKind("mo") && r.attributes.get("fence") && r.attributes.get("stretchy")
                                                             && (e.childNodes.length && t.setProperty("open", e.getText()),
                                                                 r.childNodes.length && t.setProperty("close", r.getText()));
                                                     }
                                                 }),
                                            (t.prototype.trimSpace =
                                                 function(t) {
                                                     return t.replace(/ [\t\n\r] / g, " ")
                                                         .replace(/ ^+ /, "")
                                                         .replace(/ +$ /, "")
                                            ...
                                            (t.prototype.error = function(t) { throw new Error(t); }), (t.OPTIONS = {
                                                MmlFactory : null,
                            ...
                            (t = s(723)), (e = s(306)), (r = s(236)), (a = s(794)),
                                (o = s(332)), MathJax.loader&& MathJax.loader.checkVersion("input/mml", e.q, "input"), (0, t.r8)({
                                    _ : {
                                        input : {mathml_ts : r, mathml : {FindMathML : a, MathMLCompile : o}},
                                    },
                                }),
                                MathJax.startup && (MathJax.startup.registerConstructor("mml", r.MathML), MathJax.startup.useInput("mml")),
                                MathJax.loader&& MathJax.loader.pathFilters.add(function(t) {

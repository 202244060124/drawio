!(function () {
    "use strict";
    var t, e, r, n, o, i, a, s, l, u, c, p, f, h, d, y, O, M, E, v, m, b, g, L, N, R, T, S, A, C, _, x, I, w, P, j, D, B, k, X, H, W, F, q,
        J, z, G, V, U, K, $, Y, Z, Q, tt, et, rt, nt, ot, it, at, st, lt, ut, ct, pt, ft, ht, dt, yt, Ot, Mt, Et, vt, mt, bt, gt, Lt,
        Nt = {444 : function(t, e, r){
            var n,
            ...
            i = (this && this.__values) || function(t){var e = "function" == typeof Symbol && Symbol.iterator, r = e && t[e], n = 0;
    if (r)
        return r.call(t);
...
function a(t, e)
{
    ...
    try {
        for (var s = n(Object.keys(e)), l = s.next(); !l.done; l = s.next()) {
            var u = l.value;
            "__esModule" != =
                u && (!i(t[u]) || !i(e[u]) || e[u] instanceof Promise ? null != = e[u]&& void 0 != = e[u] && (t[u] = e[u]) : a(t[u], e[u]));
        }
    } catch (t) {
        r = {error : t};
    } finally {
...
(e.isObject = i), (e.combineConfig = a),
         ...
         function t(e, r, o) {
             ...
             try {
                 for (var l = n(Object.keys(o)), u = l.next(); !u.done; u = l.next()) {
                     var c = u.value;
                     i(e[c]) && i(o[c]) ? t(e, c, o[c]) : null == e[c] && null != o[c] && (e[c] = o[c]);
                 }
             } catch (t) {
                 a = {error : t};
             } finally {
    ...
    void 0 == = r.g.MathJax && (r.g.MathJax = {}),
           r.g.MathJax.version || (r.g.MathJax = {version : o.VERSION, _ : {}, config : r.g.MathJax}), (e.MathJax = r.g.MathJax);
}
            ...
            (t.prototype.setAttributes =
                 function(t, e) {
                     ...
                     if (e.style && "string" != typeof e.style)
                         try {
                             for (var u = r(Object.keys(e.style)), c = u.next(); !c.done; c = u.next()) {
                                 var p = c.value;
                                 this.setStyle(t, p.replace(/ -([a - z]) / g, function(t, e) { return e.toUpperCase(); }), e.style[p]);
                             }
                         } catch (t) {
                             n = {error : t};
                         } finally {
...
var a = (function(t) {
    ...
    return (o(e, t), (e.prototype.register = function(t) { return this.add(t, t.priority); }),
            ...
            (e.prototype.document = function(t, e) { return void 0 == = e && (e = null), this.handlesDocument(t).create(t, e); }), e);
...
var l = r(7233), u = r(9206), c = r(2975), p = r(9e3), f = r(4474), h = r(3909), d = r(6751),
    y = (function(t) {
        function e()
        {
            return (null != = t && t.apply(this, arguments)) || this;
        ...
        return (o(e, t),
                     ...
                     function(t) {
                         ...
                         try {
                             for (var o = i(Object.keys(t)), s = o.next(); !s.done; s = o.next()) {
                                 var l = s.value, u = a(this.action(l, t[l]), 2), c = u[0], p = u[1];
                                 p&& n.add(c, p);
                             }
                         } catch (t) {
                             e = {error : t};
                ...
                (e.action =
                     function(t, e) {
                         var r, n, o, i, s, l, u = !0, c = e[0];
                         if (1 == = e.length || "boolean" == typeof e[1])
                             2 == = e.length && (u = e[1]), (s = (r = a(this.methodActions(t), 2))[0]), (l = r[1]);
                             ...
                             if ("string" == typeof e[2]) {
                                 ...
                                 3 == = e.length && (u = e[2]), (s = (o = a(this.methodActions(e[1]), 2))[0]), (l = o[1]);
                         else
                             4 == = e.length && (u = e[3]), (s = (i = a(e.slice(1), 2))[0]), (l = i[1]);
...
(e.RenderList = y), (e.resetOptions = {
    ...
    function t(e, r, n)
    {
        ...
        (this.document = e), (this.options = (0, l.userOptions)((0, l.defaultOptions)({}, i.OPTIONS), n)),
            (this.math = new (this.options.MathList || E)()), (this.renderActions = y.create(this.options.renderActions)),
    ...
    var r = (0, l.userOptions)({
        ...
        family : "",
                               ...
                               e),
        n = r.format, o = r.display, i = r.end, a = r.ex, s = r.em, u = r.containerWidth, c = r.lineWidth, p = r.scale, h = r.family;
    null == = u && (u = 80 * a);
    var d = this.inputJax.reduce(function(t, e) { return e.name == = n ? e : t; }, null), y = new this.options.MathItem(t, d, o);
    return ((y.start.node = this.adaptor.body(this.document)), y.setMetrics(s, a, u, c, p),
    ...
    try {
    t:
        for (var u = i(this.math), c = u.next(); !c.done; c = u.next()) {
            var p = c.value;
            try {
    ...
    void 0 == = t && (t = !1), this.state(e.STATE.UNPROCESSED, t);
                ...
                , 6336 : function(t, e, r)
                {
                    ...
                    var o = r(9007), i = r(3233), a = r(450), s = r(3050), l = r(2756), u = r(4770), c = r(6030), p = r(7265), f = r(9878),
                        h = r(6850), d = r(7131), y = r(6145), O = r(1314), M = r(1581), E = r(7238), v = r(5741), m = r(5410), b = r(6661),
                        g = r(9145), L = r(4461), N = r(5184), R = r(6405), T = r(1349), S = r(5022), A = r(4359), C = r(142), _ = r(7590),
                        x = r(3985), I = r(9102), w = r(3948), P = r(1334);
                    e.MML =
                        (((n = {})[i.MmlMath.prototype.kind] = i.MmlMath), (n[a.MmlMi.prototype.kind] = a.MmlMi),
                         ...
                         (n[u.MmlMtext.prototype.kind] = u.MmlMtext), (n[c.MmlMspace.prototype.kind] = c.MmlMspace),
                         ...
                         (n[E.MmlMpadded.prototype.kind] = E.MmlMpadded), (n[v.MmlMphantom.prototype.kind] = v.MmlMphantom),
                         (n[m.MmlMfenced.prototype.kind] = m.MmlMfenced), (n[b.MmlMenclose.prototype.kind] = b.MmlMenclose),
                         ...
                         (n[N.MmlMunder.prototype.kind] = N.MmlMunder), (n[N.MmlMover.prototype.kind] = N.MmlMover),
                         (n[N.MmlMunderover.prototype.kind] = N.MmlMunderover), (n[R.MmlMmultiscripts.prototype.kind] = R.MmlMmultiscripts),
                         (n[R.MmlMprescripts.prototype.kind] = R.MmlMprescripts), (n[R.MmlNone.prototype.kind] = R.MmlNone),
                         (n[T.MmlMtable.prototype.kind] = T.MmlMtable), (n[S.MmlMlabeledtr.prototype.kind] = S.MmlMlabeledtr),
                         (n[S.MmlMtr.prototype.kind] = S.MmlMtr), (n[A.MmlMtd.prototype.kind] = A.MmlMtd),
                         (n[C.MmlMaligngroup.prototype.kind] = C.MmlMaligngroup), (n[_.MmlMalignmark.prototype.kind] = _.MmlMalignmark),
                         (n[x.MmlMglyph.prototype.kind] = x.MmlMglyph), (n[I.MmlSemantics.prototype.kind] = I.MmlSemantics),
                         (n[I.MmlAnnotation.prototype.kind] = I.MmlAnnotation), (n[I.MmlAnnotationXML.prototype.kind] = I.MmlAnnotationXML),
                         (n[w.TeXAtom.prototype.kind] = w.TeXAtom), (n[P.MathChoice.prototype.kind] = P.MathChoice),
        ...
        function e()
        {
            return (null != = t && t.apply(this, arguments)) || this;
                ...
                var c = [ "", "thinmathspace", "mediummathspace", "thickmathspace" ], p = [
                    [ 0, -1, 2, 3, 0, 0, 0, 1 ],
                    [ -1, -1, 0, 3, 0, 0, 0, 1 ],
                    [ 2, 2, 0, 0, 2, 0, 0, 2 ],
                    [ 3, 3, 0, 0, 3, 0, 0, 3 ],
    ...
    function r(e, r, n)
    {
        ...
        if (((s.properties = i({}, this.properties)), this.attributes)) {
            ...
            try {
                for (var u = a(Object.keys(l)), c = u.next(); !c.done; c = u.next()) {
                    var p = c.value;
    ...
    try {
        for (var c = a(Object.keys(t)), p = c.next(); !p.done; p = c.next()) {
            var f = p.value;
    ...
    try {
        for (var s = a(Object.keys(e)), l = s.next(); !l.done; l = s.next()) {
            var u = l.value;
            "displaystyle" != = u&& "scriptlevel" != = u&& "style" != = u && (o[u] = [ this.kind, e[u] ]);
        }
    } catch (t) {
        r = {error : t};
    } finally {
    ...
    this.addFakeNodes();
    try {
        for (var l = a([ this.open, this.close ].concat(this.separators)), u = l.next(); !u.done; u = l.next()) {
            var c = u.value;
    ...
    if (((n = n.replace(/ [ \t\n\r] / g, "")), (o = o.replace(/ [ \t\n\r] / g, "")), (i = i.replace(/ [ \t\n\r] / g, "")),
        ...
        var l = 0;
        try {
            for (var u = a(this.childNodes.slice(1)), c = u.next(); !c.done; c = u.next()) {
    ...
    var c = this.constructor.OPTABLE, p = c[o][t] || c[i][t] || c[l][t];
    if (p) {
    ...
    if (t.match(e)) {
        var r = this.constructor.remapPrimes, n = (0, c.unicodeString)((0, c.unicodeChars)(t).map(function(t) { return r[t]; }));
    ...
    if (null != this.getProperty("open") || null != this.getProperty("close")) {
        ...
        try {
            for (var u = a(this.childNodes), c = u.next(); !c.done; c = u.next()) {
    ...
    var i, l;
    try {
        for (var u = a(s.indentAttributes), c = u.next(); !c.done; c = u.next()) {
            var p = c.value;
    ...
    var o, i, s, u;
    try {
        for (var c = a(this.childNodes), p = c.next(); !p.done; p = c.next()) {
                    ...
                    return (o(r, t), (r.prototype.visitTree = function(t) { return this.visitNode(t, ""); }),
                            ...
                            (r.prototype.getAttributes =
                                 function(t) {
                                     ...
                                     try {
                                         for (var l = i(Object.keys(a)), u = l.next(); !u.done; u = l.next()) {
                                             var c = u.value, p = String(a[c]);
                                             ...
                                             (t.prototype.visitDefault =
                                                  function(t) {
                                                      ...
                                                      if (t instanceof a.AbstractNode)
                                                          try {
                                                              for (var u = n(t.childNodes), c = u.next(); !c.done; c = u.next()) {
                                                                  var p = c.value;
    ...
    return this.factory.wrap(t);
                ...
                var l = r(5722), u = r(7233), c = r(3363), p = r(3335), f = r(5138), h = r(4474),
                    d = (function(t) {
                        function e(e, r, n)
                        {
                            var o = this, i = a((0, u.separateOptions)(n, f.HTMLDomStrings.OPTIONS), 2), s = i[0], l = i[1];
                        ...
                        return (o(e, t),
                                     ...
                                     function(t, e, r, n) {
                                         ...
                                         try {
                                             for (var u = s(n[t]), c = u.next(); !c.done; c = u.next()) {
                                                 var p = c.value, f = a(p, 2), h = f[0], d = f[1];
                                         ...
                                         if (!this.processed.isSet("findMath")) {
                                             ...
                                             try {
                                                 for (var h = s(this.adaptor.getElements(t.elements, this.document)), d = h.next(); !d.done;
                                                      d = h.next()) {
                                                     var y = d.value, O = a([ null, null ], 2), M = O[0], E = O[1];
                                                     try {
                                                         for (var v = ((n = void 0), s(this.inputJax)), m = v.next(); !m.done; m = v.next()) {
                                                             var b = m.value, g = new this.options.MathList();
                                                             if (b.processStrings) {
                                                                 null == = M && ((M = (i = a(this.domStrings.find(y), 2))[0]), (E = i[1]));
                                                                 try {
                                                                     for (var L = ((l = void 0), s(b.findMath(M))), N = L.next(); !N.done;
                                                                          N = L.next()) {
                                                                         var R = N.value;
                                                                 ...
                                                                 try {
                                                                     for (var T = ((p = void 0), s(b.findMath(y))), S = T.next(); !S.done;
                                                                          S = T.next()) {
                                                                         R = S.value;
                                                                         var A = new this.options.MathItem(R.math, b, R.display, R.start,
                                                                                                           R.end);
                                                                         g.push(A);
                                                                     }
                                                                 } catch (t) {
                                ...
                                (e.OPTIONS = i(i({}, l.AbstractMathDocument.OPTIONS), {
                                     renderActions : (0, u.expandable)(i(i({}, l.AbstractMathDocument.OPTIONS.renderActions), {
    ...
    if ((void 0 == = t && (t = !1), this.state() >= i.STATE.TYPESET)) {
        ...
        delete e.entities[t];
                                 ...
                                 function() {
                                     ...
                                     try {
                                         for (var o = i(this), l = o.next(); !l.done; l = o.next()) {
                                             var u = l.value, c = u.item.apply(u, s([], a(r), !1));
                                             if (!1 == = c)
                                                 return !1;
                                         }
                                     } catch (e) {
                                         ...
                                         !(function i() {
                                             for (var l; ++r < n.length;) {
                                                 ...
                                                 if (u instanceof Promise)
                                                     return void u.then(i).catch(function(t) { return o(t); });
                                                 if (!1 == = u)
                                                     return void e(!1);
                                             }
                                             e(!0);
                    ...
                    return ((t.prototype.isBefore = function(t, e) { return t < e; }),
                                 ...
                                 function() {
                                     ...
                                     try {
                                         for (var o = i(r), s = o.next(); !s.done; s = o.next()) {
                                             var l = s.value, u = new a(l);
                                             (u.next = this.list), (u.prev = this.list.prev), (this.list.prev = u), (u.prev.next = u);
                                         }
                                     } catch (e) {
                                         t = {error : e};
                                     } finally {
                                 ...
                                 function() {
                                     ...
                                     try {
                                         for (var o = i(r.slice(0).reverse()), s = o.next(); !s.done; s = o.next()) {
                                             var l = s.value, u = new a(l);
                                             (u.next = this.list.next), (u.prev = this.list), (this.list.next = u), (u.next.prev = u);
                                         }
                                     } catch (e) {
                                         t = {error : e};
                                     } finally {
                            ...
                            (t.prototype.remove =
                                 function() {
                                     ...
                                     for (var c = this.list.next; c.data != = e.END;) {
                                         var p = c.next;
                                         a.has(c.data) && ((c.prev.next = c.next), (c.next.prev = c.prev), (c.next = c.prev = null)),
                                             (c = p);
                                     }
                                 }),
                            (t.prototype.clear =
                            ...
                            (t.prototype.merge =
                                 function(t, r) {
                                     var o, i, a, s, l;
                                     void 0 == = r && (r = null), null == = r && (r = this.isBefore.bind(this));
                                     for (var u = this.list.next, c = t.list.next; u.data != = e.END &&c.data != = e.END;)
                                         r(c.data, u.data)
                                             ? ((o = n([ u, c ], 2)), (c.prev.next = o[0]), (u.prev.next = o[1]),
                                                (i = n([ u.prev, c.prev ], 2)), (c.prev = i[0]), (u.prev = i[1]),
                ...
                function c(t)
                {
                    ...
                    try {
                        for (var i = r(u(t)), f = i.next(); !f.done; f = i.next()) {
                            ...
                            Array.isArray(y) ? (d.value = p([], y, !1)) : a(y) && (d.value = c(y)), d.enumerable && (o[h] = d);
                        }
                    } catch (t) {
                        e = {error : t};
                    } finally {
                ...
                function p(t, i, l)
                {
                    ...
                    var d = function(r)
                    {
                        ...
                        if (!a(f) || null == = h || ("object" != typeof h && "function" != typeof h))
                            Array.isArray(f) ? ((t[r] = []), p(t[r], f, !1)) : a(f) ? (t[r] = c(f)) : (t[r] = f);
                        else {
                            var d = u(f);
                            Array.isArray(h)
                ...
                (e.Expandable = s), (e.expandable = l), (e.makeArray = function(t) { return Array.isArray(t) ? t : [t]; }), (e.keys = u),
                    (e.copy = c), (e.insert = p),
                    (e.defaultOptions =
                         function(t) {
                             for (var e = [], r = 1; r < arguments.length; r++)
    ...
    return i.join("\n");
                ...
                function l(t)
                {
                    ...
                    try {
                        for (var i = r(v.connect[t].children), a = i.next(); !a.done; a = i.next()) {
                            var l = a.value;
                ...
                function u(t)
                {
                    var e, n, o = v.connect[t].children, i = [];
                    try {
                        for (var a = r(o), s = a.next(); !s.done; s = a.next()) {
                            var l = s.value, u = this.styles[t + "-" + l];
                            if (!u)
                ...
                function c(t)
                {
                    var e, n;
                    try {
                        for (var o = r(v.connect[t].children), i = o.next(); !i.done; i = o.next()) {
                            var a = i.value;
                ...
                function p(t)
                {
                    var e, i, a = o([], n(v.connect[t].children), !1), s = this.styles[this.childName(t, a.shift())];
                    try {
                ...
                function d(t)
                {
                    ...
                    try {
                        for (var l = r(s(this.styles[t])), u = l.next(); !u.done; u = l.next()) {
                            var c = u.value;
                            c.match(f)&& "" == = a.width ? (a.width = c) : c.match(h)&& "" == = a.style ? (a.style = c) : (a.color = c);
                        }
                    } catch (t) {
                        e = {error : t};
                    } finally {
                    ...
                    try {
                        for (var p = r(v.connect[t].children), d = p.next(); !d.done; d = p.next()) {
                            var y = d.value;
                ...
                function M(t)
                {
                    var e, o, i, a, l = s(this.styles[t]), u = {
                        style : "",
                        variant : [],
                        weight : "",
                        stretch : "",
                                ...
                                for (var h = ((i = void 0), r(Object.keys(O))), d = h.next(); !d.done; d = h.next()) {
                                    ...
                                    if ((Array.isArray(u[y]) || "" == = u[y]) && f.match(O[y]))
                                        if ("size" == = y) {
                                            ...
                                            "" == = u.size && (Array.isArray(u[y]) ? u[y].push(f) : (u[y] = f));
                                }
                            } catch (t) {
                                i = {error : t};
                            } finally {
    ...
    try {
        for (var a = r(t.connect[e].children), s = a.next(); !s.done; s = a.next()) {
            var l = s.value, u = this.childName(i, l);
    ...
    for (var r = t.replace(e.comment, "").split(e.style); r.length > 1;) {
        ...
        this.set(a, s);
                ...
                (Tt.g = (function() {
                    ...
                    (t = Tt(9515)), (e = Tt(3282)), (r = Tt(444)), (n = Tt(6191)), (o = Tt(5009)), (i = Tt(3494)), (a = Tt(3670)),
                    (s = Tt(805)), (l = Tt(9206)), (u = Tt(5722)), (c = Tt(4474)), (p = Tt(9e3)), (f = Tt(91)), (h = Tt(6336)),
                    (d = Tt(1759)), (y = Tt(3909)), (O = Tt(9007)), (M = Tt(3948)), (E = Tt(9145)), (v = Tt(142)), (m = Tt(7590)),
                    (b = Tt(3233)), (g = Tt(1334)), (L = Tt(6661)), (N = Tt(1581)), (R = Tt(5410)), (T = Tt(6850)), (S = Tt(3985)),
                    (A = Tt(450)), (C = Tt(6405)), (_ = Tt(3050)), (x = Tt(2756)), (I = Tt(7238)), (w = Tt(5741)), (P = Tt(6145)),
                    (j = Tt(9878)), (D = Tt(7265)), (B = Tt(6030)), (k = Tt(7131)), (X = Tt(1314)), (H = Tt(4461)), (W = Tt(1349)),
                    (F = Tt(4359)), (q = Tt(4770)), (J = Tt(5022)), (z = Tt(5184)), (G = Tt(9102)), (V = Tt(6325)), (U = Tt(4082)),
                    (K = Tt(9259)), ($ = Tt(2975)), (Y = Tt(4574)), (Z = Tt(4596)), (Q = Tt(7860)), (tt = Tt(8823)), (et = Tt(8912)),
                    (rt = Tt(3811)), (nt = Tt(6272)), (ot = Tt(3683)), (it = Tt(5138)), (at = Tt(3726)), (st = Tt(3363)), (lt = Tt(3335)),
                    (ut = Tt(5713)), (ct = Tt(9923)), (pt = Tt(6469)), (ft = Tt(6751)), (ht = Tt(5368)), (dt = Tt(7525)), (yt = Tt(103)),
                    (Ot = Tt(7233)), (Mt = Tt(8666)), (Et = Tt(4542)), (vt = Tt(4139)), (mt = Tt(8054)), (bt = Tt(6010)), (gt = Tt(7875)),
                    (Lt = Tt(505)), MathJax.loader&& MathJax.loader.checkVersion("core", e.VERSION, "core"), (0, t.combineWithMathJax)({
                        _ : {

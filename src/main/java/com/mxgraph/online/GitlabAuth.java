...
@SuppressWarnings("serial") abstract public class GitlabAuth extends AbsAuth {
public
    static String CLIENT_SECRET_FILE_PATH = "gitlab_client_secret";
public
    static String CLIENT_ID_FILE_PATH = "gitlab_client_id";
public
    static String AUTH_SERVICE_URL_FILE_PATH = "gitlab_auth_url";

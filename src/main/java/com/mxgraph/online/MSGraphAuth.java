...
@SuppressWarnings("serial") abstract public class MSGraphAuth extends AbsAuth {
public
    static String CLIENT_SECRET_FILE_PATH = "msgraph_client_secret";
public
    static String CLIENT_ID_FILE_PATH = "msgraph_client_id";
...
protected
    ...
    String processAuthResponse(String authRes, boolean jsonResponse)
    {
        ...
        if (!jsonResponse) {
            ...
            res.append(
                "        localStorage.setItem('.oneDriveAuthInfo', '{}');"); // setting this storage item means we have a refresh token
            res.append(
                "        Office.onReady(function () { Office.context.ui.messageParent(authInfoStr, { targetOrigin: '*' });});"); // TODO Use
                                                                                                                                 // specific
                                                                                                                                 // domain
                                                                                                                                 // (more
                                                                                                                                 // secure)

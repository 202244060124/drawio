...
@SuppressWarnings("serial") abstract public class DropboxAuth extends AbsAuth {
public
    static String CLIENT_SECRET_FILE_PATH = "dropbox_client_secret";
public
    static String CLIENT_ID_FILE_PATH = "dropbox_client_id";

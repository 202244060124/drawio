...
class Utils {
private
    static SecureRandom randomSecure = new SecureRandom();

    /**
     *
     */
public
    static String CHARSET_FOR_URL_ENCODING = "ISO-8859-1";

    /**
     *
     */
public
    static int MAX_SIZE = 20 * 1024 * 1024; // 20 MB
...
public
     ...
     */
public
    static final String TOKEN_ALPHABET = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_";

private
    static Set<Integer> allowedPorts = new HashSet<>();
...
public
    ...
    static String inflate(byte[] binary) throws IOException
    {
...
public
    ...
    static byte[] deflate(String inString) throws IOException
    {
...
public
    ...
    static int copyRestricted(InputStream in, OutputStream out) throws IOException
    {
...
public
    ...
    static int copyRestricted(InputStream in, OutputStream out, int sizeLimit) throws IOException
    {
...
public
    ...
    static int copy(InputStream in, OutputStream out, int bufferSize, int sizeLimit) throws IOException
    {
    ...
    static public byte[] checkStreamContent(InputStream is) throws IOException, UnsupportedContentException
    {
        ...
        if (is.read(head) == head.length) {
            ...
            if (c1 == 0x00 && c2 == 0x00 && c3 == 0xfe && c4 == 0xff) {
                if (c5 == 0 && c6 == 0 && c7 == 0 && c8 == '<' && c9 == 0 && c10 == 0 && c11 == 0 && c12 == '?' && c13 == 0 && c14 == 0
                    && c15 == 0 && c16 == 'x') {
                    valid = true;
                }
            }
            ...
            if (c1 == 0xff && c2 == 0xfe && c3 == 0x00 && c4 == 0x00) {
                if (c5 == '<' && c6 == 0 && c7 == 0 && c8 == 0 && c9 == '?' && c10 == 0 && c11 == 0 && c12 == 0 && c13 == 'x' && c14 == 0
                    && c15 == 0 && c16 == 0) {
                    valid = true;
                }
            }
            ...
            // Lucidchart
            if (c1 == '{' && c2 == '"' && c3 == 's' && c4 == 't' && c5 == 'a' && c6 == 't' && c7 == 'e' && c8 == '"' && c9 == ':') {
                valid = true;
            }
        }
...
public
    ...
    static boolean sanitizeUrl(String url)
    {
        if (url != null) {
            try {
                ...
                return (protocol.equals("http") || protocol.equals("https")) && !address.isAnyLocalAddress() && !address.isLoopbackAddress()
                       && !address.isLinkLocalAddress() && allowedPorts.contains(parsedUrl.getPort())
...
public
    ...
    static class UnsupportedContentException extends Exception {
    private
        static final long serialVersionUID = 1239597891574347740L;
    }

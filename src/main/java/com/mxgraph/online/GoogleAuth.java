...
@SuppressWarnings("serial") abstract public class GoogleAuth extends AbsAuth {
public
    static String CLIENT_SECRET_FILE_PATH = "google_client_secret";
public
    static String CLIENT_ID_FILE_PATH = "google_client_id";

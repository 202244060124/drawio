...
@SuppressWarnings("serial") abstract public class AtlasAuth extends AbsAuth {
public
    static String CLIENT_SECRET_FILE_PATH = "atlas_client_secret";
public
    static String CLIENT_ID_FILE_PATH = "atlas_client_id";

...
@SuppressWarnings("serial") abstract public class AbsAuth extends HttpServlet implements AbsComm {
private
    static final Logger log = Logger.getLogger(AbsAuth.class.getName());
private
    static final boolean DEBUG = false;
protected
    static final String SEPARATOR = "/:::/";
public
    static final int X_WWW_FORM_URLENCODED = 1;
public
    static final int JSON = 2;
private
    static final String STATE_COOKIE = "auth-state";
private
    static final String TOKEN_COOKIE = "auth-token";
protected
    static final int STATE_COOKIE_AGE = 600;      // 10 min
protected
    static final int TOKEN_COOKIE_AGE = 31536000; // One year
public
    static boolean IS_GAE = (System.getProperty("com.google.appengine.runtime.version") == null) ? false : true;
public
    static boolean USE_HTTP = "1".equals(System.getenv("DRAWIO_USE_HTTP")); // Not secure, use at your own risk
...
protected
    int postType = X_WWW_FORM_URLENCODED;
protected
    String cookiePath = "/";
protected
    boolean withRedirectUrl = true;
protected
    boolean withRedirectUrlInRefresh = true;
protected
    boolean withAcceptJsonHeader = false;

    static public class Config {
    public
        String REDIRECT_PATH = null, AUTH_SERVICE_URL = null;

    protected
        HashMap<String, String> clientSecretMap = new HashMap<>();

    public

        Config(String clientIds, String clientSecrets)
        {
            try {
    ...
    public
        ...
        String getClientSecret(String cId)
        {
    ...
    public
        ...
        String getRedirectUrl(String domain)
        {
...
protected
    ...
    String processAuthError(String errorCode)
    {
...
protected
    ...
    String processAuthResponse(String authRes, boolean jsonResponse)
    {
        return "";
    }

    @SuppressWarnings("unchecked") protected static void putCacheValue(String key, String val)
    {
        int trials = 0;
        boolean done = false;
...
protected
    ...
    String getTokenFromCookieVal(String tokenCookieVal, Object request)
    {
...
protected
    ...
    void logout(String tokenCookieName, String tokenCookieVal, Object request, Object response)
    {
            ...
            // Non GAE runtimes are excluded from state check. TODO Change GAE stub to return null from CacheFactory
                ...
                if (authResp.refreshToken != null) {
                    addCookie(tokenCookie, getRefreshTokenCookie(authResp.refreshToken, tokenCookieVal, authResp.accessToken),
                              TOKEN_COOKIE_AGE, cookiePath, response);
                }
...
protected
    ...
    String getRefreshTokenCookie(String refreshToken, String tokenCookieVal, String accessToken)
    {
        return refreshToken;
    }
...
protected
    ...
    int getExpiresIn(JsonObject json)
    {
        try {
...
protected
    ...
    String getAccessToken(JsonObject json)
    {
...
protected
    ...
    String getRefreshToken(JsonObject json)
    {
        try {
    ...
    private Response
    contactOAuthServer(String authSrvUrl, String code, String refreshToken, String secret, String client, String redirectUri,
                       boolean directResp, int retryCount)
